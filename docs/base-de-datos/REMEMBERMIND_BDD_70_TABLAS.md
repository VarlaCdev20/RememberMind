...
**Documento histórico previo:** `REMEMBERMIND_BDD_69_TABLAS.md` (BDD V2.0 — 69 tablas)
**Entidad central:** `residentes`

> Este documento define las entidades, atributos, PK, FK y relaciones de la BDD operativa V2.1. No modificar sin consulta y aprobación previa.
...
- 1 — 0..1 valoraciones_enfermeria_preadmision
...
## 8. `valoraciones_enfermeria_preadmision` — Transaccional

**PK:** `cod_valoracion_enfermeria string(20)`
...
- `estado_general string(40) NULL`

- `nivel_conciencia string(40) NULL`

- `orientacion_persona string(40) NULL`

- `orientacion_tiempo string(40) NULL`

- `orientacion_espacio string(40) NULL`

- `comunicacion string(80) NULL`

- `hay_dolor boolean DEFAULT false`

- `intensidad_dolor smallint NULL`

- `ubicacion_dolor string(255) NULL`

- `movilidad string(80) NULL`

- `apoyo_movilidad string(160) NULL`

- `riesgo_caida string(40) NULL`

- `piel_estado string(80) NULL`

- `hay_heridas boolean DEFAULT false`

- `ubicacion_heridas string(255) NULL`

- `higiene_ingreso string(80) NULL`

- `continencia_basica string(80) NULL`

- `alimentacion_aparente string(80) NULL`

- `pa_sistolica decimal(6,2) NULL`

- `pa_diastolica decimal(6,2) NULL`
...
- `medicacion_referida text NULL`

- `alergias_referidas text NULL`

- `dependencia_funcional string(60) NULL`

- `riesgo_nutricional string(60) NULL`

- `riesgo_cognitivo string(60) NULL`

- `tipo_evaluacion_cognitiva string(80) NULL`

- `necesidad_apoyo_inmediato text NULL`

- `prioridad_sugerida string(20) NULL`

- `confirmacion_documentacion boolean DEFAULT false`

- `comentarios_adicionales text NULL`

- `recomendacion_enfermeria text NULL`
...
## 10. `residentes_contactos` — Intermedia
...
## 12. `residentes` — Maestra principal
...
## 13. `historial_estados_residente` — Transaccional
...
## 16. `ocupaciones_cama` — Intermedia
...
## 18. `consentimientos` — Transaccional
...
## 20. `notas_clinicas` — Transaccional
...
## 21. `antecedentes_clinicos` — Transaccional
...
## 24. `seguros_residente` — Transaccional
...
## 25. `dispositivos_clinicos` — Transaccional
...
## 26. `signos_vitales` — Transaccional
...
## 28. `mediciones_antropometricas` — Transaccional
...
## 29. `tipos_estudio_clinico` — Maestra
...
## 30. `componentes_estudio` — Auxiliar
...
## 31. `estudios_clinicos` — Transaccional
...
## 32. `resultados_estudio` — Intermedia
...
## 33. `informes_estudio` — Transaccional
...
## 34. `documentos_clinicos` — Transaccional
...
## 37. `indicaciones_clinicas` — Transaccional
...
## 38. `asignaciones_residente_jornada` — Intermedia
...
## 39. `controles_cognitivos` — Transaccional
...
## 40. `registros_conductuales` — Transaccional
...
## 41. `registros_sueno` — Transaccional
...
## 42. `registros_ingesta` — Transaccional
...
## 43. `registros_hidratacion` — Transaccional
...
## 44. `registros_eliminacion` — Transaccional
...
## 47. `curaciones_herida` — Transaccional
...
## 49. `planes_cuidado` — Transaccional
...
## 50. `intervenciones_cuidado` — Auxiliar
...
## 51. `programaciones_cuidado` — Auxiliar
...
## 52. `ejecuciones_cuidado` — Transaccional
...
## 54. `prescripciones` — Transaccional
...
## 55. `horarios_prescripcion` — Auxiliar
...
## 56. `administraciones_medicacion` — Transaccional
...
## 58. `preguntas_instrumento` — Auxiliar
...
## 60. `aplicaciones_instrumento` — Transaccional
...
## 61. `respuestas_instrumento` — Intermedia
...
## 62. `valoraciones_psicologicas` — Transaccional
...
## 63. `valoraciones_nutricionales` — Transaccional
...
## 64. `valoraciones_funcionales` — Transaccional
...
## 65. `seguimientos_pedagogicos` — Transaccional
...
## 67. `participantes_actividad` — Intermedia
...
## 70. `eventos_alerta` — Transaccional
...
Relaciones de preadmisión:
- `preadmisiones 1:0..1 valoraciones_enfermeria_preadmision` (valoración integral normalizada previa a la formalización).
- `usuarios 1:N valoraciones_enfermeria_preadmision` (personal de enfermería que registra la valoración mediante `cod_usuario_registro`).
...
13. `jornadas`;
14. `preadmisiones`;
15. `valoraciones_enfermeria_preadmision`;
16. `admisiones`;
17. `residentes_contactos`;
18. `historial_estados_residente`;
19. `ocupaciones_cama`;
20. `documentos`;
21. `consentimientos`;
22. `atenciones`;
23. resto de tablas clínicas dependientes;
24. tablas de seguimiento;
25. planes e intervenciones;
26. medicación;
27. estructura/aplicaciones de instrumentos;
28. valoraciones profesionales;
29. actividades/participantes;
30. visitas;
31. alertas/eventos.
...
- `valoraciones_enfermeria_preadmision(cod_preadmision)`;
- `valoraciones_enfermeria_preadmision(cod_usuario_registro)`;
...
15. No permitir más de una valoración de enfermería por preadmisión (1:1 estricto con FK UNIQUE).
