...
class TabMedicacionEnfermeriaTest extends TestCase
{
    ...
    public function test_escenario_a_b_c_d_e_f_g_en_pestana_medicaciones(): void
    {
        ...
        $medFuturo = MedicacionAdulto::create([
        ...
        $medAtrasado = MedicacionAdulto::create([
            'cod_am' => $this->adulto->cod_am,
        ...
        $medAdmin = MedicacionAdulto::create([
            'cod_am' => $this->adulto->cod_am,
        ...
        $medSusp = MedicacionAdulto::create([
            'cod_am' => $this->adulto->cod_am,
        ...
        // F. Medicamento PRN
        $medPrn = MedicacionAdulto::create([
            'cod_am' => $this->adulto->cod_am,
