...
class EventosClinicosFichaTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->turno = TurnoEnfermeria::firstOrCreate(['cod_turno' => 'TUR_001'], [
            'cod_turno' => 'TUR_001',
        ...
        $this->habitacion = Habitacion::firstOrCreate(['cod_habitacion' => 'HAB_EV_101'], [
            'cod_habitacion' => 'HAB_EV_101',
        ...
        $this->cama = Cama::firstOrCreate(['cod_cama' => 'CAM_EV_101A'], [
            'cod_cama' => 'CAM_EV_101A',
        ...
        OcupacionCama::firstOrCreate(['cod_cama' => 'CAM_EV_101A'], [
    ...
    public function test_registro_de_nuevo_evento_clinico_se_guarda_en_bd_y_aparece_en_timeline(): void
    {
        ...
        $this->assertDatabaseHas('incidentes', [
            'cod_residente' => $this->adulto->cod_residente ?? $this->adulto->cod_am,
