...
use App\Models\{AdultoMayor, User, AdministracionMedicacion, AtencionAdulto, TipoAtencionAdulto};
...
class RegistrosClinicosTest extends TestCase
{
    ...
    public function test_administracion_acepta_codigo_real_y_rechaza_medicacion_de_otro_adulto(): void
    {
        ...
        $med = Prescripcion::create(['cod_am' => $adulto->cod_am, 'nombre_medicamento' => 'Orden de prueba', 'dosis' => 'Según orden', 'via_administracion' => 'ORAL', 'frecuencia' => 'Diaria', 'hora_programada' => '08:00', 'fecha_inicio' => today(), 'estado' => 'ACTIVO']);
