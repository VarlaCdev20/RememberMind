...
class TipoDocumentoUsuarioSeeder extends Seeder
{
    ...
    {
        $allRoles = ['SUPERADMINISTRADOR', 'ADMINISTRADOR', 'ENFERMEROS', 'MEDICO GENERAL/GERIATRA', 'PSICOLOGO/A', 'PEDAGOGO', 'NUTRICIONISTA', 'FISIOTERAPEUTA', 'VOLUNTARIO', 'FAMILIAR'];
        $staffRoles = ['SUPERADMINISTRADOR', 'ADMINISTRADOR', 'ENFERMEROS', 'MEDICO GENERAL/GERIATRA', 'PSICOLOGO/A', 'PEDAGOGO', 'NUTRICIONISTA', 'FISIOTERAPEUTA', 'VOLUNTARIO'];
        $clinicalRoles = ['ENFERMEROS', 'MEDICO GENERAL/GERIATRA', 'PSICOLOGO/A', 'PEDAGOGO', 'NUTRICIONISTA', 'FISIOTERAPEUTA'];
        $hiringRoles = ['SUPERADMINISTRADOR', 'ADMINISTRADOR', 'ENFERMEROS', 'MEDICO GENERAL/GERIATRA', 'PSICOLOGO/A', 'PEDAGOGO', 'NUTRICIONISTA', 'FISIOTERAPEUTA'];
        $cvRoles = ['ADMINISTRADOR', 'ENFERMEROS', 'MEDICO GENERAL/GERIATRA', 'PSICOLOGO/A', 'PEDAGOGO', 'NUTRICIONISTA', 'FISIOTERAPEUTA'];
        $policeRoles = ['ADMINISTRADOR', 'ENFERMEROS', 'MEDICO GENERAL/GERIATRA', 'PSICOLOGO/A', 'PEDAGOGO', 'NUTRICIONISTA', 'FISIOTERAPEUTA', 'VOLUNTARIO'];
        ...
        $tipos = [
            ...
            [
                ...
                'aplica_roles' => ['SUPERADMINISTRADOR', 'ADMINISTRADOR'],
                'obligatorio' => true,
                'requiere_vencimiento' => false,
                'requiere_validacion' => true,
                'orden' => 5,
