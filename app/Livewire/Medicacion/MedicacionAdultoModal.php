...
class MedicacionAdultoModal extends Component
{
    ...
    public function rules()
    {
        return [
            ...
            'intervalo_horas' => 'required_if:es_prn,true|nullable|integer|min:1|max:24',
    ...
    public function messages()
    {
        return [
            ...
            'intervalo_horas.required_if' => 'La medicación PRN requiere un intervalo mínimo entre dosis.',
