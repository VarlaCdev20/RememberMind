...
class AreasAtencionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            try {
                $alertasActivas = Alerta::whereIn('estado', ['ABIERTA', 'EN_ATENCION'])->count();
            } catch (\Throwable $e2) {
                $alertasActivas = 0;
            }
        }
        ...
        $areas = [
            ...
            // ÁREA SOCIAL Y FAMILIAS
            'social' => [
                'id' => 'social',
                'nombre' => 'Área Social y Red Familiar',
                'rol_principal' => 'FAMILIAR',
                'rol_etiqueta' => 'Trabajo Social y Familias',
                'icono' => 'ph-hand-heart',
                'color' => 'rose',
                ...
                'descripcion' => 'Acompañamiento psicosocial, vinculación de tutores y gestión de la red de apoyo familiar.',
                'subdivisiones' => [
                    'social' => [
                        'titulo' => 'Vistas Sociales y Comunitarias',
                        'subtitulo' => 'Gestión de familias, admisiones y red de apoyo',
                        'icono' => 'ph-users-three',
                        'vistas' => [
                            [
