    ...
    private function identificarRegistroAfectado($log): string
    {
        ...
        try {
            return match ($log->subject_type) {
                ...
                'App\\Models\\Familiar', 'App\\Models\\Contacto' => DB::table('contactos')->where('cod_contacto', $log->subject_id)->value(DB::raw("TRIM(nombres || ' ' || apellido_paterno)")) ?? "Contacto: $log->subject_id",
