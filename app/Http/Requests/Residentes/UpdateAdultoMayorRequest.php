...
class UpdateAdultoMayorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Consentimiento (Opcional en actualización si ya aceptó antes)
            'consentimiento_datos' => ['nullable', 'boolean'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'ci_unique' => 'La combinación de CI, complemento y expedición ya está registrada para otro adulto mayor.',
