        ...
        return [
            'nombres'              => [
                ...
                function ($attribute, $value, $fail) {
                    $exists = \App\Models\Personal::where('nombres', $this->nombres)->where('apellido_paterno', $this->ap_paterno)->where('apellido_materno', $this->ap_materno)->exists();
                    if ($exists) {
            ...
            'numero_documento'     => [
                'required', 'string', 'max:30', 'unique:personal,numero_documento',
                function ($attribute, $value, $fail) {
