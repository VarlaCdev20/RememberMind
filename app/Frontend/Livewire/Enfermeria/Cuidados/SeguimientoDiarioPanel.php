...
class SeguimientoDiarioPanel extends Component
{
    ...
    public function abrirCrear(): void
    {
        ...
        $this->reset([
            'editandoId', 'codResidente', 'codPlan', 'horaFin', 'higiene', 'orientacion',
    ...
    public function guardar(): void
    {
        ...
        $this->validate([
            ...
            'codPlan'               => ['nullable', \Illuminate\Validation\Rule::exists('planes_cuidado','cod_plan')->where('cod_residente', $this->codResidente)],
        ...
        $turnoVigente = app(\App\Backend\Modulos\Enfermeria\Servicios\TurnoEnfermeriaService::class)
        ...
        if ($this->codPlan !== '' && !PlanCuidado::where('cod_plan', $this->codPlan)->where('cod_residente', $this->codResidente)->exists()) {
