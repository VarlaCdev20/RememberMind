...
$this->cod_est_adul = 'ACTIVO';
    ...
    private function cargarAdulto()
    {
        ...
        $this->ap_materno = $adulto->apellido_materno;
        $this->ci = $adulto->numero_documento;
        $this->complemento_ci = $adulto->complemento_documento;
        $this->expedicion_ci = $adulto->expedicion_documento;
    ...
    private function validarPaso()
    {
        ...
        switch ($this->paso) {
            case 1:
                ...
                $ciUnique = Rule::unique('residentes', 'numero_documento');
                if ($this->isEdit) {
                    $ciUnique->ignore($this->adultoId, 'cod_residente');
                }
...
$codEst = 'ACTIVO';
        ...
        try {
            ...
            abort_unless($this->isEdit && $this->adultoId, 403, 'El residente solo puede crearse mediante la admisión formal.');
