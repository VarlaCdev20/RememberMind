...
class AlertasService
{
    ...
    public function crear(string $codResidente, array $datos, User $usuario, string $permiso = 'alertas.gestionar'): Alerta
    {
        ...
        return DB::transaction(function () use ($codResidente, $datos, $tipo, $usuario) {
