...
<body class="bg-app-institucional font-sans antialiased text-texto-principal min-h-screen overflow-x-hidden selection:bg-[#D96C33] selection:text-white relative">
    ...
    <header x-data="{ open: false, scrolled: false }" 
        ...
        <div :class="scrolled 
                ? 'bg-[#FFFDF9]/72 backdrop-blur-xl shadow-[0_14px_35px_rgba(47,36,31,0.16)] border border-[#006B5E]/18 h-16 md:h-18' 
                : 'bg-[#FFFDF9]/42 backdrop-blur-md shadow-[0_8px_24px_rgba(47,36,31,0.08)] border border-[#006B5E]/12 h-20 md:h-22'" 
            ...
            <div class="flex justify-between items-center w-full">
                ...
                <div class="flex-shrink-0 flex items-center gap-2.5 group cursor-pointer z-[60]">
                    ...
                    <a href="#" class="hidden max-w-[210px] font-outfit text-[11px] font-extrabold uppercase leading-[1.05] tracking-wide text-azul-profundo transition-colors group-hover:text-[#006B5E] sm:block">CENTRO GERIÁTRICO<br>JARDÍN DE LOS RECUERDOS</a>
                </div>

                {{-- Menú Escritorio --}}
                <div class="hidden lg:flex items-center space-x-5 xl:space-x-8">
                    <a href="#inicio" class="relative flex items-center gap-1.5 text-base font-extrabold text-azul-profundo hover:text-[#006B5E] transition-colors hover-underline group"><i class="ph-bold ph-house text-lg group-hover:scale-110 transition-transform"></i>Inicio</a>
                    <a href="#problema" class="relative flex items-center gap-1.5 text-base font-extrabold text-azul-profundo hover:text-[#006B5E] transition-colors hover-underline group"><i class="ph-bold ph-stethoscope text-lg group-hover:scale-110 transition-transform"></i>Servicios</a>
                    <a href="#experiencia" class="relative flex items-center gap-1.5 text-base font-extrabold text-azul-profundo hover:text-[#006B5E] transition-colors hover-underline group"><i class="ph-bold ph-heart text-lg group-hover:scale-110 transition-transform"></i>Experiencia</a>
                    <a href="#servicios" class="relative flex items-center gap-1.5 text-base font-extrabold text-azul-profundo hover:text-[#006B5E] transition-colors hover-underline group"><i class="ph-bold ph-star text-lg group-hover:scale-110 transition-transform"></i>Actividades</a>
                    <a href="#impacto" class="relative flex items-center gap-1.5 text-base font-extrabold text-azul-profundo hover:text-[#006B5E] transition-colors hover-underline group"><i class="ph-bold ph-chart-line-up text-lg group-hover:scale-110 transition-transform"></i>Impacto</a>
                </div>
                ...
                <div class="hidden lg:flex items-center gap-3">
                    ...
                    <button
                        ...
                        class="flex items-center gap-1.5 rounded-full bg-[#CBEFE8]/75 px-3 py-2 text-xs font-black text-[#0B4F46] border border-[#006B5E]/18 shadow-sm transition-all hover:bg-[#006B5E] hover:text-white hover:border-[#006B5E] active:scale-95"
                    >
                ...
                <div class="lg:hidden flex items-center gap-2">
                    ...
                    <button
                        ...
                        data-theme-toggle
                        aria-label="Cambiar modo claro u oscuro"
                        class="flex h-9 w-9 items-center justify-center rounded-full bg-[#CBEFE8]/75 text-[#0B4F46] border border-[#006B5E]/18 shadow-sm transition-all hover:bg-[#006B5E] hover:text-white active:scale-95"
                    >
                        <i class="ph-bold ph-moon text-base" data-theme-icon data-icon-dark="ph-bold ph-moon text-base" data-icon-light="ph-bold ph-sun text-base"></i>
                    </button>
                    <button @click.stop="open = true" type="button" class="text-[#0B4F46] bg-[#CBEFE8] p-1.5 rounded-full hover:bg-[#F28B54] hover:text-white focus:outline-none transition-all duration-300 shadow-sm" aria-label="Abrir menú">
        ...
        <aside x-show="open" x-cloak
             ...
             class="fixed top-0 right-0 h-screen w-[85%] max-w-sm bg-[#FAF6EF] shadow-[0_0_50px_rgba(47,36,31,0.30)] z-[90] lg:hidden flex flex-col border-l border-[#006B5E]/16 pointer-events-auto">
             
            <div class="p-5 flex justify-between items-center border-b border-[#006B5E]/14">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('storage/images/LOGO.png') }}"
                         alt="CENTRO GERIÁTRICO JARDÍN DE LOS RECUERDOS"
                         class="h-10 w-auto object-contain">
                    <div class="leading-tight">
                        <p class="font-outfit text-xs font-extrabold uppercase text-azul-profundo">CENTRO GERIÁTRICO</p>
                        <p class="font-outfit text-xs font-extrabold uppercase text-[#006B5E]">JARDÍN DE LOS RECUERDOS</p>
                    </div>
                </div>
                <button @click="open = false" type="button" class="text-azul-profundo p-2 bg-[#CBEFE8] rounded-full hover:bg-[#F28B54] hover:text-white transition-all shadow-md active:scale-90" aria-label="Cerrar menú">
            ...
            <div class="px-6 py-6 flex flex-col gap-3 overflow-y-auto flex-grow">
                ...
                <div class="mt-auto pt-6 border-t border-[#006B5E]/14 space-y-3">
                    {{-- Botón modo oscuro en móvil --}}
                    <button
                        type="button"
                        data-theme-toggle
                        aria-label="Cambiar modo claro u oscuro"
                        class="flex w-full items-center justify-center gap-2 rounded-full bg-[#CBEFE8] border border-[#006B5E]/18 px-5 py-3 text-base font-black text-[#0B4F46] transition-all hover:bg-[#006B5E] hover:text-white hover:border-[#006B5E] active:scale-95"
                    >
    ...
    <section id="inicio" class="relative min-h-screen flex flex-col justify-center pt-36 md:pt-40 pb-12 overflow-hidden z-0 w-full">
        ...
        <div class="hero-blob bg-blob-1 absolute top-10 left-10 w-[40rem] h-[40rem] bg-[#5ED3E6]/18 rounded-full mix-blend-multiply filter blur-[120px] animate-pulse-slow -z-10"></div>
        <div class="hero-blob bg-blob-2 absolute top-40 right-0 w-[35rem] h-[35rem] bg-[#97E3D5]/24 rounded-full mix-blend-multiply filter blur-[120px] animate-pulse-slow -z-10" style="animation-delay: 2s;"></div>
        <div class="hero-blob bg-blob-3 absolute -bottom-20 left-1/4 w-[45rem] h-[35rem] bg-[#F28B54]/14 rounded-[100%] mix-blend-multiply filter blur-[120px] animate-pulse-slow -z-10" style="animation-delay: 4s;"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center relative z-10 flex flex-col justify-center mt-6">
            ...
            <div class="floating-element top-[10%] left-[25%] text-[#F28B54] text-3xl hidden lg:block" style="animation-delay: 3s;"><i class="ph ph-hand-heart"></i></div>
            <div class="floating-element bottom-[30%] left-[8%] text-[#F28B54] text-4xl hidden lg:block" style="animation-delay: 2s;"><i class="ph ph-brain"></i></div>
            ...
            <div class="floating-element top-[60%] left-[15%] text-[#006B5E] text-4xl hidden lg:block" style="animation-delay: 7s; opacity: 0.1;"><i class="ph ph-leaf"></i></div>
            ...
            <div class="floating-element top-[25%] right-[5%] text-[#F28B54] text-4xl hidden lg:block" style="animation-delay: 1.5s;"><i class="ph ph-pill"></i></div>
            ...
            <div class="floating-element bottom-[40%] right-[20%] text-[#2EA9C0] text-2xl hidden lg:block" style="animation-delay: 6s;"><i class="ph ph-flower"></i></div>
            ...
            <div class="floating-element bottom-[5%] right-[30%] text-[#F28B54] text-3xl hidden lg:block" style="animation-delay: 4.5s; opacity: 0.1;"><i class="ph ph-first-aid"></i></div>
            ...
            <div class="hero-text flex flex-col items-center">
                ...
                {{-- Badge de Confianza --}}
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#CBEFE8]/70 border border-[#006B5E]/14 text-[#0B4F46] text-xs md:text-sm font-bold mb-6 md:mb-8" data-aos="fade-down">
                    <span class="flex h-2 w-2 rounded-full bg-[#006B5E] animate-pulse"></span>
                    Confianza de +500 familias en la región
                </div>

                {{-- TITULO PRINCIPAL --}}
                <h1 class="font-outfit text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-azul-profundo leading-[1.05] mb-6 md:mb-8 tracking-tighter uppercase text-shadow-deep text-center">
                    JARDÍN DE
                    <span class="text-[#006B5E] relative whitespace-nowrap block sm:inline-block">
                        LOS RECUERDOS
                        <svg class="absolute -bottom-2 left-0 w-full text-[#5ED3E6]/45 -z-10 parallax-underline" viewBox="0 0 100 20" preserveAspectRatio="none">
                            <path d="M0,10 Q50,20 100,10" stroke="currentColor" stroke-width="8" fill="none" stroke-linecap="round"/>
                        </svg>
                    </span>
                </h1>

                <p class="text-sm font-black uppercase tracking-widest text-azul-profundo/60 mb-3 md:mb-4" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 w-full sm:w-auto" data-aos="zoom-in" data-aos-delay="400">
                    ...
                    <a href="#problema" class="btn-secundario-institucional w-full sm:w-auto relative overflow-hidden group px-8 md:px-10 py-4 md:py-5 font-extrabold rounded-full text-base md:text-lg transition-all duration-300 hover:-translate-y-1 active:scale-95 active:translate-y-1 shadow-md text-center">
                        ...
                        <div class="absolute inset-0 bg-[#CBEFE8]/40 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out"></div>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="mt-16 md:mt-24 w-full relative overflow-hidden flex flex-col justify-center" data-aos="fade-in" data-aos-delay="600">
            ...
            <div class="inline-flex gap-4 md:gap-8 animate-marquee w-max py-8 hover:cursor-grab active:cursor-grabbing">
                ...
                @foreach($loopImages as $i => $img)
                    <div class="shrink-0 overflow-hidden shadow-[0_15px_30px_rgba(47,36,31,0.14)] relative border-4 border-[#FFFDF9] transition-transform duration-500 hover:-translate-y-2 hover:shadow-[0_25px_50px_rgba(0,107,94,0.20)]"
        ...
        <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-azul-profundo/40 z-20" data-aos="fade-up" data-aos-delay="1000">
            ...
            <div class="w-[1px] h-12 bg-gradient-to-b from-azul-profundo/40 to-transparent relative">
                <div class="absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 bg-[#F28B54] rounded-full scroll-indicator"></div>
            </div>
        </div>
    </section>

    {{-- 3. SERVICIOS QUE OFRECEMOS --}}
    <section id="problema" class="py-16 md:py-24 lg:py-32 bg-[#F1E7DA]/72 relative overflow-hidden">
        ...
        <div class="floating-element bottom-[15%] right-[5%] text-[#F28B54] text-6xl opacity-[0.07]" style="animation-delay: 3s;"><i class="ph ph-heartbeat"></i></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                <div class="card-interactiva group rounded-[3rem] p-8 md:p-10 cursor-default" data-aos="fade-up" data-aos-delay="100">
                    <div class="w-16 h-16 bg-[#F6B08A]/24 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-[#F28B54] group-hover:text-white transition-all duration-500 text-[#F28B54] shadow-inner group-hover:rounded-full group-hover:rotate-12">
                        <i class="ph-fill ph-stethoscope text-3xl icon-pulse"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-azul-profundo mb-4 group-hover:text-[#F28B54] transition-colors">Cuidado Médico</h3>
                ...
                <div class="card-interactiva group rounded-[3rem] p-8 md:p-10 cursor-default" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-16 h-16 bg-[#5ED3E6]/18 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-[#2EA9C0] group-hover:text-white transition-all duration-500 text-[#2EA9C0] shadow-inner group-hover:rounded-full group-hover:rotate-12">
                        <i class="ph-fill ph-brain text-3xl icon-pulse"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-azul-profundo mb-4 group-hover:text-[#2EA9C0] transition-colors">Estimulación</h3>
                    <p class="text-texto-secundario text-base md:text-lg leading-relaxed font-medium">
                ...
                <div class="card-interactiva group rounded-[3rem] p-8 md:p-10 cursor-default" data-aos="fade-up" data-aos-delay="300">
                    <div class="w-16 h-16 bg-[#CBEFE8]/75 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-[#006B5E] group-hover:text-white transition-all duration-500 text-[#006B5E] shadow-inner group-hover:rounded-full group-hover:rotate-12">
                        <i class="ph-fill ph-hands-clapping text-3xl icon-pulse"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-azul-profundo mb-4 group-hover:text-[#006B5E] transition-colors">Acompañamiento</h3>
                    <p class="text-texto-secundario text-base md:text-lg leading-relaxed font-medium">
    ...
    <section id="experiencia" class="py-16 md:py-24 lg:py-32 relative overflow-hidden bg-[#FAF6EF]">
        {{-- Iconos flotantes en Experiencia --}}
        <div class="floating-element top-[20%] right-[15%] text-[#F28B54] text-5xl opacity-[0.08]" style="animation-delay: 2s;"><i class="ph ph-hand-waving"></i></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="space-y-6 md:space-y-8" data-aos="fade-right">
                    <h2 class="font-outfit text-4xl sm:text-5xl lg:text-6xl font-extrabold text-azul-profundo leading-[1.1] text-shadow-title">
                        El valor profundo de <br class="hidden sm:block"><span class="text-[#F28B54]">sentirse en casa</span>.
                    </h2>
                    ...
                    <ul class="space-y-4 md:space-y-6 pt-4 md:pt-6">
                        <li class="card-interactiva group flex items-center gap-4 md:gap-5 p-4 md:p-5 rounded-[2rem] cursor-default">
                            <div class="flex-shrink-0 w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-[#CBEFE8]/75 text-[#006B5E] flex items-center justify-center transition-transform duration-500 group-hover:rotate-12 group-hover:rounded-full group-hover:scale-110 shadow-inner">
                                <i class="ph-fill ph-sun-horizon text-2xl md:text-3xl"></i>
                            </div>
                            <span class="text-xl md:text-2xl font-bold text-azul-profundo group-hover:text-[#006B5E] transition-colors">Ambiente cálido y familiar</span>
                        </li>
                        <li class="card-interactiva group flex items-center gap-4 md:gap-5 p-4 md:p-5 rounded-[2rem] cursor-default">
                            <div class="flex-shrink-0 w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-[#F6B08A]/24 text-[#F28B54] flex items-center justify-center transition-transform duration-500 group-hover:rotate-12 group-hover:rounded-full group-hover:scale-110 shadow-inner">
                                <i class="ph-fill ph-hand-heart text-2xl md:text-3xl"></i>
                            </div>
                            <span class="text-xl md:text-2xl font-bold text-azul-profundo group-hover:text-[#F28B54] transition-colors">Vocación de servicio real</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="relative h-[400px] sm:h-[500px] md:h-[650px] w-full mt-10 lg:mt-0" data-aos="fade-left">
                    <div class="parallax-img-1 absolute top-0 right-0 w-[85%] h-[75%] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-[0_30px_60px_rgba(47,36,31,0.22)] z-20 group border-4 md:border-8 border-[#FAF6EF]">
                        ...
                        <div class="absolute inset-0 bg-[#5ED3E6]/0 group-hover:bg-[#5ED3E6]/10 transition-colors duration-500"></div>
                    </div>
                    
                    <div class="parallax-img-2 absolute bottom-0 left-0 w-[70%] h-[55%] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-[0_30px_60px_rgba(47,36,31,0.22)] border-4 md:border-[8px] border-[#FFFDF9] z-30 group">
                        ...
                        <div class="absolute inset-0 bg-[#97E3D5]/0 group-hover:bg-[#97E3D5]/10 transition-colors duration-500"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="servicios" class="py-16 md:py-24 lg:py-32 bg-[#F1E7DA]/72 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto mb-12 md:mb-20" data-aos="fade-up">
                <h2 class="font-outfit text-4xl md:text-5xl lg:text-6xl font-extrabold text-azul-profundo mb-4 md:mb-6 text-shadow-title">
                    Atención diseñada con el <span class="text-[#F28B54]">corazón</span>
                </h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
                @php
                    $actividades = [
                        ['Nutrición Adaptada', 'Dietas personalizadas elaboradas por especialistas para mantener una salud digestiva.', 'ph-apple-logo', '#F28B54', 'bg-[#F6B08A]/24'],
                        ['Fisioterapia', 'Movimiento constante guiado por expertos para conservar la movilidad.', 'ph-person-arms-spread', '#006B5E', 'bg-[#CBEFE8]/75'],
                        ['Arte y Color', 'Espacios creativos donde la pintura libera el estrés y fomenta la expresión.', 'ph-palette', '#2EA9C0', 'bg-[#5ED3E6]/18'],
                        ['Musicoterapia', 'Tardes musicales que despiertan emociones y devuelven la sonrisa.', 'ph-music-notes', '#F28B54', 'bg-[#F6B08A]/24'],
                        ['Lazos Familiares', 'Organizamos celebraciones para que el vínculo familiar nunca se debilite.', 'ph-users-three', '#0B4F46', 'bg-[#97E3D5]/28'],
                        ['Paz Mental', 'Psicólogos disponibles para asegurar que cada día se viva con tranquilidad.', 'ph-flower-lotus', '#006B5E', 'bg-[#CBEFE8]/75'],
                    ];
                @endphp
                ...
                @foreach($actividades as $index => $s)
                    <div class="card-interactiva group h-full flex flex-col rounded-[3rem] p-8 md:p-10 cursor-default" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                        ...
                        <div class="w-8 h-1.5 bg-[#006B5E]/18 rounded-full mt-6 transition-all duration-500 group-hover:bg-[{{ $s[3] }}] group-hover:w-full"></div>
                    </div>
                @endforeach
            </div>
        </div>
    ...
    <section id="impacto" class="py-16 md:py-24 bg-[#0B4F46] relative overflow-hidden text-white" x-data="impactDashboard()">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div data-aos="fade-right">
                    <span class="text-[#97E3D5] font-bold tracking-wider uppercase text-sm mb-4 block">Nuestro Impacto</span>
                    <h2 class="font-outfit text-4xl md:text-5xl font-extrabold mb-6 text-shadow-title">
                        Tecnología al servicio de la <span class="text-[#F6B08A]">memoria</span>
                    </h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="group border-l-4 border-[#F28B54] pl-4 transition-all duration-300 hover:border-white">
                        ...
                        <div class="group border-l-4 border-[#5ED3E6] pl-4 transition-all duration-300 hover:border-white">
                ...
                <div class="group bg-white/10 backdrop-blur-md rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-8 border border-[#5ED3E6]/18 shadow-[0_30px_60px_rgba(0,0,0,0.34)] transition-all duration-500 hover:bg-white/15 hover:shadow-[0_40px_80px_rgba(0,0,0,0.48)] hover:border-[#97E3D5]/35 w-full overflow-hidden" data-aos="fade-left">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-base md:text-lg font-bold">Evolución Cognitiva Promedio</h3>
                        <div class="w-3 h-3 rounded-full bg-[#5ED3E6] animate-ping"></div>
                    </div>
    ...
    <footer id="contacto" class="bg-[#FAF6EF] pt-16 md:pt-20 pb-8 border-t border-[#006B5E]/14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-12 mb-12 md:mb-16">
                ...
                <div class="sm:col-span-2" data-aos="fade-up">
                    <div class="flex items-center gap-3 mb-6 group cursor-pointer w-fit">
                        ...
                        <h2 class="font-outfit text-xl font-extrabold tracking-tight text-azul-profundo group-hover:text-[#006B5E] transition-colors leading-tight">CENTRO GERIÁTRICO<br>JARDÍN DE LOS RECUERDOS</h2>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        @foreach($socials as $social)
                            <a href="#" class="group flex items-center gap-0 overflow-hidden rounded-full bg-[#FFFDF9] p-3 shadow-md border border-[#006B5E]/14 transition-all duration-300 hover:gap-3 hover:px-5 hover:shadow-lg hover:border-[#F28B54]/45 hover:-translate-y-1 active:scale-95">
                ...
                <div data-aos="fade-up" data-aos-delay="100">
                    ...
                    <ul class="space-y-4 text-base font-bold text-azul-profundo/80">
                        <li><a href="#inicio" class="hover:text-[#F28B54] transition-colors hover:translate-x-1 inline-block">Inicio</a></li>
                        <li><a href="#problema" class="hover:text-[#F28B54] transition-colors hover:translate-x-1 inline-block">Servicios</a></li>
                        <li><a href="#experiencia" class="hover:text-[#F28B54] transition-colors hover:translate-x-1 inline-block">Experiencia</a></li>
                        <li><a href="#servicios" class="hover:text-[#F28B54] transition-colors hover:translate-x-1 inline-block">Actividades</a></li>
                        @if (Route::has('login'))
                            <li><a href="{{ route('login') }}" class="hover:text-[#F28B54] transition-colors hover:translate-x-1 inline-block">Acceso Institucional</a></li>
                        @endif
                    </ul>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul class="space-y-4 text-base font-bold text-azul-profundo/80">
                        <li class="flex items-start gap-3 group cursor-pointer">
                            <i class="ph-fill ph-map-pin text-2xl text-[#F28B54] mt-0.5 group-hover:-translate-y-1 transition-transform"></i>
                        ...
                        <li class="flex items-center gap-3 group cursor-pointer">
                            <i class="ph-fill ph-phone-call text-2xl text-[#F28B54] group-hover:scale-110 transition-transform"></i>
            ...
            <div class="border-t border-[#006B5E]/14 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm font-bold text-azul-profundo/80 text-center md:text-left">
