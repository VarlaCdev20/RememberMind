...
<div class="group relative flex flex-col overflow-hidden rounded-3xl border border-borde-suave bg-fondo-card shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-terracota/10">
 ...
 <a href="{{ $ruta }}"
 class="mt-4 w-full rounded-xl bg-boton-acento py-2.5 text-center text-[11px] font-bold uppercase tracking-wider text-inverso shadow-sm transition-all hover:bg-boton-acento-dark active:scale-95 group-hover:shadow-md group-hover:shadow-terracota/25">
 {{ $boton }}
 </a>
 </div>
</div>
