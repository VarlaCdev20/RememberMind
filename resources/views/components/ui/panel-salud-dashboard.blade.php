...
<div class="rm-card rounded-[2rem] p-5">
 ...
 <h2 class="text-lg font-extrabold text-titulo">Resumen clínico-asistencial</h2>
 ...
 <div class="mt-1 text-xl font-extrabold text-modulo-salud">{{ $resumen['medicacionesActivas'] ?? 0 }}</div>
 ...
 <div class="mt-1 text-xl font-extrabold {{ ($resumen['altaDependencia'] ?? 0) > 0 ? 'text-estado-advertencia-texto' : 'text-titulo' }}">
 ...
 <div>
 <p class="text-[10px] font-bold uppercase tracking-wide text-meta">Riesgo caída</p>
 <p class="text-base font-extrabold {{ ($resumen['riesgoCaidaAlto'] ?? 0) > 0 ? 'text-estado-advertencia-texto' : 'text-titulo' }}">
 ...
 <div>
 <p class="text-[10px] font-bold uppercase tracking-wide text-meta">Medicación hoy</p>
 <p class="text-base font-extrabold text-titulo">{{ $resumen['adminMedicacionHoy'] ?? 0 }}</p>
