...
<div class="rm-card rounded-[2rem] p-5">
 ...
 <div>
 <p class="text-[11px] font-bold uppercase tracking-wide text-meta">Personal de salud</p>
 <p class="text-xl font-extrabold text-titulo">{{ $salud['total'] ?? 0 }}</p>
 </div>
 </div>
 ...
 <span class="ml-1 shrink-0 text-[10px] font-bold text-modulo-cognitivoTexto">{{ $esp['total'] }}</span>
 </div>
 @endforeach
 </div>
 @endif
 ...
 <div>
 <p class="text-[11px] font-bold uppercase tracking-wide text-meta">Personal admin.</p>
 <p class="text-xl font-extrabold text-titulo">{{ $admin['total'] ?? 0 }}</p>
 </div>
 </div>
 ...
 <span class="ml-1 shrink-0 text-[10px] font-bold text-boton-acento">{{ $cargo['total'] }}</span>
 </div>
 @endforeach
 </div>
 @endif
 ...
 <div>
 <p class="text-[11px] font-bold uppercase tracking-wide text-meta">Voluntarios</p>
 <p class="text-xl font-extrabold text-titulo">{{ $vol['total'] ?? 0 }}</p>
 </div>
 </div>
 ...
 <span class="ml-1 shrink-0 text-[10px] font-bold text-modulo-voluntariosTexto">{{ $area['total'] }}</span>
 </div>
 @endforeach
 </div>
 @endif
 ...
 <span class="text-xs font-bold uppercase tracking-wide text-meta">Red familiar</span>
 </div>

 <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
 <div class="rounded-xl bg-fondo-card px-3 py-2 text-center">
 <p class="text-lg font-extrabold text-titulo">{{ $totalFam }}</p>
 <p class="text-[10px] font-bold uppercase tracking-wide text-meta">Familiares</p>
 </div>
 <div class="rounded-xl bg-fondo-card px-3 py-2 text-center">
 <p class="text-lg font-extrabold text-modulo-salud">{{ $conFam }}</p>
 <p class="text-[10px] font-bold uppercase tracking-wide text-meta">Con familiar</p>
 </div>
 <div class="rounded-xl bg-fondo-card px-3 py-2 text-center {{ $sinFam > 0 ? 'border border-boton-acento' : '' }}">
 <p class="text-lg font-extrabold {{ $sinFam > 0 ? 'text-boton-acento' : 'text-titulo' }}">{{ $sinFam }}</p>
 <p class="text-[10px] font-bold uppercase tracking-wide text-meta">Sin familiar</p>
 </div>
 <div class="rounded-xl bg-fondo-card px-3 py-2 text-center">
 <p class="text-lg font-extrabold text-titulo">{{ $responsables }}</p>
 <p class="text-[10px] font-bold uppercase tracking-wide text-meta">Responsables</p>
 </div>
 </div>
