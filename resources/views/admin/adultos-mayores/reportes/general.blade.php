    ...
    <div class="bg-fondo-card p-4 sm:p-8 min-h-screen font-outfit text-titulo">
        ...
        <div class="mb-10 flex flex-col sm:flex-row items-center justify-between border-b-2 border-borde-fuerte pb-6">
            ...
            <div class="mt-4 sm:mt-0 no-print">
                <button onclick="window.print()" class="rounded-full bg-boton-principal px-8 py-3 text-xs font-black text-inverso shadow-xl transition hover:bg-fondo-panel active:scale-95">
        ...
        <div class="mb-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-3xl border border-borde bg-fondo-panel p-6 shadow-sm">
                <p class="text-[10px] font-black uppercase tracking-[0.2em] text-apoyo">Población Total</p>
            ...
            <div class="rounded-3xl border border-borde bg-fondo-card p-6 shadow-sm">
                <p class="text-[10px] font-black uppercase tracking-[0.2em] text-apoyo">Calidad de Vida</p>
                <div class="mt-2 flex items-end justify-between">
                    <div>
                        <h3 class="text-4xl font-black text-parrafo">{{ $stats['act_totales'] }}</h3>
                        <p class="text-[10px] font-black uppercase text-apoyo">Actividades</p>
                    </div>
                    <div class="text-right">
                        <p class="text-xl font-black text-parrafo">{{ $stats['eval_totales'] }}</p>
                        <p class="text-[10px] font-black uppercase text-apoyo">Evaluaciones</p>
                    </div>
                </div>
            </div>
                ...
                <div class="rounded-[2.5rem] border border-borde bg-fondo-card overflow-hidden shadow-sm">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            <thead>
                                <tr class="text-[10px] font-black uppercase tracking-widest text-apoyo border-b border-borde">
                            ...
                            <tbody class="divide-y divide-[#F2EBE3]">
                                @foreach($adultos as $adulto)
                                    <tr class="hover:bg-fondo-panel transition-colors">
                                        <td class="px-8 py-4 text-xs font-black text-apoyo">{{ $adulto->cod_am }}</td>
                                        <td class="px-8 py-4">
                                            <p class="text-sm font-black text-titulo">{{ $adulto->nombres }} {{ $adulto->ap_paterno }}</p>
        ...
        <div class="mt-20 flex flex-col items-center gap-4 text-center">
            ...
            <p class="text-[10px] font-black text-apoyo uppercase tracking-[0.4em]">Reporte Consolidado por RememberMind System</p>
