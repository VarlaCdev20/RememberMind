<x-app-layout>
 ...
 <div class="space-y-6">
 <h2 class="text-xl font-extrabold text-titulo border-b border-borde pb-2 uppercase tracking-widest flex items-center gap-2">
 ...
 <p class="text-[10px] font-bold uppercase text-apoyo">Atenciones Médicas</p>
 ...
 <div class="rounded-3xl border border-borde bg-fondo-card p-6 shadow-sm">
 <p class="text-[10px] font-bold uppercase text-apoyo">Actividades Realizadas</p>
 ...
 <div class="rounded-3xl border border-borde bg-fondo-card p-6 shadow-sm">
 <p class="text-[10px] font-bold uppercase text-apoyo">Monitoreo Cognitivo</p>
 ...
 <div class="rounded-3xl border border-borde bg-fondo-card p-6 shadow-sm">
 <p class="text-[10px] font-bold uppercase text-apoyo">Índice de Confianza</p>
 ...
 <h2 class="text-xl font-extrabold text-inverso mb-6 uppercase tracking-widest flex items-center gap-2">
 ...
 <span class="text-xs font-bold uppercase">Población Atendida</span>
 <span class="text-xs font-bold">{{ $stats['poblacion'] }} residentes</span>
 </div>
 ...
 <h4 class="text-sm font-bold mb-3">Misión Cumplida</h4>
 <p class="text-sm font-medium text-inverso/70 leading-relaxed">"CENTRO GERIÁTRICO JARDÍN DE LOS RECUERDOS" se consolida como el referente en cuidado cognitivo regional, utilizando RememberMind para garantizar que ningún adulto mayor pierda su identidad sin un acompañamiento profesional.
 </p>
 </div>
 </div>

 <div class="mt-10 flex justify-center">
 <button onclick="window.print()" class="rounded-full bg-fondo-card px-8 py-3 text-sm font-bold text-titulo shadow-lg transition hover:scale-105 active:scale-95">
 ...
 <p class="text-[10px] font-bold uppercase tracking-[0.3em] text-apoyo">Documento Informativo Institucional — {{ date('Y') }}</p>
 </div>
 </div>
