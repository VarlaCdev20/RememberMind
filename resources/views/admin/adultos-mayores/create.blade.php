            ...
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="mt-1 max-w-2xl text-sm font-bold leading-5 text-titulo/60">
                        Complete el proceso de admisión inicial. Los campos obligatorios están marcados con (*).
                    </p>
                </div>
        ...
        <form method="POST" action="{{ route('admin.adultos-mayores.store') }}" enctype="multipart/form-data" onsubmit="procesarFormulario(event)">
            ...
            <section x-show="paso === 1" x-transition.opacity.duration.250ms class="bg-transparent pt-4 border-t border-borde-suave">
                ...
                <div class="grid gap-4 md:grid-cols-3">
                    <div>
                        ...
                        <input name="nombres" value="{{ old('nombres') }}" placeholder="Ej. MARÍA ELENA" oninput="this.value = this.value.toUpperCase()"
                    ...
                    <div>
                        ...
                        <input name="ap_paterno" value="{{ old('ap_paterno') }}" placeholder="Ej. MAMANI" oninput="this.value = this.value.toUpperCase()"
                    ...
                    <div>
                        ...
                        <input name="ap_materno" value="{{ old('ap_materno') }}" placeholder="Ej. QUISPE" oninput="this.value = this.value.toUpperCase()"
            ...
            <section x-cloak x-show="paso === 2" x-transition.opacity.duration.250ms class="bg-transparent pt-4 border-t border-borde-suave">
                ...
                <div class="grid gap-4 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input name="complemento_ci" value="{{ old('complemento_ci') }}" placeholder="Ej. 1A" oninput="this.value = this.value.toUpperCase()"
            ...
            <section x-cloak x-show="paso === 3" x-transition.opacity.duration.250ms class="bg-transparent pt-4 border-t border-borde-suave">
                <div class="mb-4 flex items-start gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-extrabold text-titulo">Paso 3: Contacto y Dirección</h2>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input name="ciudad_municipio" value="{{ old('ciudad_municipio') }}" placeholder="EJ. EL ALTO" oninput="this.value = this.value.toUpperCase()"
                    ...
                    <div>
                        ...
                        <input name="zona" value="{{ old('zona') }}" placeholder="EJ. MIRAFLORES" oninput="this.value = this.value.toUpperCase()"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input name="calle" value="{{ old('calle') }}" placeholder="EJ. AV. SAAVEDRA NRO 123" oninput="this.value = this.value.toUpperCase()"
            ...
            <section x-cloak x-show="paso === 5" x-transition.opacity.duration.250ms class="bg-transparent pt-4 border-t border-borde-suave">
                ...
                <div class="mb-6 flex flex-col items-center justify-center gap-4 sm:flex-row sm:justify-start">
                    ...
                    <div class="w-full sm:w-auto flex-1">
                        <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-titulo/55">Fotografía del Adulto Mayor</label>
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="lg:col-span-3">
                        ...
                        <input name="alergias" value="{{ old('alergias', 'Ninguna') }}" oninput="this.value = this.value.toUpperCase()"
                    ...
                    <div>
                        ...
                        <input name="contacto_emergencia_nombre" value="{{ old('contacto_emergencia_nombre') }}" placeholder="NOMBRE COMPLETO" oninput="this.value = this.value.toUpperCase()"
                    ...
                    <div class="lg:col-span-3">
                        ...
                        <input name="contacto_emergencia_direccion" value="{{ old('contacto_emergencia_direccion') }}" placeholder="DIRECCIÓN DEL CONTACTO..." x-model="direccion_emergencia" maxlength="200" oninput="this.value = this.value.toUpperCase()"
            ...
            <section x-cloak x-show="paso === 6" x-transition.opacity.duration.250ms class="bg-transparent pt-4 border-t border-borde-suave">
                <div class="mb-4 flex items-start gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-extrabold text-titulo">Paso 6: Confirmación y Cierre</h2>
                ...
                <div class="rm-card-soft p-4 mb-5">
                    ...
                    <ul class="text-xs font-bold text-titulo/70 space-y-1">
                        ...
                        <li><i class="ph-bold ph-caret-right text-terracota mr-1"></i> El sistema validará los datos institucionales antes de crear los submódulos.</li>
                    </ul>
                </div>
