    ...
    <div class="relative mx-auto max-w-7xl space-y-6 py-6">
        ...
        <section class="rounded-2xl border border-borde-suave bg-fondo-card p-12 text-center shadow-sm flex flex-col items-center justify-center min-h-[400px]">
            ...
            <div class="mt-8 flex gap-3">
                <a href="{{ route('admin.adultos-mayores.index') }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-app border border-borde-suave px-5 py-3 text-xs font-black text-titulo transition hover:bg-fondo-app active:scale-95">
