...
<div class="space-y-6">
    ...
    {{-- ── Header ────────────────────────────────────────────── --}}
    <div class="rounded-[24px] border border-[#CBBBAA]/60 bg-gradient-to-br from-[#2F3E5C] to-[#4A5D8A] p-6 text-white">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs font-semibold text-white/60">Indicadores clínicos, gráficas evolutivas y exportación del expediente</p>
                </div>
            </div>
            <span class="hidden sm:block text-xs font-black uppercase tracking-wide bg-white/10 rounded-lg px-4 py-2">
                {{ $adulto->cod_am }}
            </span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="rounded-2xl border border-[#CBBBAA]/40 bg-white p-4 shadow-sm">
            <div class="flex items-center justify-between mb-2">
                <span class="text-xs font-black uppercase tracking-wide text-[#2F3E5C]/50">Signos Vitales</span>
                <i class="ph-bold ph-heartbeat text-[#C45F4B] text-xl"></i>
            </div>
            <p class="text-3xl font-black text-[#2F3E5C]">{{ $statSignos }}</p>
            @if($ultimaSV)
            <p class="text-xs font-bold text-[#2F3E5C]/50 mt-1">
            ...
            @else
            <p class="text-xs font-bold text-[#2F3E5C]/30 mt-1">Sin registros vigentes</p>
            @endif
        </div>

        <div class="rounded-2xl border border-[#CBBBAA]/40 bg-white p-4 shadow-sm">
            <div class="flex items-center justify-between mb-2">
                <span class="text-xs font-black uppercase tracking-wide text-[#2F3E5C]/50">Medicación Activa</span>
                <i class="ph-bold ph-pill text-[#617453] text-xl"></i>
            </div>
            <p class="text-3xl font-black text-[#2F3E5C]">{{ $statMedActivas }}</p>
            <p class="text-xs font-bold text-[#2F3E5C]/50 mt-1">
        ...
        <div class="rounded-2xl border border-[#CBBBAA]/40 bg-white p-4 shadow-sm">
            <div class="flex items-center justify-between mb-2">
                <span class="text-xs font-black uppercase tracking-wide text-[#2F3E5C]/50">Valorac. Funcional</span>
                <i class="ph-bold ph-person-arms-spread text-[#5B5F97] text-xl"></i>
            </div>
            <p class="text-3xl font-black text-[#2F3E5C]">{{ $ultimoBarth?->indice_barthel ?? '—' }}</p>
            <p class="text-xs font-bold text-[#2F3E5C]/50 mt-1">
                @if($ultimoBarth)
        ...
        <div class="rounded-2xl border border-[#CBBBAA]/40 bg-white p-4 shadow-sm">
            <div class="flex items-center justify-between mb-2">
                <span class="text-xs font-black uppercase tracking-wide text-[#2F3E5C]/50">Evaluaciones Cog.</span>
                <i class="ph-bold ph-brain text-[#A86B3C] text-xl"></i>
            </div>
            <p class="text-3xl font-black text-[#2F3E5C]">{{ $statEval }}</p>
            <p class="text-xs font-bold text-[#2F3E5C]/50 mt-1">
                @if($ultimaEval)
    ...
    <div class="grid md:grid-cols-2 gap-6" id="reportes-charts-section-{{ $idAdulto }}">
        ...
        <div class="rounded-[20px] border border-[#CBBBAA]/40 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-2 mb-4">
                <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#C45F4B]/10 text-[#C45F4B]">
                    <i class="ph-bold ph-activity text-sm"></i>
                </div>
                <div>
                    <h3 class="text-sm font-black text-[#2F3E5C]">Signos Vitales</h3>
                    <p class="text-xs font-bold text-[#2F3E5C]/40 uppercase tracking-wide">Tendencia de presión arterial y pulso</p>
                </div>
            </div>
            ...
            @else
                <div class="flex flex-col items-center justify-center h-40 text-[#2F3E5C]/20">
        ...
        <div class="rounded-[20px] border border-[#CBBBAA]/40 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-2 mb-4">
                <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#617453]/10 text-[#617453]">
                    <i class="ph-bold ph-pill text-sm"></i>
                </div>
                <div>
                    <h3 class="text-sm font-black text-[#2F3E5C]">Medicación por Estado</h3>
                    <p class="text-xs font-bold text-[#2F3E5C]/40 uppercase tracking-wide">Distribución del esquema terapéutico</p>
                </div>
            </div>
        ...
        <div class="rounded-[20px] border border-[#CBBBAA]/40 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-2 mb-4">
                <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#5B5F97]/10 text-[#5B5F97]">
                    <i class="ph-bold ph-person-arms-spread text-sm"></i>
                </div>
                <div>
                    <h3 class="text-sm font-black text-[#2F3E5C]">Índice Barthel</h3>
                    <p class="text-xs font-bold text-[#2F3E5C]/40 uppercase tracking-wide">Evolución de la capacidad funcional (0–100)</p>
                </div>
            </div>
        ...
        <div class="rounded-[20px] border border-[#CBBBAA]/40 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-2 mb-4">
                <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#A86B3C]/10 text-[#A86B3C]">
                    <i class="ph-bold ph-brain text-sm"></i>
                </div>
                <div>
                    <h3 class="text-sm font-black text-[#2F3E5C]">Evaluaciones Cognitivas</h3>
                    <p class="text-xs font-bold text-[#2F3E5C]/40 uppercase tracking-wide">Puntaje obtenido vs. puntaje máximo</p>
                </div>
            </div>
    ...
    <div class="rounded-[24px] border border-[#CBBBAA]/60 bg-white/95 p-6 shadow-sm">
        <div class="mb-5 flex items-center gap-3 border-b border-[#CBBBAA]/30 pb-4">
            <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-[#8C5A48]/10 text-[#8C5A48]">
                <i class="ph-bold ph-download-simple text-xl"></i>
            </div>
            <div>
                <h3 class="text-base font-black text-[#2F3E5C]">Centro de Descargas</h3>
                <p class="text-xs font-bold text-[#2F3E5C]/40 uppercase tracking-wide">Exporta el expediente en el formato que necesites</p>
            </div>
        </div>
        ...
        <div class="space-y-3">
            ...
            <div class="rounded-xl border border-[#D5C7B9] bg-[#FDFBFA] p-4">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h4 class="text-sm font-black text-[#2F3E5C]">Expediente Integral 360°</h4>
                            <p class="text-xs font-bold text-[#2F3E5C]/50 uppercase tracking-wide">Datos completos: personal, salud, cognitivo, participación</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-2 shrink-0">
                        <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'format' => 'pdf']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-[#2F3E5C] px-3 py-2 text-xs font-black text-white uppercase tracking-wide transition hover:bg-[#25324d] active:scale-95 shadow-sm">
                        ...
                        <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'format' => 'excel']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-[#1D6F42] px-3 py-2 text-xs font-black text-white uppercase tracking-wide transition hover:bg-[#175733] active:scale-95 shadow-sm">
                        ...
                        <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'format' => 'word']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-[#2B5797] px-3 py-2 text-xs font-black text-white uppercase tracking-wide transition hover:bg-[#1e3f70] active:scale-95 shadow-sm">
            ...
            <div class="rounded-xl border border-[#D5C7B9] bg-[#FDFBFA] p-4">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#C45F4B]/10 text-[#C45F4B]">
                            <i class="ph-bold ph-heartbeat text-xl"></i>
                        </div>
                        <div>
                            <h4 class="text-sm font-black text-[#2F3E5C]">Reporte Médico de Salud</h4>
                            <p class="text-xs font-bold text-[#2F3E5C]/50 uppercase tracking-wide">Ficha médica, signos vitales y medicación</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-2 shrink-0">
                        <a href="{{ route('admin.adultos-mayores.reportes.especifico', ['adulto_mayor' => $idAdulto, 'tipo' => 'medico', 'format' => 'pdf']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-[#C45F4B] px-3 py-2 text-xs font-black text-white uppercase tracking-wide transition hover:bg-[#a94e3c] active:scale-95 shadow-sm">
                            <i class="ph-bold ph-file-pdf"></i> PDF
                        </a>
                        <a href="{{ route('admin.adultos-mayores.reportes.especifico', ['adulto_mayor' => $idAdulto, 'tipo' => 'signos', 'format' => 'pdf']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-white border border-[#C45F4B]/30 px-3 py-2 text-xs font-black text-[#C45F4B] uppercase tracking-wide transition hover:bg-[#C45F4B]/5 active:scale-95 shadow-sm">
                        ...
                        <a href="{{ route('admin.adultos-mayores.reportes.especifico', ['adulto_mayor' => $idAdulto, 'tipo' => 'medicacion', 'format' => 'pdf']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-white border border-[#617453]/30 px-3 py-2 text-xs font-black text-[#617453] uppercase tracking-wide transition hover:bg-[#617453]/5 active:scale-95 shadow-sm">
            ...
            <div class="rounded-xl border border-[#D5C7B9] bg-[#FDFBFA] p-4">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#5B5F97]/10 text-[#5B5F97]">
                            <i class="ph-bold ph-person-arms-spread text-xl"></i>
                        </div>
                        <div>
                            <h4 class="text-sm font-black text-[#2F3E5C]">Reporte de Valoración Funcional</h4>
                            <p class="text-xs font-bold text-[#2F3E5C]/50 uppercase tracking-wide">Índice Barthel, dependencia y riesgo de caída</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-2 shrink-0">
                        <a href="{{ route('admin.adultos-mayores.reportes.especifico', ['adulto_mayor' => $idAdulto, 'tipo' => 'funcional', 'format' => 'pdf']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-[#5B5F97] px-3 py-2 text-xs font-black text-white uppercase tracking-wide transition hover:bg-[#4a4e7e] active:scale-95 shadow-sm">
                            <i class="ph-bold ph-file-pdf"></i> PDF
                        </a>
                        <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'format' => 'excel']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-white border border-[#1D6F42]/30 px-3 py-2 text-xs font-black text-[#1D6F42] uppercase tracking-wide transition hover:bg-[#1D6F42]/5 active:scale-95 shadow-sm">
                            <i class="ph-bold ph-file-xls"></i> Excel
                        </a>
                    </div>
                </div>
            ...
            <div class="rounded-xl border border-[#D5C7B9] bg-[#FDFBFA] p-4">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#A86B3C]/10 text-[#A86B3C]">
                            <i class="ph-bold ph-brain text-xl"></i>
                        </div>
                        <div>
                            <h4 class="text-sm font-black text-[#2F3E5C]">Reporte de Evaluaciones Cognitivas</h4>
                            <p class="text-xs font-bold text-[#2F3E5C]/50 uppercase tracking-wide">Historial MoCA / MMSE y evolución</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-2 shrink-0">
                        <a href="{{ route('admin.adultos-mayores.reportes.especifico', ['adulto_mayor' => $idAdulto, 'tipo' => 'cognitivo', 'format' => 'pdf']) }}"
                           class="inline-flex items-center gap-1.5 rounded-lg bg-[#A86B3C] px-3 py-2 text-xs font-black text-white uppercase tracking-wide transition hover:bg-[#8e5a31] active:scale-95 shadow-sm">
                            <i class="ph-bold ph-file-pdf"></i> PDF
                        </a>
                    </div>
                </div>
