...
>
 ...
 @if(($bitacoraLista ?? collect())->count() > 0)
 @php $ultimoMov = ($bitacoraLista ?? collect())->first(); @endphp
 ...
 @foreach(($bitacoraLista ?? collect())->take(5) as $log)
