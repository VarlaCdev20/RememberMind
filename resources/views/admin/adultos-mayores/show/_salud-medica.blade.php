...
>
    ...
    <div class="flex flex-col gap-4 border-b border-borde pb-5">
        <div class="flex items-center justify-between">
            ...
            <a 
                ...
                class="inline-flex items-center gap-2 rounded-xl bg-boton-principal px-4 py-2.5 text-xs font-black uppercase tracking-wider text-inverso shadow-sm hover:bg-fondo-panel active:scale-95 transition shrink-0"
            >
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <div class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm flex flex-col justify-between hover:border-borde-focus transition">
                <div>
                    <div class="flex items-start justify-between gap-4 mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-lg font-black text-titulo">Resumen de Ficha Médica</h3>
                                <p class="text-xs text-apoyo">Antecedentes, alergias y condiciones</p>
                            </div>
                        </div>
                        <span class="px-2.5 py-1 rounded-full text-xs font-black uppercase tracking-wide {{ $fichasMedicas->isNotEmpty() ? 'bg-estado-exitoBg text-estado-exito' : 'bg-fondo-panel text-parrafo' }}">
                    ...
                    @if($fichasMedicas->isNotEmpty())
                        ...
                        <div class="grid grid-cols-2 gap-3 text-sm">
                            <div class="rounded-xl bg-fondo-app p-3 border border-borde-suave">
                                <span class="block text-[10px] font-black uppercase tracking-wide text-apoyo mb-1">Alergias</span>
                            ...
                            <div class="rounded-xl bg-fondo-app p-3 border border-borde-suave">
                                <span class="block text-[10px] font-black uppercase tracking-wide text-apoyo mb-1">Dieta Especial</span>
                ...
                <div class="mt-5 border-t border-borde-suave pt-4">
                    <button type="button" @click="vistaSaludActiva = 'ficha_medica'" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde-focus px-4 py-2.5 text-[11px] font-black uppercase tracking-wider text-boton-acento shadow-sm transition hover:bg-estado-peligroBg active:scale-95">
            ...
            <div class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm flex flex-col justify-between hover:border-teal-600/40 transition">
                <div>
                    <div class="flex items-start justify-between gap-4 mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-lg font-black text-titulo">Resumen de Signos Vitales</h3>
                ...
                <div class="mt-5 border-t border-borde-suave pt-4">
                    <button type="button" @click="vistaSaludActiva = 'signos_vitales'" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-teal-600/30 px-4 py-2.5 text-[11px] font-black uppercase tracking-wider text-teal-700 shadow-sm transition hover:bg-teal-50 active:scale-95">
                        <i class="ph-bold ph-eye"></i> Ver Resumen Interno
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm flex flex-col justify-between hover:border-estado-exitoBorde transition">
                <div>
                    <div class="flex items-start justify-between gap-4 mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-lg font-black text-titulo">Resumen de Medicación</h3>
                                <p class="text-xs text-apoyo">Tratamiento activo</p>
                            </div>
                        </div>
                        <span class="px-2.5 py-1 rounded-full text-xs font-black uppercase tracking-wide bg-estado-exitoBg text-estado-exito">
                    ...
                    @if($medicaciones->where('estado', 'ACTIVO')->count() > 0)
                        <div class="flex items-center justify-between rounded-xl bg-fondo-app p-3 border border-borde-suave">
                            <div>
                                <span class="block text-[10px] font-black uppercase tracking-wide text-apoyo mb-1">Tomas Recientes</span>
                                <span class="text-xs font-black text-titulo">{{ $administracionesMedicacion->take(5)->where('estado_administracion', 'ADMINISTRADO')->count() }} Completadas</span>
                            </div>
                ...
                <div class="mt-5 border-t border-borde-suave pt-4 grid grid-cols-2 gap-2">
                    <button type="button" @click="vistaSaludActiva = 'medicacion'" class="inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-fondo-card border border-estado-exitoBorde px-2 py-2.5 text-xs font-black uppercase tracking-wider text-estado-exito shadow-sm transition hover:bg-fondo-panel active:scale-95">
                        <i class="ph-bold ph-pill"></i> Resumen
                    </button>
                    <button type="button" @click="vistaSaludActiva = 'administracion'" class="inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-fondo-card border border-estado-exitoBorde px-2 py-2.5 text-xs font-black uppercase tracking-wider text-estado-exito shadow-sm transition hover:bg-fondo-panel active:scale-95">
                ...
                <div>
                    <div class="flex items-start justify-between gap-4 mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-lg font-black text-titulo">Resumen Geriátrico</h3>
                    ...
                    <div class="grid grid-cols-2 gap-2 text-center">
                        <div class="rounded-xl bg-fondo-app p-3 border border-borde-suave">
                            <p class="text-[10px] font-black uppercase tracking-wide text-apoyo mb-1">Autonomía</p>
                            <p class="text-xs font-black text-titulo">{{ $valoracionesFuncionales->first()?->nivel_dependencia ?? 'N/D' }}</p>
                        </div>
                        <div class="rounded-xl bg-fondo-app p-3 border border-borde-suave">
                            <p class="text-[10px] font-black uppercase tracking-wide text-apoyo mb-1">Riesgo Caídas</p>
                            <p class="text-xs font-black {{ ($valoracionesFuncionales->first()?->riesgo_caida ?? 'N/D') !== 'N/D' ? 'text-amber-600' : 'text-titulo' }}">{{ $valoracionesFuncionales->first()?->riesgo_caida ?? 'N/D' }}</p>
                        </div>
                    </div>
                </div>
                <div class="mt-5 border-t border-borde-suave pt-4 grid grid-cols-2 gap-2">
                    <button type="button" @click="vistaSaludActiva = 'valoracion'" class="inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-fondo-card border border-indigo-300 px-2 py-2.5 text-xs font-black uppercase tracking-wider text-indigo-700 shadow-sm transition hover:bg-indigo-50 active:scale-95">
                        <i class="ph-bold ph-wheelchair"></i> Funcional
                    </button>
                    <button type="button" @click="vistaSaludActiva = 'evaluaciones'" class="inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-fondo-card border border-indigo-300 px-2 py-2.5 text-xs font-black uppercase tracking-wider text-indigo-700 shadow-sm transition hover:bg-indigo-50 active:scale-95">
            ...
            <div class="lg:col-span-2 rounded-[24px] border border-borde bg-gradient-to-br from-[#2F3E5C] to-[#455A84] p-6 shadow-sm flex flex-col justify-between text-inverso hover:shadow-md transition">
                ...
                <div class="mt-2 grid grid-cols-2 gap-3 w-full">
                    <button type="button" @click="vistaSaludActiva = 'alertas'" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-card/10 border border-white/20 px-3 py-2.5 text-xs font-black uppercase tracking-wider text-inverso transition hover:bg-fondo-card/20">
                        <i class="ph-bold ph-bell-ringing"></i> Resumen Alertas
                    </button>
                    <button type="button" @click="vistaSaludActiva = 'reportes'" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-card text-titulo px-3 py-2.5 text-xs font-black uppercase tracking-wider transition hover:bg-fondo-card/90">
    ...
    <div x-show="vistaSaludActiva === 'ficha_medica'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Ficha Médica</h3>
        @if($fichasMedicas->isNotEmpty())
            @php $ficha = $fichasMedicas->first(); @endphp
            <div class="space-y-4">
                <div>
                    <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Estado de ficha</span>
                ...
                <div class="grid sm:grid-cols-2 gap-4 bg-fondo-panel p-4 rounded-xl">
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Alergias Principales</span>
                        <p class="text-sm font-bold text-parrafo">{{ $ficha->alergias ?: 'Ninguna registrada' }}</p>
                    </div>
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Condiciones Médicas</span>
                        <p class="text-sm font-bold text-titulo">{{ $ficha->enfermedades_preexistentes ?: 'Ninguna registrada' }}</p>
                    </div>
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Restricciones Principales</span>
                        <p class="text-sm font-bold text-titulo">{{ $ficha->restricciones_alimentarias ?: 'Ninguna' }}</p>
                    </div>
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Cuidados Especiales</span>
                        <p class="text-sm font-bold text-titulo">{{ $ficha->cuidados_especiales ?: 'Ninguno' }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-2 pt-4">
                    <a href="{{ route('admin.salud-seguimiento.ficha', $adulto->cod_am) }}" class="inline-flex items-center gap-1.5 rounded-xl bg-boton-principal px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
        ...
        @else
            <div class="text-center py-6">
                ...
                <a href="{{ route('admin.salud-seguimiento.ficha', $adulto->cod_am) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-boton-principal px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
                    Ir a Gestión Completa
                </a>
            </div>
        @endif
    ...
    <div x-show="vistaSaludActiva === 'signos_vitales'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Signos Vitales</h3>
        @if($signosVitales->isNotEmpty())
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-2 pt-4">
                    <a href="{{ route('admin.salud-seguimiento.signos', $adulto->cod_am) }}" class="inline-flex items-center gap-1.5 rounded-xl bg-teal-700 px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-teal-800">
        ...
        @else
            <div class="text-center py-6">
                ...
                <a href="{{ route('admin.salud-seguimiento.signos', $adulto->cod_am) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-teal-700 px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-teal-800">
                    Ver Gestión Completa
                </a>
            </div>
        @endif
    ...
    <div x-show="vistaSaludActiva === 'medicacion'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Medicación</h3>
        @if($medicaciones->isNotEmpty())
            <div class="space-y-4">
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div class="bg-fondo-panel p-3 rounded-xl border border-borde text-center">
                        <p class="text-xs font-black uppercase tracking-wide text-apoyo">Activos</p>
                        <p class="text-xl font-black text-estado-exito">{{ $medicaciones->where('estado', 'ACTIVO')->count() }}</p>
                    </div>
                    <div class="bg-fondo-panel p-3 rounded-xl border border-borde text-center">
                        <p class="text-xs font-black uppercase tracking-wide text-apoyo">Suspendidos</p>
                        <p class="text-xl font-black text-apoyo">{{ $medicaciones->where('estado', 'SUSPENDIDO')->count() }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-2 pt-4">
                    <a href="{{ route('admin.salud-seguimiento.medicacion', $adulto->cod_am) }}" class="inline-flex items-center gap-1.5 rounded-xl bg-fondo-panel px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
                        Ver Gestión Completa
                    </a>
                </div>
            </div>
        @else
            <div class="text-center py-6">
                ...
                <a href="{{ route('admin.salud-seguimiento.medicacion', $adulto->cod_am) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-fondo-panel px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
                    Ver Gestión Completa
                </a>
            </div>
        @endif
    ...
    <div x-show="vistaSaludActiva === 'administracion'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Administración de Medicación</h3>
        @if($administracionesMedicacion->isNotEmpty())
            <div class="space-y-4">
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div class="bg-fondo-panel p-3 rounded-xl border border-borde text-center">
                        <p class="text-xs font-black uppercase tracking-wide text-apoyo">Administradas hoy</p>
                    ...
                    <div class="bg-fondo-panel p-3 rounded-xl border border-borde text-center">
                        <p class="text-xs font-black uppercase tracking-wide text-apoyo">Pendientes</p>
                        <p class="text-xl font-black text-amber-600">{{ $administracionesMedicacion->where('estado_administracion', 'PENDIENTE')->count() }}</p>
                    </div>
                    <div class="bg-fondo-panel p-3 rounded-xl border border-borde text-center">
                        <p class="text-xs font-black uppercase tracking-wide text-apoyo">Omitidas</p>
                        <p class="text-xl font-black text-red-600">{{ $administracionesMedicacion->where('estado_administracion', 'NO_ADMINISTRADO')->count() }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-2 pt-4">
                    <a href="{{ route('admin.salud-seguimiento.administracion', $adulto->cod_am) }}" class="inline-flex items-center gap-1.5 rounded-xl bg-fondo-panel px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
                        Ir a Gestión Completa
                    </a>
                </div>
            </div>
        @else
            <div class="text-center py-6">
                ...
                <a href="{{ route('admin.salud-seguimiento.administracion', $adulto->cod_am) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-fondo-panel px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
    ...
    <div x-show="vistaSaludActiva === 'valoracion'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Valoración Funcional</h3>
        @if($valoracionesFuncionales->isNotEmpty())
            ...
            <div class="space-y-4">
                <div class="grid sm:grid-cols-2 gap-4 bg-fondo-panel p-4 rounded-xl border border-borde">
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Nivel de Autonomía</span>
                        <p class="text-sm font-bold text-titulo">{{ $valFunc->nivel_dependencia }}</p>
                    </div>
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Movilidad</span>
                        <p class="text-sm font-bold text-titulo">{{ $valFunc->movilidad ?: 'N/D' }}</p>
                    </div>
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Alimentación</span>
                        <p class="text-sm font-bold text-titulo">{{ $valFunc->alimentacion ?: 'N/D' }}</p>
                    </div>
                    <div>
                        <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Higiene y Traslado</span>
                        <p class="text-sm font-bold text-titulo">{{ $valFunc->higiene_aseo ?: 'N/D' }} / {{ $valFunc->traslado ?: 'N/D' }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-2 pt-4">
                    <a href="{{ route('admin.salud-seguimiento.valoracion', $adulto->cod_am) }}" class="inline-flex items-center gap-1.5 rounded-xl bg-amber-600 px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-amber-700">
                        Ver Gestión Completa
                    </a>
                </div>
            </div>
        @else
            <div class="text-center py-6">
                ...
                <a href="{{ route('admin.salud-seguimiento.valoracion', $adulto->cod_am) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-amber-600 px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-amber-700">
                    Ver Gestión Completa
                </a>
            </div>
        @endif
    ...
    <div x-show="vistaSaludActiva === 'evaluaciones'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Evaluaciones Geriátricas</h3>
        @if($evaluacionesGeriatricasActivas->isNotEmpty())
            ...
            <div class="space-y-4">
                <div class="bg-fondo-panel p-4 rounded-xl border border-borde text-sm">
                    <span class="block text-xs font-black uppercase tracking-wide text-apoyo mb-1">Última Evaluación Registrada</span>
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-3">
                        <div>
                            <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Alerta / Riesgo</span>
                            <p class="font-bold {{ $latestGer->nivel_alerta === 'NORMAL' ? 'text-emerald-600' : 'text-red-600' }}">{{ $latestGer->nivel_alerta }}</p>
                        </div>
                        <div>
                            <span class="block text-xs font-black uppercase tracking-wide text-apoyo">Puntaje Obtenido</span>
                            <p class="font-bold text-titulo">{{ $latestGer->puntaje_total }} pts</p>
                        </div>
                    </div>
                </div>
                <div class="flex items-center gap-2 pt-4">
                    <a href="{{ route('admin.salud-seguimiento.resumen', $adulto->cod_am) }}" class="inline-flex items-center gap-1.5 rounded-xl bg-boton-principal px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
                        Ver Gestión Completa
                    </a>
                </div>
            </div>
        @else
            <div class="text-center py-6">
                ...
                <a href="{{ route('admin.salud-seguimiento.resumen', $adulto->cod_am) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-boton-principal px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
                    Ver Gestión Completa
                </a>
            </div>
        @endif
    ...
    <div x-show="vistaSaludActiva === 'alertas'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Alertas de Salud</h3>
        ...
        <div class="text-center py-6 bg-fondo-panel rounded-xl">
            ...
            <a href="{{ route('admin.salud-seguimiento.alertas', $adulto->cod_am) }}" class="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-boton-principal px-4 py-2 text-xs font-black text-inverso shadow-sm hover:bg-fondo-panel">
    ...
    <div x-show="vistaSaludActiva === 'reportes'" style="display: none;" x-transition.opacity class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm">
        <h3 class="text-lg font-black text-titulo mb-4 border-b border-borde pb-3">Resumen de Reportes</h3>
        <div class="grid sm:grid-cols-2 gap-4">
            <div class="bg-fondo-panel p-4 rounded-xl border border-borde">
                ...
                <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $adulto->cod_am, 'format' => 'pdf']) }}" class="text-xs font-black text-parrafo hover:underline">Descargar PDF</a>
            </div>
            <div class="bg-fondo-panel p-4 rounded-xl border border-borde">
                ...
                <a href="{{ route('admin.salud-seguimiento.reportes', $adulto->cod_am) }}" class="text-xs font-black text-titulo hover:underline">Ir a Reportes Avanzados</a>
            </div>
        </div>
    </div>
