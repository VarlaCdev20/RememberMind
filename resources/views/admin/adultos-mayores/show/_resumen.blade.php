                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="mt-2 flex flex-wrap gap-2 items-center">
                            ...
                            @if(optional($adultoObj)->archivado_en)
                                <span class="inline-flex items-center rounded-lg bg-amber-600/10 text-amber-700 border border-amber-600/20 px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider">
                ...
                <div class="rounded-xl border border-[#D5C7B9]/50 bg-[#F2EBE3]/50 p-4">
                    ...
                    @else
                        <div class="flex items-start gap-3 rounded-lg border border-amber-600/25 bg-amber-600/5 p-3">
                            ...
                            <div>
                                <p class="text-[11px] font-black text-amber-700">Sin contacto principal registrado</p>
                ...
                <div class="rounded-xl border border-[#D5C7B9]/50 bg-[#F2EBE3]/50 p-4">
                    ...
                    @else
                        <div class="flex items-start gap-3 rounded-lg border border-red-600/25 bg-red-600/5 p-3">
                            ...
                            <div>
                                <p class="text-[11px] font-black text-red-700">Sin datos de emergencia directos</p>
        ...
        <section class="overflow-hidden rounded-[24px] border border-[#CBBBAA] bg-[#E7DDD2]/95 shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl transition hover:shadow-[0_16px_36px_rgba(47,62,92,0.12)]">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="rounded-xl border border-[#D5C7B9]/50 bg-[#F2EBE3]/50 p-4 space-y-3">
                    ...
                    @else
                        <div class="mt-4 flex items-center gap-2 rounded-xl bg-amber-500/10 border border-amber-500/20 p-2.5 text-[10px] font-black text-amber-700 justify-center uppercase tracking-wider">
