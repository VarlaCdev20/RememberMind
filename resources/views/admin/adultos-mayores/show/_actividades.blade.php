...
>
 ...
 class="inline-flex items-center justify-center gap-2 rounded-2xl bg-fondo-panel px-4 py-2.5 text-xs font-bold text-inverso shadow-[0_10px_20px_rgba(217,162,124,0.20)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-[0.98]">
 ...
 <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-apoyo">
 Actividades
 </p>
 ...
 <p class="mt-2 text-sm font-bold {{ $totalActividades > 0 ? 'text-parrafo' : 'text-parrafo' }}">
 ...
 <div>
 <h3 class="text-base font-extrabold text-titulo">Registro de Actividades</h3>
 <p class="text-[10px] font-bold text-apoyo uppercase tracking-widest">Participación y eventos institucionales</p>
 </div>
 </div>
 <button type="button" @click="abrir('actividad')" class="rounded-xl bg-fondo-panel px-4 py-2 text-xs font-bold text-inverso hover:bg-fondo-panel transition">
 ...
 <td class="px-6 py-4">
 <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-[9px] font-bold uppercase {{ $colorAct }}">
 {{ $estadoAct }}
 </span>
 </td>
 ...
 <td class="px-6 py-3">
 <p class="text-[11px] font-bold text-apoyo uppercase">{{ $actAnu->tipoActividad->tipo ?? 'Actividad' }}</p>
