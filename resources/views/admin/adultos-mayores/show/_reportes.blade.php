...
>
 ...
 <h3 class="text-lg font-extrabold">Expediente Integral 360°</h3>
 ...
 <div class="mt-6">
 <a href="{{ (Route::has('admin.adultos-mayores.reporte-individual') ? route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'format' => 'pdf']) : '#') }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card text-titulo px-4 py-2.5 text-xs font-bold uppercase tracking-wider shadow-sm transition hover:bg-fondo-card/90 active:scale-95">
 ...
 <h3 class="text-lg font-extrabold text-titulo">Reporte de Salud</h3>
 ...
 <a href="{{ (Route::has('admin.adultos-mayores.reporte-individual') ? route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'salud', 'format' => 'pdf']) : '#') }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 ...
 <h3 class="text-lg font-extrabold text-titulo">Reporte Cognitivo</h3>
 ...
 <div class="mt-6 border-t border-borde pt-4">
 <a href="{{ (Route::has('admin.adultos-mayores.reporte-individual') ? route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'cognitivo', 'format' => 'pdf']) : '#') }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 <i class="ph-bold ph-file-pdf"></i> Descargar Reporte
 </a>
 </div>
 </div>
 ...
 <h3 class="text-lg font-extrabold text-titulo">Reporte de Participación</h3>
 ...
 <div class="mt-6 border-t border-borde pt-4">
 <a href="{{ (Route::has('admin.adultos-mayores.reporte-individual') ? route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'actividades', 'format' => 'pdf']) : '#') }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 <i class="ph-bold ph-file-pdf"></i> Descargar Reporte
 </a>
 </div>
 </div>
 ...
 <h3 class="text-lg font-extrabold text-titulo">Reporte Documental</h3>
 ...
 <div class="mt-6 border-t border-borde pt-4">
 <a href="{{ (Route::has('admin.adultos-mayores.reporte-individual') ? route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'documentos', 'format' => 'pdf']) : '#') }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 <i class="ph-bold ph-file-pdf"></i> Descargar Reporte
 </a>
 </div>
 </div>
