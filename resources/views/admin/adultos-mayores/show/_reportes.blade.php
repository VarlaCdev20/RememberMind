...
>
 ...
 <div class="mt-6">
 <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'format' => 'pdf']) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card text-titulo px-4 py-2.5 text-xs font-bold uppercase tracking-wider shadow-sm transition hover:bg-fondo-card/90 active:scale-95">
 ...
 <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'salud', 'format' => 'pdf']) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 ...
 <div class="mt-6 border-t border-borde pt-4">
 <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'cognitivo', 'format' => 'pdf']) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 <i class="ph-bold ph-file-pdf"></i> Descargar Reporte
 </a>
 </div>
 </div>
 ...
 <div class="mt-6 border-t border-borde pt-4">
 <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'actividades', 'format' => 'pdf']) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 <i class="ph-bold ph-file-pdf"></i> Descargar Reporte
 </a>
 </div>
 </div>
 ...
 <div class="mt-6 border-t border-borde pt-4">
 <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'documentos', 'format' => 'pdf']) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
 <i class="ph-bold ph-file-pdf"></i> Descargar Reporte
 </a>
 </div>
 </div>
