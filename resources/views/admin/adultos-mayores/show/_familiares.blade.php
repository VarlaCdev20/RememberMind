...
>
        ...
        <section class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            @foreach($alertas as $alerta)
                ...
                <div class="flex items-start gap-3 rounded-2xl border p-4.5 transition hover:shadow-sm {{ $alertaColorClass }}">
                    ...
                    <div class="min-w-0">
                        <h4 class="text-xs font-black uppercase tracking-wider leading-none">{{ $alerta['titulo'] }}</h4>
    ...
    <div class="grid gap-6 xl:grid-cols-3">
        ...
        <div class="space-y-6 xl:col-span-2">
                ...
                <div class="p-6">
                    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Nombre Completo</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ $nombreCompleto ?: 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Código Interno</p>
                            <p class="mt-1 text-sm font-black text-[#E27D60]">#{{ $idAdulto }}</p>
                        </div>
                        ...
                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            ...
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">
                                ...
                                @if(optional($adultoObj)->complemento_ci)
                                    <span class="text-xs font-bold text-[#2F3E5C]/60">- {{ optional($adultoObj)->complemento_ci }}</span>
                                @endif
                                @if(optional($adultoObj)->expedicion_ci)
                                    <span class="ml-1 rounded bg-[#2F3E5C]/10 px-1 py-0.5 text-[10px] font-black text-[#2F3E5C] uppercase">{{ optional($adultoObj)->expedicion_ci }}</span>
                                @endif
                            </p>
                        </div>
                        ...
                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            ...
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ $edad ? $edad . ' años' : 'Sin registrar' }}</p>
                        </div>
                        ...
                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            ...
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ optional($adultoObj)->estado_civil ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Nivel Educativo</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ optional($adultoObj)->nivel_educat ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Nacionalidad / Origen</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ optional($adultoObj)->nacionalidad ?? 'Boliviana' }}</p>
                        </div>
                    </div>

                    {{-- Observación General --}}
                    <div class="mt-4 rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-4">
                        <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45 mb-1.5">Observaciones Generales del Expediente</p>
                        <p class="text-xs font-semibold leading-relaxed text-[#2F3E5C]/80">
            ...
            <section class="overflow-hidden rounded-[24px] border border-[#CBBBAA] bg-[#E7DDD2]/95 shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl transition hover:shadow-[0_16px_36px_rgba(47,62,92,0.12)]">
                ...
                <div class="p-6">
                    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Celular del Adulto Mayor</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C] flex items-center gap-1.5">
                                {{ $celular }}
                        ...
                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Teléfono Fijo</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ $telefonoFijo }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Ciudad / Municipio</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ optional($adultoObj)->ciudad_municipio ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Departamento de Residencia</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ optional($adultoObj)->departamento_residencia ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Zona / Barrio</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ $zona }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Calle o Avenida</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ $calle }}</p>
                        </div>
                    </div>

                    <div class="mt-4 grid gap-4 sm:grid-cols-2">
                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Número de Domicilio</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C]">{{ optional($adultoObj)->num_dom ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-[#D5C7B9]/60 bg-[#F2EBE3]/50 p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45">Referencia de Ubicación</p>
                            <p class="mt-1 text-sm font-black text-[#2F3E5C] truncate">{{ optional($adultoObj)->referencia ?? 'Sin registrar' }}</p>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="space-y-6">
            ...
            <section class="overflow-hidden rounded-[24px] border border-[#CBBBAA] bg-[#E7DDD2]/95 shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl transition hover:shadow-[0_16px_36px_rgba(47,62,92,0.12)]">
                <div class="flex items-center justify-between border-b border-[#D5C7B9] px-6 py-4">
                    <div>
                        <span class="text-[10px] font-black uppercase tracking-[0.2em] text-red-600">
                            Contingencia
                        </span>
                        <h2 class="mt-0.5 text-base font-black text-[#2F3E5C]">
                ...
                <div class="p-6">
                    @if($emergenciaNombre)
                        <div class="space-y-4">
                            <div class="rounded-xl border border-[#D5C7B9]/50 bg-red-600/5 p-4">
                                <p class="text-[9px] font-black uppercase tracking-widest text-red-600 mb-1">Nombre Completo</p>
                                <p class="text-sm font-black text-[#2F3E5C]">{{ $emergenciaNombre }}</p>
                            </div>

                            <div class="grid grid-cols-2 gap-3">
                                <div class="rounded-xl border border-[#D5C7B9]/50 bg-[#F2EBE3]/50 p-3">
                                    <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45 mb-1">Parentesco</p>
                                    <p class="text-xs font-black text-[#2F3E5C]">{{ optional($adultoObj)->contacto_emergencia_parentesco ?: 'Sin registrar' }}</p>
                                </div>

                                <div class="rounded-xl border border-[#D5C7B9]/50 bg-red-600/5 p-3">
                                    <p class="text-[9px] font-black uppercase tracking-widest text-red-600 mb-1">Celular / Teléfono</p>
                                    <p class="text-xs font-black text-red-600 flex items-center gap-1">
                            ...
                            <div class="rounded-xl border border-[#D5C7B9]/50 bg-[#F2EBE3]/50 p-4">
                                <p class="text-[9px] font-black uppercase tracking-widest text-[#2F3E5C]/45 mb-1">Dirección del Contacto</p>
                                <p class="text-xs font-semibold leading-relaxed text-[#2F3E5C]/80">
                    ...
                    @else
                        <div class="flex flex-col items-center justify-center py-6 text-center">
                            ...
                            <h3 class="mt-4 text-xs font-black text-red-700 uppercase tracking-wider">
                            ...
                            @if($idAdulto)
                                <a href="{{ route('admin.adultos-mayores.edit', $idAdulto) }}" class="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-red-600 px-4 py-2.5 text-xs font-black text-white transition hover:bg-red-700 hover:-translate-y-0.5 active:scale-95 shadow-md">
            ...
            <section class="overflow-hidden rounded-[24px] border border-[#CBBBAA] bg-[#E7DDD2]/95 shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl">
                <div class="border-b border-[#D5C7B9] px-6 py-4">
                ...
                <div class="p-6 space-y-3">
                    @if($idAdulto)
                        <a href="{{ route('admin.adultos-mayores.edit', $idAdulto) }}" class="flex w-full items-center justify-center gap-2 rounded-xl bg-[#2F3E5C] py-3 text-xs font-black text-white shadow-md transition hover:-translate-y-0.5 hover:bg-[#1F2E4C] active:scale-95">
                            <i class="ph-bold ph-pencil-simple-line"></i> Editar Ficha Demográfica
                        </a>
                    @endif

                    <button type="button" @click="abrir('familiar')" class="flex w-full items-center justify-center gap-2 rounded-xl bg-[#8EA17D] py-3 text-xs font-black text-white shadow-md transition hover:-translate-y-0.5 hover:bg-[#7C916A] active:scale-95">
    ...
    <section class="overflow-hidden rounded-[24px] border border-[#CBBBAA] bg-[#E7DDD2]/95 shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl">
        <div class="flex flex-col gap-4 border-b border-[#D5C7B9] px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-[#8EA17D]">
            ...
            <div class="flex items-center gap-2">
                <span class="rounded-full bg-[#8EA17D]/15 px-3 py-1 text-[10px] font-black text-[#617453] uppercase border border-[#8EA17D]/30">
        ...
        <div class="p-6">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                @forelse($familiaresActivos as $familiar)
                    ...
                    <div class="relative flex flex-col justify-between rounded-[20px] border border-[#D5C7B9] bg-[#F2EBE3]/55 p-5 transition-all duration-300 hover:-translate-y-1 hover:bg-[#F2EBE3] hover:shadow-[0_12px_24px_rgba(47,62,92,0.06)]">
                        <div>
                            {{-- Fila superior con avatar e iniciales --}}
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#8EA17D]/15 text-base font-black text-[#617453] border border-[#8EA17D]/25">
                                        {{ strtoupper(substr($nombreFamiliar ?: 'F', 0, 1)) }}
                                    </div>
                                    <div class="min-w-0">
                                        <h3 class="text-sm font-black text-[#2F3E5C] leading-snug truncate" title="{{ $nombreFamiliar }}">
                                            {{ $nombreFamiliar ?: 'Familiar' }}
                                        </h3>
                                        <p class="text-[9px] font-bold text-[#2F3E5C]/50 uppercase tracking-wider mt-0.5">Familiar #{{ $codFamiliar }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 flex flex-wrap gap-1.5">
                                <span class="rounded bg-[#D5C7B9] px-2 py-0.5 text-[9px] font-black uppercase text-[#2F3E5C]/75">
                                    {{ $parentescoFamiliar }}
                                </span>
                                
                                @if($esResponsable)
                                    <span class="inline-flex items-center gap-1 rounded bg-[#E27D60]/15 px-2 py-0.5 text-[9px] font-black uppercase text-[#D96F58]">
                                        <span class="h-1.5 w-1.5 rounded-full bg-[#E27D60]"></span>
                                        Responsable principal
                                    </span>
                                @endif

                                @if($esEmergencia)
                                    <span class="inline-flex items-center gap-1 rounded bg-red-600/10 px-2 py-0.5 text-[9px] font-black uppercase text-red-600">
                            ...
                            <div class="mt-4.5 space-y-2 border-t border-[#D5C7B9]/45 pt-3.5">
                                <div class="flex items-center gap-2 text-xs font-bold text-[#2F3E5C]">
                                    <div class="flex h-6 w-6 items-center justify-center rounded-lg bg-[#2F3E5C]/5 text-[#2F3E5C]/70">
                                ...
                                <div class="flex items-start gap-2 text-xs font-bold text-[#2F3E5C]/85">
                                    <div class="flex h-6 w-6 items-center justify-center rounded-lg bg-[#2F3E5C]/5 text-[#2F3E5C]/70 mt-0.5">
                        ...
                        <div class="mt-5 flex justify-end gap-1.5 border-t border-[#D5C7B9]/45 pt-3">
                            <button type="button" @click="abrir('familiar', @js($familiar), false, true)" title="Ver Ficha Detallada" class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#2F3E5C]/10 text-[#2F3E5C] transition hover:bg-[#2F3E5C] hover:text-white">
                                <i class="ph-bold ph-eye text-sm"></i>
                            </button>
                            
                            <button type="button" @click="abrir('familiar', @js($familiar), true, false)" title="Editar Familiar" class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#2F3E5C]/10 text-[#2F3E5C] transition hover:bg-[#2F3E5C] hover:text-white">
                            ...
                            <form action="{{ route('admin.adultos-mayores.familiares.destroy', [$idAdulto, $codFamiliar]) }}" method="POST" onsubmit="confirmarAccion(event, 'Desactivar vínculo familiar', 'El vínculo con este familiar se marcará como inactivo. Se conservará el registro histórico.')">
                                @csrf @method('DELETE')
                                <button type="submit" title="Desactivar vínculo" class="flex h-8 w-8 items-center justify-center rounded-lg bg-terracota/10 text-terracota transition hover:bg-terracota hover:text-white">
                ...
                @empty
                    <div class="col-span-full py-10 text-center">
                        ...
                        <button type="button" @click="abrir('familiar')" class="mt-4 inline-flex items-center gap-2 rounded-xl bg-[#8EA17D] px-4 py-2 text-xs font-black text-white transition hover:bg-[#7C916A] active:scale-95 shadow-md">
            ...
            @if(count($familiaresInactivos) > 0)
                <div class="mt-8 border-t border-[#D5C7B9]/50 pt-6">
                    <div class="mb-4 flex items-center justify-between">
                        <h4 class="text-xs font-black uppercase tracking-widest text-[#7A604B] flex items-center gap-2">
                            <i class="ph-bold ph-archive"></i> Historial de Vínculos Desactivados
                        </h4>
                        <span class="rounded-full bg-[#7A604B]/10 px-2 py-0.5 text-[9px] font-black text-[#7A604B] uppercase tracking-wider">Historial Institucional</span>
                    </div>
                    
                    <div class="overflow-hidden rounded-2xl border border-[#D5C7B9]/50 bg-white/20 backdrop-blur-sm shadow-sm">
                        <table class="w-full text-left text-sm text-[#2F3E5C]">
                            <thead class="bg-[#D5C7B9]/30 text-[9px] uppercase tracking-widest text-[#2F3E5C]/60">
                                <tr>
                            ...
                            <tbody class="divide-y divide-[#D5C7B9]/30">
                                @foreach($familiaresInactivos as $finac)
                                    ...
                                    @endphp
                                    <tr class="hover:bg-[#F2EBE3]/30 transition grayscale-[60%] opacity-70 hover:grayscale-0 hover:opacity-100">
                                        <td class="px-6 py-3">
                                            <div class="flex items-center gap-2">
                                                <div class="flex h-7 w-7 items-center justify-center rounded-lg bg-[#7A604B]/15 text-[10px] font-black text-[#7A604B]">
                                                    {{ strtoupper(substr($nombreFinac ?: 'F', 0, 1)) }}
                                                </div>
                                                <span class="text-xs font-bold text-[#2F3E5C]">{{ $nombreFinac }}</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-3 text-xs text-[#2F3E5C]/65">
                                        ...
                                        <td class="px-6 py-3 text-right">
                                            <form action="{{ route('admin.adultos-mayores.familiares.restore', [$idAdulto, $codFinac]) }}" method="POST" onsubmit="confirmarAccion(event, 'Restaurar vínculo', 'El familiar volverá a estar vinculado activamente al expediente.')">
                                                @csrf @method('PATCH')
                                                <button type="submit" title="Restaurar vínculo activo" class="rounded-lg bg-[#8EA17D]/10 p-1.5 text-[#8EA17D] hover:bg-[#8EA17D] hover:text-white transition">
