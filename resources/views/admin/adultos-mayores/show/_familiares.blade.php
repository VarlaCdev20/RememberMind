        ...
        <div class="space-y-6 xl:col-span-2">
                ...
                <div class="p-6">
                    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Nombre Completo</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ $nombreCompleto ?: 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Código Interno</p>
                            <p class="mt-1 text-sm font-black text-boton-acento">#{{ $idAdulto }}</p>
                        </div>
                        ...
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            ...
                            <p class="mt-1 text-sm font-black text-titulo">
                                ...
                                @if(optional($adultoObj)->expedicion_ci)
                                    <span class="ml-1 rounded bg-fondo-panel px-1 py-0.5 text-[10px] font-black text-titulo uppercase">{{ optional($adultoObj)->expedicion_ci }}</span>
                                @endif
                            </p>
                        </div>
                        ...
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            ...
                            <p class="mt-1 text-sm font-black text-titulo">{{ $edad ? $edad . ' años' : 'Sin registrar' }}</p>
                        </div>
                        ...
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            ...
                            <p class="mt-1 text-sm font-black text-titulo">{{ optional($adultoObj)->estado_civil ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Nivel Educativo</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ optional($adultoObj)->nivel_educat ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Nacionalidad / Origen</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ optional($adultoObj)->nacionalidad ?? 'Boliviana' }}</p>
                        </div>
                    </div>

                    {{-- Observación General --}}
                    <div class="mt-4 rounded-xl border border-borde-suave bg-fondo-panel p-4">
                        <p class="text-[9px] font-black uppercase tracking-widest text-apoyo mb-1.5">Observaciones Generales del Expediente</p>
            ...
            <section class="overflow-hidden rounded-[24px] border border-borde bg-fondo-panel shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl transition hover:shadow-[0_16px_36px_rgba(47,62,92,0.12)]">
                ...
                <div class="p-6">
                    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Celular del Adulto Mayor</p>
                            <p class="mt-1 text-sm font-black text-titulo flex items-center gap-1.5">
                                {{ $celular }}
                        ...
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Teléfono Fijo</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ $telefonoFijo }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Ciudad / Municipio</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ optional($adultoObj)->ciudad_municipio ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Departamento de Residencia</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ optional($adultoObj)->departamento_residencia ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Zona / Barrio</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ $zona }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Calle o Avenida</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ $calle }}</p>
                        </div>
                    </div>

                    <div class="mt-4 grid gap-4 sm:grid-cols-2">
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Número de Domicilio</p>
                            <p class="mt-1 text-sm font-black text-titulo">{{ optional($adultoObj)->num_dom ?? 'Sin registrar' }}</p>
                        </div>

                        <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3.5">
                            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo">Referencia de Ubicación</p>
                            <p class="mt-1 text-sm font-black text-titulo truncate">{{ optional($adultoObj)->referencia ?? 'Sin registrar' }}</p>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="space-y-6">
                ...
                <div class="p-6">
                    @if($emergenciaNombre)
                        <div class="space-y-4">
                            <div class="rounded-xl border border-borde-suave bg-red-600/5 p-4">
                                ...
                                <p class="text-sm font-black text-titulo">{{ $emergenciaNombre }}</p>
                            </div>

                            <div class="grid grid-cols-2 gap-3">
                                <div class="rounded-xl border border-borde-suave bg-fondo-panel p-3">
                                    <p class="text-[9px] font-black uppercase tracking-widest text-apoyo mb-1">Parentesco</p>
                                    <p class="text-xs font-black text-titulo">{{ optional($adultoObj)->contacto_emergencia_parentesco ?: 'Sin registrar' }}</p>
                                </div>
                            ...
                            <div class="rounded-xl border border-borde-suave bg-fondo-panel p-4">
                                <p class="text-[9px] font-black uppercase tracking-widest text-apoyo mb-1">Dirección del Contacto</p>
                                <p class="text-xs font-semibold leading-relaxed text-apoyo">
                    ...
                    @else
                        <div class="flex flex-col items-center justify-center py-6 text-center">
                            ...
                            @if($idAdulto)
                                <a href="{{ route('admin.adultos-mayores.edit', $idAdulto) }}" class="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-red-600 px-4 py-2.5 text-xs font-black text-inverso transition hover:bg-red-700 hover:-translate-y-0.5 active:scale-95 shadow-md">
            ...
            <section class="overflow-hidden rounded-[24px] border border-borde bg-fondo-panel shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl">
                ...
                <div class="p-6 space-y-3">
                    @if($idAdulto)
                        <a href="{{ route('admin.adultos-mayores.edit', $idAdulto) }}" class="flex w-full items-center justify-center gap-2 rounded-xl bg-boton-principal py-3 text-xs font-black text-inverso shadow-md transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
                            <i class="ph-bold ph-pencil-simple-line"></i> Editar Ficha Demográfica
                        </a>
                    @endif

                    <button type="button" @click="abrir('familiar')" class="flex w-full items-center justify-center gap-2 rounded-xl bg-fondo-panel py-3 text-xs font-black text-inverso shadow-md transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
    ...
    <section class="overflow-hidden rounded-[24px] border border-borde bg-fondo-panel shadow-[0_12px_28px_rgba(47,62,92,0.08)] backdrop-blur-xl">
        <div class="flex flex-col gap-4 border-b border-borde-suave px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center gap-2">
                <span class="rounded-full bg-fondo-panel px-3 py-1 text-[10px] font-black text-parrafo uppercase border border-borde">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div>
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-fondo-panel text-base font-black text-parrafo border border-borde">
                                        {{ strtoupper(substr($nombreFamiliar ?: 'F', 0, 1)) }}
                                    </div>
                                    <div class="min-w-0">
                                        <h3 class="text-sm font-black text-titulo leading-snug truncate" title="{{ $nombreFamiliar }}">
                            ...
                            <div class="mt-3 flex flex-wrap gap-1.5">
                                <span class="rounded bg-fondo-app px-2 py-0.5 text-[9px] font-black uppercase text-apoyo">
                                    {{ $parentescoFamiliar }}
                                </span>
                                
                                @if($esResponsable)
                                    <span class="inline-flex items-center gap-1 rounded bg-estado-peligroBg px-2 py-0.5 text-[9px] font-black uppercase text-parrafo">
                ...
                @empty
                    <div class="col-span-full py-10 text-center">
                        ...
                        <h4 class="mt-4 text-sm font-black text-titulo">Sin familiares vinculados</h4>
                        ...
                        <button type="button" @click="abrir('familiar')" class="mt-4 inline-flex items-center gap-2 rounded-xl bg-fondo-panel px-4 py-2 text-xs font-black text-inverso transition hover:bg-fondo-panel active:scale-95 shadow-md">
            ...
            @if(count($familiaresInactivos) > 0)
                <div class="mt-8 border-t border-borde-suave pt-6">
                    <div class="mb-4 flex items-center justify-between">
                        <h4 class="text-xs font-black uppercase tracking-widest text-parrafo flex items-center gap-2">
                            <i class="ph-bold ph-archive"></i> Historial de Vínculos Desactivados
                        </h4>
                        <span class="rounded-full bg-fondo-panel px-2 py-0.5 text-[9px] font-black text-parrafo uppercase tracking-wider">Historial Institucional</span>
                    </div>
                            ...
                            <tbody class="divide-y divide-[#D5C7B9]/30">
                                @foreach($familiaresInactivos as $finac)
                                    ...
                                    <tr class="hover:bg-fondo-panel transition grayscale-[60%] opacity-70 hover:grayscale-0 hover:opacity-100">
                                        <td class="px-6 py-3">
                                            <div class="flex items-center gap-2">
                                                <div class="flex h-7 w-7 items-center justify-center rounded-lg bg-fondo-panel text-[10px] font-black text-parrafo">
