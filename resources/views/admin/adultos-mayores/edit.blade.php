<x-sistema-layout>
            ...
            <form method="POST" action="{{ route('admin.adultos-mayores.update', $idAdulto) }}" enctype="multipart/form-data" onsubmit="procesarFormulario(event)">
                ...
                <section x-show="paso === 1" x-transition.opacity.duration.250ms class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 shadow-[0_14px_32px_rgba(47,62,92,0.11)]">
                    ...
                    <div class="mb-6 flex flex-col items-center justify-center gap-4 sm:flex-row sm:justify-start">
                        ...
                        <div class="w-full sm:w-auto flex-1">
                            <label class="mb-1 block text-[11px] font-black uppercase tracking-widest text-titulo/55">Actualizar Fotografía (Opcional)</label>
                ...
                <section x-cloak x-show="paso === 6" x-transition.opacity.duration.250ms class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 shadow-[0_14px_32px_rgba(47,62,92,0.11)]">
                    <div class="mb-4 flex items-start gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-black text-titulo">Paso 6: Confirmación de Actualización</h2>
                    ...
                    <div class="rounded-xl bg-fondo-panel p-4 mb-5 border border-borde-suave">
                        <h3 class="text-sm font-black text-titulo mb-2">Información del Sistema</h3>
                ...
                <section class="mt-4 rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm">
    ...
    function adultoMayorFormEdit() {
        return {
            ...
            alergias: @js(old('alergias', optional($adultoObj)->alergias ?? '')),
            ...
            init() {
                // Cargar errores del servidor en Alpine para pintar campos
