            ...
            <form method="POST" action="{{ route('admin.adultos-mayores.update', $idAdulto) }}" enctype="multipart/form-data" onsubmit="procesarFormulario(event)">
                ...
                <section x-show="paso === 1" x-transition.opacity.duration.250ms class="rounded-2xl border border-[#C7B5A3] bg-[#E6DDD3]/90 p-5 shadow-[0_14px_32px_rgba(47,62,92,0.11)]">
                    ...
                    <div class="mb-6 flex flex-col items-center justify-center gap-4 sm:flex-row sm:justify-start">
                        ...
                        <div class="w-full sm:w-auto flex-1">
                            <label class="mb-1 block text-[11px] font-black uppercase tracking-widest text-azul-profundo/55">Actualizar Fotografía (Opcional)</label>
                            ...
                            <p class="mt-1 text-[10px] font-bold text-azul-profundo/45">JPG, PNG o WEBP. Máximo 2MB. Si no selecciona una, se mantendrá la actual.</p>
                ...
                <section x-cloak x-show="paso === 6" x-transition.opacity.duration.250ms class="rounded-2xl border border-[#C7B5A3] bg-[#E6DDD3]/90 p-5 shadow-[0_14px_32px_rgba(47,62,92,0.11)]">
                    <div class="mb-4 flex items-start gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-black text-azul-profundo">Paso 6: Confirmación de Actualización</h2>
                            <p class="text-xs font-bold text-azul-profundo/55">Revise que todos los datos modificados sean correctos.</p>
                        </div>
                    </div>

                    <div class="rounded-xl bg-[#D5C7B9]/50 p-4 mb-5 border border-[#C7B5A3]">
                        <h3 class="text-sm font-black text-azul-profundo mb-2">Información del Sistema</h3>
                    ...
                    <div class="rounded-xl border {{ $errors->has('consentimiento_datos') ? 'border-terracota bg-terracota/5' : 'border-[#C7B5A3] bg-white/50' }} p-4">
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p class="text-xs font-bold text-azul-profundo/60 mt-0.5">Parece que el consentimiento aún no estaba firmado en el sistema.</p>
                            </div>
                        </label>
                ...
                <section class="mt-4 rounded-2xl border border-[#C7B5A3] bg-[#E6DDD3]/90 p-4 shadow-sm">
