<x-sistema-layout>
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 border-b border-borde pb-5 md:flex-row md:items-center md:justify-between">
            ...
            <a href="{{ route('admin.adultos-mayores.create') }}" class="inline-flex items-center gap-2 rounded-xl bg-boton-principal px-4 py-2.5 text-sm font-bold text-inverso shadow-sm transition hover:bg-fondo-panel active:scale-95 shrink-0">
