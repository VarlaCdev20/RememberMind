<x-sistema-layout>
    <div class="relative mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
        {{-- Encabezado --}}
        <div class="mb-6">
            <h2 class="text-2xl font-black text-titulo">Reportes de actividades</h2>
            <p class="text-sm font-medium text-apoyo">Métricas de éxito e impacto psicosocial.</p>
        </div>
        ...
        <div class="rounded-[24px] border border-borde bg-fondo-card p-8 text-center shadow-sm">
            ...
            <p class="mb-6 text-sm text-apoyo max-w-md mx-auto">
                ...
                Pronto podrás acceder a todas las herramientas de <strong>Reportes de actividades</strong>.
            </p>
