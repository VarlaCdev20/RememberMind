                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('admin.usuarios.index') }}" 
                           class="inline-flex items-center gap-2 rounded-full border border-borde-suave px-5 py-2 text-xs font-black text-titulo transition hover:bg-fondo-panel active:scale-95">
