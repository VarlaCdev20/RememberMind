<x-sistema-layout>
    <div class="relative mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-black text-titulo">Resumen Clínico Global</h2>
        ...
        <div class="rounded-[24px] border border-borde bg-fondo-card p-8 text-center shadow-sm">
            ...
            <p class="mb-6 text-sm text-apoyo max-w-2xl mx-auto leading-relaxed">
                La Ficha Médica, Medicación, Signos Vitales y Valoración Funcional se registran directamente en el Expediente del Adulto Mayor. Este panel sirve para consulta y control global.
            </p>
        </div>
    </div>
</x-sistema-layout>