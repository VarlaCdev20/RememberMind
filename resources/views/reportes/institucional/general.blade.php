    ...
    <table class="rm-metrics-row">
        <tr>
            <td class="rm-metric-left">
                ...
                <div class="rm-metric-item">
                    <div class="rm-metric-label">Signos vitales (últ. 7 días)</div>
            ...
            <td class="rm-metric-right">
                ...
                <div class="rm-metric-item">
                    <div class="rm-metric-label">Valoraciones funcionales (últ. 30 días)</div>
                ...
                <div class="rm-metric-item">
                    <div class="rm-metric-label">Evaluaciones cognitivas (últ. 30 días)</div>
