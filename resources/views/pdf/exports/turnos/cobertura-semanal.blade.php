...
<body>
    ...
    <!-- Footer de Página -->
    <footer>
        Sistema RememberMind © {{ date('Y') }} CENTRO GERIÁTRICO JARDÍN DE LOS RECUERDOS. Todos los derechos
        reservados.
    </footer>
    ...
    <div class="alert-box">
        ...
        Esta planificación semanal sirve como base de disponibilidad para las asignaciones profesionales personalizadas
        que se realicen en el módulo de Salud y Seguimiento. Solo el personal de salud con turnos activos en esta grilla
        estará disponible para ser asignado como profesional tratante de cabecera de los adultos mayores de CENTRO
        GERIÁTRICO JARDÍN DE LOS RECUERDOS, garantizando que haya cobertura real y sin solapamiento de horarios.
    </div>
