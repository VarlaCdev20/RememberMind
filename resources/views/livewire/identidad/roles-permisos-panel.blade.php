<div x-data="{ grupoExpandido: 'Administración' }">
 ...
 <span class="text-xs font-bold uppercase tracking-widest text-titulo">Procesando</span>
 </div>
 </div>
 ...
 <div>
 <span class="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider {{ $colorClass }} shadow-sm">
 ...
 <button type="button" wire:click="abrirUsuariosRol" class="inline-flex h-9 items-center gap-2 rounded-xl bg-fondo-card/60 px-4 text-[10px] font-bold uppercase text-titulo shadow-sm transition hover:bg-fondo-card active:scale-95">
 ...
 <span class="text-xs font-bold uppercase tracking-widest text-titulo">{{ $grupo }}</span>
 ...
 <div>
 <p class="text-sm font-bold text-titulo {{ $esCritico ? 'text-boton-acento' : '' }}">
 ...
 @if($hayCambios)
 <span class="mr-auto text-[10px] font-bold uppercase text-boton-acento flex items-center gap-1.5 animate-pulse">
 <i class="ph-bold ph-warning-circle text-base"></i> Hay cambios sin guardar
 </span>
 
 <button type="button" 
 wire:click="restaurarCambios" 
 class="rounded-full bg-fondo-card px-5 py-2.5 text-[10px] font-bold uppercase text-titulo shadow-sm transition hover:bg-fondo-app active:scale-95">
 Restaurar
 </button>
 @endif
 ...
 class="inline-flex items-center gap-2 rounded-full px-6 py-2.5 text-[10px] font-bold uppercase shadow-lg transition active:scale-95 {{ $hayCambios ? 'bg-boton-acento text-inverso hover:bg-boton-principal' : 'bg-fondo-panel text-inverso cursor-not-allowed' }}">
 ...
 <div>
 <h3 class="text-sm font-bold uppercase tracking-widest text-titulo">Usuarios Asociados</h3>
 ...
 <div>
 <p class="text-sm font-bold text-titulo uppercase">{{ $usu->nombres }} {{ $usu->ap_paterno }}</p>
