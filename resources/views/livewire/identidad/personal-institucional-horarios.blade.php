<div class="space-y-5">
    ...
    @if($tipoPersonal === 'ninguno')
        <div class="flex flex-col items-center justify-center p-10 text-apoyo border-2 border-dashed border-borde rounded-2xl bg-[#F0E8DE]">
    ...
    @else
        ...
        <div class="border border-boton-acento/30 rounded-2xl bg-boton-acento/5 p-5 space-y-4 animate-fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select wire:model="f_cod_area" class="w-full rounded-xl border-[#D5CABE] bg-[#FBF8F5] text-sm focus:ring-input-ringFocus focus:border-input-bordeFocus">
                ...
                <div>
                    ...
                    <select wire:model.live="f_cod_turno" class="w-full rounded-xl border-[#D5CABE] bg-[#FBF8F5] text-sm focus:ring-input-ringFocus focus:border-input-bordeFocus">
                ...
                <div>
                    ...
                    <select wire:model="f_tipo_asignacion" class="w-full rounded-xl border-[#D5CABE] bg-[#FBF8F5] text-sm focus:ring-input-ringFocus focus:border-input-bordeFocus">
                ...
                <div>
                    ...
                    <input type="date" wire:model="f_fecha_inicio" class="w-full rounded-xl border-[#D5CABE] bg-[#FBF8F5] text-sm focus:ring-input-ringFocus focus:border-input-bordeFocus">
                ...
                <div>
                    ...
                    <input type="date" wire:model="f_fecha_fin" class="w-full rounded-xl border-[#D5CABE] bg-[#FBF8F5] text-sm focus:ring-input-ringFocus focus:border-input-bordeFocus">
                ...
                <div>
                    ...
                    <input type="text" wire:model="f_observaciones" placeholder="Ej: Cobertura temporal, reemplazo..." class="w-full rounded-xl border-[#D5CABE] bg-[#FBF8F5] text-sm focus:ring-input-ringFocus focus:border-input-bordeFocus">
                </div>
            </div>
                    ...
                    @foreach($diasSemana as $dia)
                        <label class="relative cursor-pointer select-none">
                            ...
                            <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold border-2 transition-all
                                ...
                                border-borde text-apoyo hover:border-boton-acento/50 bg-[#F0E8DE]">
                                {{ $dia }}
                            </span>
                        </label>
                    @endforeach
        ...
        <div class="bg-[#F0E8DE] rounded-2xl border border-borde overflow-x-auto">
        ...
        @else
        <div class="flex flex-col items-center justify-center py-10 text-apoyo border border-dashed border-borde rounded-2xl bg-[#F0E8DE]">
    ...
    <div class="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
        <div class="w-full max-w-sm bg-[#F0E8DE] rounded-2xl shadow-2xl border border-borde overflow-hidden">
    ...
    <div class="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
        <div class="w-full max-w-md bg-[#F0E8DE] rounded-2xl shadow-2xl border border-borde overflow-hidden">
...
{!! file_get_contents(resource_path('frontend/scripts/modules/livewire-identidad-personal-institucional-horarios.js')) !!}
</script>
@endscript
