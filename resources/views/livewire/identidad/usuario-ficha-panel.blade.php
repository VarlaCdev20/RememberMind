<div class="space-y-6">
 ...
 <span class="font-bold text-parrafo">{{ $usuario->created_at?->format('d/m/Y H:i') ?? 'No disponible en BDD V2' }}</span>
 </div>
 <div class="flex justify-between items-center text-xs border-b border-borde/25 pb-2">
 <span class="font-bold text-parrafo/45">Actualizado:</span>
 <span class="font-bold text-parrafo">{{ $usuario->updated_at?->format('d/m/Y H:i') ?? 'No disponible en BDD V2' }}</span>
 </div>
