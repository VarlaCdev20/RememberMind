...
<div x-data="{
    ...
    <div class="rounded-2xl border border-[var(--rm-border)] bg-[var(--rm-surface)] p-4 sm:p-5 shadow-2xs space-y-3.5">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2 self-start sm:self-auto">
                ...
                <button type="button"
                        @click="$dispatch('abrirModalMedicacion', { cod_am: '{{ $adultoMayor->cod_am }}' })"
    ...
    <div class="rounded-2xl border border-rose-300 bg-rose-50 p-4 sm:p-5 shadow-sm text-xs">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="px-3.5 py-2 rounded-xl bg-white/80 border border-rose-200 text-right">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 pt-1">
        <div class="inline-flex items-center gap-1.5 p-1 rounded-xl bg-[var(--rm-surface-alt)] border border-[var(--rm-border)] text-xs">
            ...
            <button type="button"
                    ...
                    class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition cursor-pointer">
                <span>Próximas</span>
                <span class="px-1.5 py-0.2 rounded-full text-[10px]" :class="filtroPrioritario === 'proximas' ? 'bg-white/20 text-white' : 'bg-amber-100 text-amber-800'">3</span>
            </button>
            ...
            <button type="button"
                ...
                <span class="px-1.5 py-0.2 rounded-full text-[10px]" :class="filtroPrioritario === 'administradas' ? 'bg-white/20 text-white' : 'bg-emerald-100 text-emerald-800'">4</span>
            </button>
            ...
            <button type="button"
                    ...
                    class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition cursor-pointer">
                <span>PRN</span>
                <span class="px-1.5 py-0.2 rounded-full text-[10px]" :class="filtroPrioritario === 'prn' ? 'bg-white/20 text-white' : 'bg-blue-100 text-blue-800'">1</span>
            </button>
            ...
            <button type="button"
                ...
                <span class="px-1.5 py-0.2 rounded-full text-[10px]" :class="filtroPrioritario === 'suspendidas' ? 'bg-white/20 text-white' : 'bg-slate-200 text-slate-700'">0</span>
            </button>
        </div>
    ...
    <div x-show="alertaInterruptiva"
         ...
         class="fixed bottom-5 right-5 z-40 max-w-lg w-full p-4 rounded-2xl bg-white border-2 border-rose-400 shadow-2xl space-y-3">
