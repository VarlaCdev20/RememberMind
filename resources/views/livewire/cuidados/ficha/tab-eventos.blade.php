...
<div class="space-y-6"
    ...
    {{-- 3. BARRA DE FILTROS                                                       --}}
    {{-- ========================================================================= --}}
    <div class="p-3.5 rounded-2xl border border-[var(--rm-border)] bg-[var(--rm-surface)] shadow-2xs flex flex-col md:flex-row md:items-center md:justify-between gap-3">
