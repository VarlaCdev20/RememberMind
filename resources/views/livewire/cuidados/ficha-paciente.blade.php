...
<script>
{!! view()->file(resource_path('frontend/scripts/modules/livewire-cuidados-ficha-paciente.js.blade.php'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render() !!}
</script>
