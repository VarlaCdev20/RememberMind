...
<div class="rm-filter-bar"><div class="grid gap-3 sm:grid-cols-2"><label>Buscar<x-input wire:model.live.debounce.300ms="search" /></label>
<label>Estado<select wire:model.live="filtroEstado"><option value="">Todos</option><option>ACTIVA</option><option>FINALIZADA</option><option>ANULADA</option></select></label></div></div>
