                                ...
                                @foreach($medicaciones as $med)
                                    @php
                                        ...
                                        $estadoClases = match($estado) {
                                            'ACTIVO', 'ACTIVA' => 'bg-estado-exitoBg text-estado-exito border-estado-exitoBorde',
                                            'PAUSADO' => 'bg-estado-advertenciaBg text-estado-advertencia border-estado-advertenciaBorde',
                                            'SUSPENDIDO', 'SUSPENDIDA' => 'bg-estado-peligroBg text-boton-acento border-[var(--rm-border)]-focus',
                                            'FINALIZADO', 'FINALIZADA' => 'bg-[var(--rm-bg-app)] text-[var(--rm-text-muted)] border-[var(--rm-border)]-fuerte',
                                            'ARCHIVADO', 'ARCHIVADA' => 'bg-[var(--rm-bg-app)] text-meta border-[var(--rm-border)]-suave',
