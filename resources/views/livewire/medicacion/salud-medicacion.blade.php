<div class="space-y-6">
    ...
    <section class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl sm:p-6">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="space-y-1">
                <div class="inline-flex items-center gap-2 rounded-full border border-borde/70 bg-fondo-app px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-apoyo">
                    <i class="ph-bold ph-pill text-boton-principal"></i>
                    <span>Módulo Clínico Farmacológico</span>
                </div>
                <h1 class="text-2xl font-black tracking-tight text-parrafo sm:text-3xl">
                    Gestión y Prescripción de Medicación
                </h1>
                <p class="text-xs font-bold text-apoyo sm:text-sm">
                    @if($adulto)
                        Tratamientos y tomas activas para <span class="font-black text-parrafo">{{ $adulto->nombres }} {{ $adulto->ap_paterno }}</span> ({{ $adulto->cod_am }})
                    @else
            ...
            <div class="flex flex-wrap items-center gap-2.5">
                ...
                @if($adulto)
                    <button type="button" wire:click="verUbicacion('{{ $adulto->cod_am }}')" class="inline-flex items-center gap-2 rounded-xl border border-borde bg-fondo-panel px-4 py-2.5 text-xs font-bold text-apoyo shadow-sm transition hover:bg-fondo-hover hover:text-parrafo active:scale-95 cursor-pointer" title="Ver ficha y ubicación del residente">
                        <i class="ph-bold ph-bed text-base text-boton-principal"></i>
                        <span>Ficha y Ubicación</span>
                    </button>
                    <button type="button" wire:click="verGraficos('{{ $adulto->cod_am }}')" class="inline-flex items-center gap-2 rounded-xl border border-borde bg-fondo-panel px-4 py-2.5 text-xs font-bold text-apoyo shadow-sm transition hover:bg-fondo-hover hover:text-parrafo active:scale-95 cursor-pointer" title="Ver gráficos clínicos">
    ...
    <x-ui.modal-livewire id="modalPrescribirMedicacion" wire:model="mostrarFormularioCrear" maxWidth="3xl" closeMethod="cancelarCreacion">
        ...
        <form wire:submit="guardarNuevoMedicamento" id="formNuevoMedicamentoModal" class="space-y-5">
                                <div class="grid gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-2">
                                        <label class="mb-1.5 block text-[10px] font-bold uppercase tracking-wider text-parrafo/70">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select wire:model="nuevo_cod_am" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition appearance-none focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" list="sugerencias-farmacos" wire:model="nuevo_nombre" placeholder="Ej: Paracetamol, Losartán, Enalapril, Omeprazol..." class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition placeholder:text-meta focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" list="sugerencias-dosis" wire:model="nuevo_dosis" placeholder="Ej: 500 mg, 1 tableta, 10 ml..." class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition placeholder:text-meta focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <select wire:model="nuevo_via" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition appearance-none focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" list="sugerencias-frecuencia" wire:model="nuevo_frecuencia" placeholder="Ej: Cada 8 horas, Cada 12 horas..." class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition placeholder:text-meta focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="time" wire:model="nuevo_hora" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="date" wire:model="nuevo_fecha_inicio" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="date" wire:model="nuevo_fecha_fin" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                        </div>
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" wire:model="nuevo_medico" placeholder="Ej: Dr. Roberto Mendoza" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition placeholder:text-meta focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                                        </div>
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <textarea wire:model="nuevo_observacion" rows="2" placeholder="Ej: Administrar con abundante agua después de los alimentos. Monitorear presión arterial previa." class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition placeholder:text-meta focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20"></textarea>
                                        </div>
        ...
        <x-slot name="footer">
            <button type="button" wire:click="cancelarCreacion" class="rounded-xl border border-borde bg-fondo-app px-5 py-2.5 text-xs font-bold text-apoyo transition hover:bg-fondo-panel hover:text-parrafo active:scale-95 cursor-pointer">
                Cancelar
            </button>
            <button type="submit" form="formNuevoMedicamentoModal" wire:loading.attr="disabled" class="inline-flex items-center gap-2 rounded-xl bg-boton-principal px-6 py-2.5 text-xs font-black uppercase tracking-wider text-inverso shadow-sm transition hover:bg-boton-principalHover hover:-translate-y-0.5 active:scale-95 disabled:opacity-50 cursor-pointer">
    ...
    <section class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div class="group relative overflow-hidden rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-md">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-bold uppercase tracking-wider text-apoyo">Activas</span>
                <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-estado-exitoBg text-estado-exito">
                    <i class="ph-bold ph-check-circle text-base"></i>
                </span>
            </div>
            <p class="mt-3 text-2xl font-black text-parrafo">{{ $stats['activas'] }}</p>
            <span class="text-[10px] font-bold text-estado-exito">Prescripciones en curso</span>
        </div>

        <div class="group relative overflow-hidden rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-md">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-bold uppercase tracking-wider text-apoyo">Suspendidas</span>
            ...
            <p class="mt-3 text-2xl font-black text-parrafo">{{ $stats['suspendidas'] }}</p>
            <span class="text-[10px] font-bold text-boton-acento">Pausadas por criterio médico</span>
        </div>

        <div class="group relative overflow-hidden rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-md">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-bold uppercase tracking-wider text-apoyo">Finalizadas</span>
                <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-fondo-app text-apoyo">
                    <i class="ph-bold ph-check-square-offset text-base"></i>
                </span>
            </div>
            <p class="mt-3 text-2xl font-black text-parrafo">{{ $stats['finalizadas'] }}</p>
            <span class="text-[10px] font-bold text-apoyo">Tratamientos concluidos</span>
        </div>

        <div class="group relative overflow-hidden rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-md">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-bold uppercase tracking-wider text-apoyo">Archivadas</span>
                <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-fondo-app text-meta">
                    <i class="ph-bold ph-archive text-base"></i>
                </span>
            </div>
            <p class="mt-3 text-2xl font-black text-parrafo">{{ $stats['archivadas'] }}</p>
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <aside class="space-y-5">
            <section class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl">
                <label class="mb-2 block text-[10px] font-bold uppercase tracking-wider text-parrafo/70">
                    Filtrar por Residente
                </label>
                <div class="relative">
                    <i class="ph-bold ph-user-circle absolute left-3.5 top-1/2 -translate-y-1/2 text-meta"></i>
                    <select wire:model.live="cod_am" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition appearance-none focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
            ...
            @if($adulto)
                ...
                <section class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl">
                    <div class="flex items-center gap-3 border-b border-borde-suave pb-4 mb-4">
                        ...
                        <div>
                            ...
                            <span class="inline-block mt-0.5 rounded bg-fondo-app px-2 py-0.5 text-[9px] font-black uppercase text-apoyo border border-borde/50">ID: {{ $adulto->cod_am }}</span>
                        </div>
                    </div>
                    
                    <div class="space-y-3 text-xs text-apoyo">
                        <div class="flex justify-between items-center rounded-lg bg-fondo-app px-3 py-2 border border-borde-suave">
                ...
                {{-- PANEL PRÓXIMA TOMA --}}
                <section class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl relative overflow-hidden">
                    <h3 class="mb-3 text-[10px] font-black uppercase tracking-widest text-parrafo flex items-center gap-1.5">
                        <i class="ph-bold ph-clock text-boton-principal"></i> Agenda de hoy
                    </h3>
                    ...
                    <div class="space-y-2">
                        @forelse($agenda as $toma)
                            @php
                                $claseAgenda = match($toma['estado']) {
                                    ...
                                    'OMITIDA', 'VENCIDA' => 'border-borde-focus bg-estado-peligroBg text-boton-acento',
                                    'PROXIMA' => 'border-boton-principal/40 bg-boton-principal/10 text-boton-principal',
                                    default => 'border-borde bg-fondo-app text-apoyo',
                                };
                            @endphp
                        ...
                        @empty
                            <div class="py-3 text-center">
                                <i class="ph-bold ph-calendar-x text-2xl text-apoyo"></i>
                                <p class="mt-2 text-xs font-bold text-apoyo">No hay tomas activas programadas para hoy.</p>
                            </div>
                        @endforelse
                    </div>
                </section>
            @else
                <section class="rounded-[1.6rem] border border-dashed border-borde/65 bg-fondo-panel p-6 text-center shadow-inner">
                    <i class="ph-bold ph-hand-pointing text-3xl text-apoyo/40"></i>
                    <p class="mt-2 text-xs font-bold text-apoyo">Seleccione un residente para ver su perfil farmacológico particular o use el botón superior para agregar un medicamento.</p>
                </section>
            @endif
        </aside>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <section class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-4 shadow-sm backdrop-blur-xl sm:p-5">
                <div class="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h3 class="text-xs font-black uppercase tracking-wider text-parrafo">Filtros de Búsqueda</h3>
                    </div>
                    @if($search !== '' || $filtroEstado !== '' || $filtroVia !== '')
                        <button wire:click="limpiarFiltros" type="button" class="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-boton-acento transition hover:text-parrafo">
                ...
                <div class="grid gap-4 sm:grid-cols-3">
                    <div>
                        <label class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-parrafo/60">Medicamento</label>
                        <div class="relative">
                            <i class="ph-bold ph-magnifying-glass absolute left-3.5 top-1/2 -translate-y-1/2 text-meta"></i>
                            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Buscar medicamento..." class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition placeholder:text-meta focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                        </div>
                    </div>
                    
                    <div>
                        <label class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-parrafo/60">Estado</label>
                        <div class="relative">
                            <i class="ph-bold ph-funnel absolute left-3.5 top-1/2 -translate-y-1/2 text-meta"></i>
                            <select wire:model.live="filtroEstado" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition appearance-none focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
                    ...
                    <div>
                        <label class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-parrafo/60">Vía</label>
                        <div class="relative">
                            <i class="ph-bold ph-flask absolute left-3.5 top-1/2 -translate-y-1/2 text-meta"></i>
                            <select wire:model.live="filtroVia" class="w-full rounded-xl border border-borde/70 bg-fondo-app py-2.5 pl-10 pr-4 text-xs font-bold text-parrafo outline-none transition appearance-none focus:border-boton-principal focus:ring-2 focus:ring-boton-principal/20">
            ...
            <section class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel shadow-sm backdrop-blur-xl overflow-hidden relative">
                <div class="flex items-center justify-between border-b border-borde-suave bg-fondo-panel px-5 py-4">
                    <h3 class="text-xs font-black uppercase tracking-wider text-parrafo">
                        @if($adulto) 
                    ...
                    <span class="inline-flex w-max items-center gap-2 rounded-full bg-fondo-app border border-borde/60 px-3 py-1 text-[10px] font-black uppercase tracking-wider text-parrafo/70">
                        <i class="ph-bold ph-list-checks text-boton-principal"></i>
                ...
                @if($medicaciones->isEmpty())
                    <div class="p-10 text-center space-y-4">
                        <div class="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-fondo-app text-apoyo/50 border border-borde-suave">
                            <i class="ph-bold ph-pill text-3xl"></i>
                        </div>
                        <div>
                            <h3 class="text-base font-black text-parrafo">No se encontraron medicamentos</h3>
                            <p class="mx-auto mt-1 max-w-md text-xs font-bold text-apoyo">
                                @if($search !== '' || $filtroEstado !== '' || $filtroVia !== '')
                ...
                @else
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm text-parrafo">
                            <thead class="bg-fondo-app text-[9px] font-black uppercase tracking-widest text-apoyo border-b border-borde-suave">
                                <tr>
                                    @if(!$adulto)
                            ...
                            <tbody class="divide-y divide-borde-suave/60 bg-fondo-panel">
                                @foreach($medicaciones as $med)
                                    @php
                                        ...
                                        $estadoClases = match($estado) {
                                            ...
                                            'FINALIZADO' => 'bg-fondo-app text-apoyo border-borde-fuerte',
                                            'ARCHIVADO' => 'bg-fondo-app text-meta border-borde-suave',
                                            default => 'bg-fondo-app text-apoyo border-borde/45',
                                        };
                                        $esInactivo = in_array($estado, ['FINALIZADO', 'ARCHIVADO']);
                                    @endphp
                                    <tr class="transition-colors hover:bg-fondo-app/50 {{ $esInactivo ? 'opacity-70' : '' }}">
                                        @if(!$adulto)
                                            <td class="px-5 py-4">
                                                <p class="text-xs font-black text-parrafo">{{ $med->adultoMayor->nombres ?? 'S/D' }} {{ $med->adultoMayor->ap_paterno ?? '' }}</p>
                                                <p class="mt-0.5 text-[9px] font-black text-apoyo uppercase">{{ $med->adultoMayor->cod_am ?? '' }}</p>
                                            </td>
                                        @endif
                                        <td class="px-5 py-4">
                                            <p class="text-xs font-black text-parrafo">{{ $med->nombre_medicamento }}</p>
                                            @if($med->medico_indica)
                                                <p class="mt-0.5 text-[9px] font-bold text-apoyo uppercase tracking-wide">
                                        ...
                                        <td class="px-5 py-4">
                                            <p class="text-[10px] font-bold text-apoyo">
                                                <i class="ph-bold ph-clock mr-0.5 text-boton-principal"></i> {{ $med->frecuencia ?: 'S/D' }}
                                            </p>
                                            @if($med->hora_programada)
                                                <p class="text-[9px] font-bold text-apoyo mt-1">
                                        ...
                                        <td class="px-5 py-4 text-right">
                                            <div class="flex items-center justify-end gap-1.5">
                                                @if($estado === 'ACTIVO')
                                                    <button type="button" @click="$dispatch('abrirModalAdministracion', { cod_am: '{{ $med->cod_am }}', cod_med_adulto: '{{ $med->cod_med_adulto }}' })" class="inline-flex items-center gap-1.5 rounded-lg bg-boton-principal px-2.5 py-1.5 text-[9px] font-bold uppercase text-inverso shadow-sm transition hover:bg-boton-principalHover active:scale-95" title="Registrar toma de medicación">
                                                ...
                                                @if($estado === 'ACTIVO' && auth()->user()?->hasAnyRole(['SUPERADMINISTRADOR', 'MEDICO GENERAL/GERIATRA']))
                                                    <button type="button"
                                                        ...
                                                        class="inline-flex items-center justify-center rounded-lg border border-borde-focus bg-estado-peligroBg p-1.5 text-boton-acento transition hover:bg-boton-acento hover:text-inverso active:scale-95 cursor-pointer"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        class="inline-flex items-center justify-center rounded-lg border border-borde-fuerte bg-fondo-panel p-1.5 text-parrafo/80 transition hover:bg-boton-principal hover:text-inverso active:scale-95 cursor-pointer"
