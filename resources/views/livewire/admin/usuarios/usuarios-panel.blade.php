        ...
        <div class="space-y-6 animate-in fade-in duration-300">
            ...
            <header class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between rounded-[1.6rem] border border-borde/55 bg-fondo-panel px-6 py-5 shadow-sm backdrop-blur-xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-[10px] font-black uppercase tracking-[0.25em] text-boton-acento">Ficha de Personal & Familiares</p>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    @can('usuarios.editar')
                        <button type="button" 
                                ...
                                class="inline-flex h-10 items-center gap-2 rounded-full bg-boton-acento px-5 text-xs font-black text-inverso shadow-sm transition hover:bg-fondo-panel active:scale-95">
                    ...
                    <button type="button" 
                            wire:click="volverAlListadoUsuarios"
                            class="inline-flex h-10 items-center gap-2 rounded-full bg-fondo-card/60 border border-borde-suave px-5 text-xs font-black text-parrafo transition hover:bg-fondo-card active:scale-95">
                ...
                <div class="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div class="flex-1 text-center md:text-left space-y-2">
                        <div class="flex flex-wrap items-center justify-center md:justify-start gap-2">
                            <h3 class="text-xl font-black text-parrafo uppercase">{{ $usuarioDetalle->nombres }} {{ $usuarioDetalle->ap_paterno }} {{ $usuarioDetalle->ap_materno }}</h3>
                            <span class="inline-block rounded-full bg-boton-principal px-2.5 py-0.5 text-[9px] font-black tracking-widest text-inverso uppercase">
                                {{ $rolDisplay }}
                            </span>
                        </div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs pt-2">
                            <div>
                                ...
                                <span class="mt-1 inline-block rounded-full px-2 py-0.5 text-[9px] font-black uppercase {{ $usuarioDetalle->estado === 'ACTIVO' ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">
                                    {{ $usuarioDetalle->estado }}
                                </span>
                            </div>
                            <div>
                                <span class="font-black text-meta uppercase tracking-wide block">Acceso al Sistema:</span>
                                <span class="mt-1 inline-block rounded-full px-2 py-0.5 text-[9px] font-black uppercase {{ $usuarioDetalle->acceso_sistema === 'HABILITADO' ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">
                                    {{ $usuarioDetalle->acceso_sistema }}
                                </span>
                            </div>
                            <div>
                                <span class="font-black text-meta uppercase tracking-wide block">Estado Documental:</span>
                                <span class="mt-1 inline-block rounded-full px-2 py-0.5 text-[9px] font-black uppercase {{ $avance['porcentaje_avance'] == 100 ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">
            ...
            <nav class="sticky top-[72px] z-20 -mx-4 px-4 py-3 bg-fondo-panel border-b border-borde-suave backdrop-blur-md overflow-x-auto custom-scrollbar flex gap-2">
                <button type="button"
                   ...
                   class="inline-flex h-9 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black uppercase transition active:scale-95 shadow-sm border-2 {{ $seccionActivaDetalle === 'resumen' ? 'bg-estado-peligroBg border-borde-focus text-boton-acento' : 'bg-fondo-card/60 border-borde-suave text-apoyo hover:bg-fondo-card' }}">
                    <i class="ph-bold ph-list-bullets mr-1.5 text-sm"></i>
                    Resumen
                </button>
                <button type="button"
                   wire:click="cambiarSeccionDetalle('identidad')"
                   class="inline-flex h-9 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black uppercase transition active:scale-95 shadow-sm border-2 {{ $seccionActivaDetalle === 'identidad' ? 'bg-estado-peligroBg border-borde-focus text-boton-acento' : 'bg-fondo-card/60 border-borde-suave text-apoyo hover:bg-fondo-card' }}">
                    <i class="ph-bold ph-identification-card mr-1.5 text-sm"></i>
                    Identidad
                </button>
                <button type="button"
                   wire:click="cambiarSeccionDetalle('contacto')"
                   class="inline-flex h-9 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black uppercase transition active:scale-95 shadow-sm border-2 {{ $seccionActivaDetalle === 'contacto' ? 'bg-estado-peligroBg border-borde-focus text-boton-acento' : 'bg-fondo-card/60 border-borde-suave text-apoyo hover:bg-fondo-card' }}">
                    <i class="ph-bold ph-phone mr-1.5 text-sm"></i>
                    Contacto
                </button>
                <button type="button"
                   wire:click="cambiarSeccionDetalle('perfil')"
                   class="inline-flex h-9 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black uppercase transition active:scale-95 shadow-sm border-2 {{ $seccionActivaDetalle === 'perfil' ? 'bg-estado-peligroBg border-borde-focus text-boton-acento' : 'bg-fondo-card/60 border-borde-suave text-apoyo hover:bg-fondo-card' }}">
                    <i class="ph-bold ph-user-gear mr-1.5 text-sm"></i>
                    Perfil
                </button>
                <button type="button"
                   wire:click="cambiarSeccionDetalle('documentos')"
                   class="inline-flex h-9 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black uppercase transition active:scale-95 shadow-sm border-2 {{ $seccionActivaDetalle === 'documentos' ? 'bg-estado-peligroBg border-borde-focus text-boton-acento' : 'bg-fondo-card/60 border-borde-suave text-apoyo hover:bg-fondo-card' }}">
                    <i class="ph-bold ph-files mr-1.5 text-sm"></i>
                    Documentos
                </button>
                <button type="button"
                   wire:click="cambiarSeccionDetalle('acceso')"
                   class="inline-flex h-9 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black uppercase transition active:scale-95 shadow-sm border-2 {{ $seccionActivaDetalle === 'acceso' ? 'bg-estado-peligroBg border-borde-focus text-boton-acento' : 'bg-fondo-card/60 border-borde-suave text-apoyo hover:bg-fondo-card' }}">
                ...
                <button type="button"
                   ...
                   class="inline-flex h-9 shrink-0 items-center justify-center rounded-xl px-4 text-xs font-black uppercase transition active:scale-95 shadow-sm border-2 {{ $seccionActivaDetalle === 'vinculo' ? 'bg-estado-peligroBg border-borde-focus text-boton-acento' : 'bg-fondo-card/60 border-borde-suave text-apoyo hover:bg-fondo-card' }}">
            ...
            <div class="space-y-6">
                ...
                <section id="seccion-resumen" class="animate-in fade-in duration-200 rounded-[1.8rem] border border-borde-suave bg-fondo-card/70 p-6 shadow-sm backdrop-blur-md space-y-4">
                    <h4 class="flex items-center gap-2 border-b border-borde-suave pb-2 text-xs font-black uppercase tracking-widest text-boton-acento">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-xs">
                        ...
                        <div>
                            ...
                            <span class="mt-1 inline-block rounded-full px-2.5 py-0.5 text-[10px] font-black uppercase {{ $usuarioDetalle->estado === 'ACTIVO' ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">
                                {{ $usuarioDetalle->estado }}
                            </span>
                        </div>
                        <div>
                            <span class="font-black text-meta uppercase tracking-wider block">Acceso al Sistema:</span>
                            <span class="mt-1 inline-block rounded-full px-2.5 py-0.5 text-[10px] font-black uppercase {{ $usuarioDetalle->acceso_sistema === 'HABILITADO' ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">
                                {{ $usuarioDetalle->acceso_sistema }}
                            </span>
                        </div>
                        <div>
                            <span class="font-black text-meta uppercase tracking-wider block">Estado Documental:</span>
                            <span class="mt-1 inline-block rounded-full px-2.5 py-0.5 text-[10px] font-black uppercase {{ $avance['porcentaje_avance'] == 100 ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">
                                {{ $avance['porcentaje_avance'] == 100 ? 'COMPLETA' : 'PENDIENTE' }} ({{ $avance['porcentaje_avance'] }}%)
                            </span>
                        </div>
                        @if($usuarioDetalle->created_at)
                ...
                <section id="seccion-perfil" class="animate-in fade-in duration-200 rounded-[1.8rem] border border-borde-suave bg-fondo-card/70 p-6 shadow-sm backdrop-blur-md space-y-4">
                    ...
                    @else
                        <div class="py-4 text-center">
                            <span class="text-xs font-black text-meta uppercase tracking-widest">Sin datos adicionales de rol</span>
                        </div>
                    @endif
                </section>
                @endif
                ...
                <section id="seccion-documentacion" class="animate-in fade-in duration-200 rounded-[1.8rem] border border-borde-suave bg-fondo-card/70 p-6 shadow-sm backdrop-blur-md space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="pt-2 flex flex-col gap-2">
                                <a href="{{ route('admin.usuarios.documentos.pdf', $usuarioDetalle->cod_usu) }}"
                                   target="_blank"
                                   class="w-full inline-flex h-9 items-center justify-center gap-1.5 rounded-xl bg-boton-principal text-inverso text-[10px] font-black uppercase tracking-wider transition hover:bg-boton-acento active:scale-95 shadow-sm">
                                    <i class="ph-bold ph-printer"></i>
                                    Paquete Documental
                                </a>
                                <button type="button" 
                                        onclick="enviarPaqueteCorreo('{{ $usuarioDetalle->cod_usu }}', '{{ $usuarioDetalle->correo }}')"
                                        class="w-full inline-flex h-9 items-center justify-center gap-1.5 rounded-xl bg-fondo-panel text-[10px] font-black text-parrafo border border-borde-fuerte transition hover:bg-boton-principal hover:text-inverso active:scale-95 shadow-sm">
                                ...
                                <button type="button"
                                        ...
                                        class="w-full inline-flex h-9 items-center justify-center gap-1.5 rounded-xl bg-fondo-card text-xs font-black text-boton-acento border border-borde-focus transition hover:bg-boton-acento hover:text-inverso active:scale-95 shadow-md mt-2">
                    ...
                    <div class="mt-8 border-t border-borde-suave pt-6">
                        <h4 class="flex items-center gap-2 mb-4 text-xs font-black uppercase tracking-widest text-boton-acento">
                                ...
                                <div class="flex flex-col p-4 rounded-[1.2rem] border border-borde-suave bg-fondo-card shadow-sm hover:shadow-md transition">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-xs font-black text-parrafo uppercase truncate" title="{{ $docInst['nombre'] }}">{{ $docInst['nombre'] }}</p>
                                    ...
                                    <div class="mt-auto pt-4 flex items-center gap-2">
                                        <a href="{{ route('admin.usuarios.documentos.ver', ['user' => $usuarioDetalle->cod_usu, 'documento' => $docInst['slug']]) }}" target="_blank"
                                           class="flex-1 h-8 bg-fondo-panel hover:bg-boton-principal text-parrafo hover:text-inverso text-[10px] font-black uppercase rounded-lg flex items-center justify-center gap-1 transition">
                                        ...
                                        <a href="{{ route('admin.usuarios.documentos.imprimir', ['user' => $usuarioDetalle->cod_usu, 'documento' => $docInst['slug']]) }}" target="_blank"
                                           class="flex-1 h-8 bg-fondo-card border border-borde-suave hover:border-borde-focus text-parrafo hover:text-boton-acento text-[10px] font-black uppercase rounded-lg flex items-center justify-center gap-1 transition">
                ...
                @if($seccionActivaDetalle === 'vinculo' && $rolKey === 'familiar')
                    ...
                    <section id="seccion-vinculacion" class="animate-in fade-in duration-200 rounded-[1.8rem] border border-borde-suave bg-fondo-card/70 p-6 shadow-sm backdrop-blur-md space-y-4">
                        ...
                        @else
                            <div class="py-4 text-center">
                                <span class="text-xs font-black text-meta uppercase tracking-widest">Sin adultos mayores vinculados</span>
                            </div>
                        @endif
                    </section>
                @endif
            ...
            <div class="flex items-center justify-between border-t border-borde-suave pt-4">
                <button type="button" 
                        wire:click="volverAlListadoUsuarios" 
                        class="inline-flex h-9 items-center gap-2 rounded-xl bg-fondo-panel px-4 text-xs font-black text-parrafo transition hover:bg-boton-principal hover:text-inverso active:scale-95">
                    <i class="ph-bold ph-arrow-left"></i>
                    Volver al Listado
                </button>
                <button type="button" 
                        onclick="window.scrollTo({top: 0, behavior: 'smooth'})" 
                        class="inline-flex h-9 items-center gap-2 rounded-xl bg-fondo-card/60 border border-borde-suave px-4 text-xs font-black text-parrafo transition hover:bg-fondo-card active:scale-95">
    ...
    <header class="mb-5 rounded-[1.6rem] border border-borde/55 bg-fondo-panel px-6 py-5 shadow-[0_10px_26px_rgba(47,62,92,0.07)] backdrop-blur-xl">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-[10px] font-black uppercase tracking-[0.28em] text-boton-acento">
            ...
            <button type="button"
                    ...
                    class="inline-flex items-center justify-center gap-2 rounded-full bg-boton-acento px-6 py-3 text-sm font-black text-inverso shadow-lg shadow-[#E27D60]/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl active:translate-y-0 active:scale-95">
    ...
    <section class="mb-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <article class="rounded-[1.35rem] border border-borde bg-fondo-panel p-5 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-fondo-panel hover:shadow-md">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-[10px] font-black uppercase tracking-[0.22em] text-parrafo/42">
...
<section class="mb-5 rounded-[1.35rem] bg-fondo-panel px-4 py-3 shadow-[0_12px_28px_rgba(47,62,92,0.11)] backdrop-blur-md">
    <div class="grid items-end gap-3 xl:grid-cols-12">
        <div class="xl:col-span-3">
            <label class="mb-1 block text-[9px] font-black uppercase tracking-[0.18em] text-parrafo/45">
                Buscar
            </label>
        ...
        <div class="xl:col-span-2">
            ...
            <select wire:model.defer="filtroRol"
                    class="h-10 w-full rounded-xl border-0 bg-fondo-panel px-3 text-xs font-black text-parrafo shadow-[inset_0_1px_0_rgba(255,255,255,0.45),0_4px_12px_rgba(47,62,92,0.04)] outline-none transition-all focus:bg-fondo-card focus:ring-2 focus:ring-[#E27D60]/18">
        ...
        <div class="flex gap-2 xl:col-span-1">
            <button type="button"
                    ...
                    class="inline-flex h-10 flex-1 items-center justify-center gap-1.5 rounded-xl bg-boton-principal px-3 text-[10px] font-black uppercase tracking-wide text-inverso shadow-[0_8px_16px_rgba(47,62,92,0.18)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(47,62,92,0.24)] active:scale-95"
                    title="Buscar">
    ...
    <section class="relative">
        <div wire:loading.delay wire:target="aplicarFiltros,limpiarFiltros,toggleEstado,abrirFichaRapida,abrirVistaCompleta,editarUsuario" class="absolute inset-0 z-[60] flex items-center justify-center rounded-[2rem] bg-fondo-card/45 backdrop-blur-sm">
            <div class="flex items-center gap-3 rounded-full bg-fondo-card px-5 py-3 shadow-lg">
                ...
                <span class="text-xs font-black uppercase tracking-widest text-parrafo">
                    Cargando
                </span>
            </div>
        </div>
                    ...
                    <article wire:key="card-user-{{ $u->cod_usu }}"
                        ...
                        <div class="p-3">
                            ...
                            <div class="mb-2 flex justify-end">
                                @if($u->estado === 'ACTIVO')
                                    <span class="inline-flex items-center gap-1.5 rounded-full bg-estado-exitoBg px-2.5 py-1 text-[9px] font-black uppercase text-estado-exito">
                                        <span class="h-1.5 w-1.5 rounded-full bg-estado-exitoBg"></span>
                                        Activo
                                    </span>
                                @else
                                    <span class="inline-flex items-center gap-1.5 rounded-full bg-fondo-panel px-2.5 py-1 text-[9px] font-black uppercase text-meta">
                            ...
                            <div class="flex flex-col items-center text-center">
                                ...
                                <h3 class="mt-2.5 line-clamp-2 text-sm font-black uppercase leading-5 text-parrafo">
                                    {{ $nombreCompleto }}
                                </h3>
                            ...
                            <div class="mt-3 space-y-2">
                                ...
                                <div class="rounded-xl border border-borde bg-fondo-panel/75 px-3 py-2">
                                    <p class="text-[9px] font-black uppercase tracking-[0.16em] text-parrafo/35">
                                        Último acceso
                                    </p>
                                    @if($ultimoAcceso)
                            ...
                            <div class="mt-3 flex items-center justify-center gap-1.5">
                                ...
                                <button type="button"
                                        ...
                                        class="inline-flex h-8 items-center gap-1.5 rounded-full bg-boton-principal px-2.5 text-[9px] font-black text-inverso shadow-sm transition hover:bg-fondo-panel active:scale-95"
                                ...
                                @if($estaInactivo)
                                    <button type="button"
                                            ...
                                            class="inline-flex h-8 cursor-not-allowed items-center gap-1.5 rounded-full bg-fondo-panel px-2.5 text-[9px] font-black text-meta">
                                ...
                                @else
                                    <button type="button"
                                            ...
                                            class="inline-flex h-8 items-center gap-1.5 rounded-full bg-boton-acento px-2.5 text-[9px] font-black text-inverso shadow-sm transition hover:bg-fondo-panel active:scale-95">
                                        <i class="ph-bold ph-pencil-simple"></i>
                                        Editar
                                    </button>
                                @endif
                                ...
                                <button type="button"
                                        ...
                                        class="inline-flex h-8 items-center gap-1.5 rounded-full bg-fondo-panel px-2.5 text-[9px] font-black text-parrafo shadow-sm transition hover:bg-fondo-panel hover:text-inverso active:scale-95"
                                        title="Ficha rápida">
                ...
                @empty
                    <div class="col-span-full py-8 text-center">
                        <div class="mx-auto flex max-w-md flex-col items-center">
                            ...
                            <h3 class="mt-4 text-lg font-black text-parrafo">
                            ...
                            <tr class="transition-all duration-200 {{ $estaInactivo ? 'bg-fondo-panel grayscale opacity-70' : 'hover:bg-fondo-panel' }}"
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex min-w-0 items-center gap-3">
                                        <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-boton-principal text-sm font-black text-inverso shadow-sm">
                                            {{ strtoupper($inicial) }}
                                        </div>
                                        <div class="min-w-0">
                                ...
                                <td class="px-5 py-4">
                                    @if($u->estado === 'ACTIVO')
                                        <span class="rounded-full bg-estado-exitoBg px-3 py-1 text-[10px] font-black uppercase text-estado-exito">
                                            Activo
                                        </span>
                                    @else
                                        <span class="rounded-full bg-fondo-panel px-3 py-1 text-[10px] font-black uppercase text-meta">
                                            Inactivo
                                        </span>
                                    @endif
                                </td>
        ...
        <div class="relative z-[2147483647] w-full max-w-4xl max-h-[92vh] overflow-hidden rounded-[24px] border border-borde-suave bg-fondo-app shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-in fade-in zoom-in duration-300 flex flex-col">
            ...
            <header class="relative border-b border-borde-suave bg-fondo-panel px-4 py-3 backdrop-blur-xl shrink-0">
                <div class="flex items-center justify-between gap-4 mb-2">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-black text-parrafo">
            ...
            <div class="flex-1 max-h-[62vh] overflow-y-auto custom-scrollbar px-4 py-3">
                ...
                <div class="space-y-4 animate-in slide-in-from-right-4 duration-300">
                    <div class="flex items-center gap-3 border-b border-borde-suave pb-2">
                        ...
                        <h3 class="text-xs font-black text-parrafo uppercase tracking-widest">Información Personal</h3>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-5 bg-fondo-card/40 p-4 rounded-2xl border border-borde-suave">
                        ...
                        <div class="flex-1 text-center sm:text-left space-y-1">
                            <h4 class="text-xs font-black text-parrafo uppercase tracking-wider">Fotografía Institucional</h4>
                            <p class="text-[10px] text-apoyo font-semibold leading-relaxed">
                                Formatos permitidos: JPG, JPEG, PNG, WEBP. Tamaño máximo: 4MB.
                            </p>
                            <label class="inline-flex items-center gap-2 px-3 py-1.5 bg-boton-principal hover:bg-boton-acento text-inverso rounded-lg text-[9px] font-black uppercase tracking-wider cursor-pointer shadow transition active:scale-95">
                            ...
                            @error('foto_de_perfil_upload') 
                                <span class="block text-[9px] font-black text-boton-acento uppercase mt-1">{{ $message }}</span> 
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <div class="md:col-span-2 lg:col-span-3">
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Nombres *</label>
                            ...
                            @error('nombres') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Apellido Paterno *</label>
                            ...
                            @error('ap_paterno') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Apellido Materno</label>
                        ...
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Género *</label>
                            ...
                            @error('genero') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <div class="flex justify-between items-center mb-1">
                                <label class="block text-[9px] font-black uppercase tracking-widest text-apoyo">Fecha Nacimiento *</label>
                                @if($edad !== null)
                                    <span class="text-[9px] font-black text-boton-acento uppercase tracking-wider">Edad: {{ $edad }} años</span>
                                @endif
                            </div>
                            ...
                            @error('fecha_nacimiento') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">País Emisor *</label>
                        ...
                        <div class="md:col-span-2 lg:col-span-3 grid gap-3 {{ (mb_strtoupper((string) $pais_documento, 'UTF-8') === 'BOLIVIA' && $tipo_documento === 'CI') ? 'grid-cols-12' : 'grid-cols-3' }}">
                            <div class="{{ (mb_strtoupper((string) $pais_documento, 'UTF-8') === 'BOLIVIA' && $tipo_documento === 'CI') ? 'col-span-3' : 'col-span-1' }} {{ mb_strtoupper((string) $pais_documento, 'UTF-8') !== 'OTRO' ? 'pointer-events-none opacity-60' : '' }}">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Tipo *</label>
                                <select wire:model.live="tipo_documento" tabindex="-1" class="w-full h-10 rounded-xl border border-borde bg-fondo-card px-3 py-2 text-xs font-black text-parrafo outline-none transition focus:border-borde-fuerte">
                            ...
                            <div class="{{ (mb_strtoupper((string) $pais_documento, 'UTF-8') === 'BOLIVIA' && $tipo_documento === 'CI') ? 'col-span-6' : 'col-span-2' }}">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Número Doc *</label>
                            ...
                            <div class="col-span-3">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-boton-acento">Expedido (EXP) *</label>
                                <select wire:model="expedido" class="w-full h-10 rounded-xl border {{ $errors->has('expedido') ? 'border-borde-focus' : 'border-borde' }} bg-fondo-card px-3 py-2 text-xs font-black text-parrafo outline-none transition focus:border-borde-fuerte">
                                    <option value="">SELECCIONE...</option>
                            ...
                            @endif
                            @error('numero_documento') <div class="col-span-full"><span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span></div> @enderror
                            @error('expedido') <div class="col-span-full"><span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span></div> @enderror
                ...
                <div class="space-y-4 animate-in slide-in-from-right-4 duration-300">
                    <div class="flex items-center gap-3 border-b border-borde-suave pb-2">
                        ...
                        <h3 class="text-xs font-black text-parrafo uppercase tracking-widest">Contacto y Domicilio</h3>
                    </div>
                    <div class="grid gap-4 md:grid-cols-2">
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Correo Institucional *</label>
                            ...
                            @error('correo') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>

                        <div class="grid grid-cols-12 gap-2">
                            <div class="col-span-5">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">País Celular</label>
                                <select wire:model.live="pais_telefono" class="w-full h-10 rounded-xl border border-borde bg-fondo-card px-1 py-2 text-[9px] font-black text-parrafo outline-none transition">
                            ...
                            <div class="col-span-7">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Celular *</label>
                                <div class="flex gap-2">
                                    <span class="inline-flex items-center justify-center h-10 px-2 rounded-xl bg-fondo-panel border border-borde text-xs font-black text-parrafo">
                                        {{ $codigo_telefono ?: '+??' }}
                                    </span>
                                ...
                                @error('telefono') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        {{-- Domicilio --}}
                        <div class="md:col-span-2 border-t border-borde-suave pt-3">
                            <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest mb-3">Dirección de Domicilio</h4>
                        </div>

                        <!-- 1. Departamento -->
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Departamento de Domicilio *</label>
                            ...
                            @error('departamento_domicilio') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>

                        <!-- Especifique Departamento (si aplica) -->
                        @if($departamento_domicilio === 'OTRO')
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Especifique Departamento *</label>
                                ...
                                @error('otro_departamento') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                        @else
                        ...
                        <!-- 2. Municipio / Ciudad -->
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Municipio / Localidad *</label>
                            @if($departamento_domicilio === 'OTRO')
                                ...
                                @error('otro_municipio') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            @else
                                ...
                                @error('municipio_domicilio') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            @endif
                        </div>

                        <!-- 3. Zona / Barrio -->
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Zona / Barrio *</label>
                            @if(isset($catalogZonas[$municipio_domicilio]))
                                ...
                                @error('zona_domicilio') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            @else
                                ...
                                @error('otra_zona') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            @endif
                        </div>
                        ...
                        @if($municipio_domicilio === 'OTRO' && $departamento_domicilio !== 'OTRO')
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Especifique Municipio *</label>
                        ...
                        @if(isset($catalogZonas[$municipio_domicilio]) && $zona_domicilio === 'OTRO')
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Especifique Zona / Barrio *</label>
                        ...
                        <div class="md:col-span-2 grid grid-cols-12 gap-3">
                            <div class="col-span-8">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Calle / Avenida *</label>
                                ...
                                @error('calle') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-span-4">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Nro. Domicilio *</label>
                                ...
                                @error('nro_domicilio') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        <!-- 8. Referencia de domicilio -->
                        <div class="md:col-span-2">
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Referencia de Domicilio</label>
                            ...
                            @error('referencia_domicilio') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>

                        {{-- Emergencia --}}
                        <div class="md:col-span-2 border-t border-borde-suave pt-3">
                            <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest mb-3">Contacto de Emergencia</h4>
                        </div>

                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Nombres Emergencia *</label>
                                ...
                                @error('contacto_emergencia') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Apellido Paterno *</label>
                                ...
                                @error('ap_paterno_emergencia') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Apellido Materno</label>
                                ...
                                @error('ap_materno_emergencia') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Parentesco / Relación</label>
                            ...
                            @error('parentesco_emergencia') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Celular de Emergencia</label>
                            ...
                            @error('celular_emergencia') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="space-y-4 animate-in slide-in-from-right-4 duration-300">
                    <div class="flex items-center gap-3 border-b border-borde-suave pb-2">
                        ...
                        <h3 class="text-xs font-black text-parrafo uppercase tracking-widest">Tipo de usuario / rol institucional</h3>
                    </div>
                    <div class="grid gap-4 md:grid-cols-2 max-w-3xl">
                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Tipo de usuario / rol institucional *</label>
                            <select wire:model.live="rol" class="w-full h-10 rounded-xl border {{ $errors->has('rol') ? 'border-borde-focus ring-4 ring-[#E27D60]/10' : 'border-borde focus:border-borde-fuerte' }} bg-fondo-card px-4 py-2 text-sm font-black text-parrafo outline-none transition">
                            ...
                            @error('rol') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Área Institucional Operativa</label>
                            <select wire:model="cod_area" class="w-full h-10 rounded-xl border {{ $errors->has('cod_area') ? 'border-borde-focus ring-4 ring-[#E27D60]/10' : 'border-borde focus:border-borde-fuerte' }} bg-fondo-card px-4 py-2 text-sm font-black text-parrafo outline-none transition">
                            ...
                            @error('cod_area') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            ...
                            @if($rol)
                                ...
                                @endphp
                                @if($sugeridaTxt)
                                    <p class="mt-1 text-[9px] font-black uppercase text-boton-acento tracking-wider flex items-center gap-1 animate-pulse">
                        ...
                        <div class="md:col-span-2 grid gap-4 md:grid-cols-2 border-t border-borde-suave pt-3 animate-in fade-in duration-300">
                            <div class="md:col-span-2">
                                <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest">Información Profesional Médica</h4>
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-boton-acento">Especialidad Médica *</label>
                                ...
                                @error('especialidad_salud') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Fecha de Ingreso *</label>
                                ...
                                @error('fecha_ingreso') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                            <div class="md:col-span-2">
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Institución de Formación</label>
                                ...
                                @error('institucion_formacion') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                        ...
                        <div class="md:col-span-2 grid gap-4 md:grid-cols-2 border-t border-borde-suave pt-3 animate-in fade-in duration-300">
                            <div class="md:col-span-2">
                                <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest">Información de Cargo Administrativo</h4>
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Cargo Administrativo *</label>
                                ...
                                @else
                                    ...
                                    @error('cargo_administrativo') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                                @endif
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Fecha de Ingreso *</label>
                        ...
                        <div class="md:col-span-2 grid gap-4 md:grid-cols-2 border-t border-borde-suave pt-3 animate-in fade-in duration-300">
                            <div class="md:col-span-2">
                                <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest">Perfil de Voluntariado</h4>
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Disponibilidad Inicial</label>
                                ...
                                @error('disponibilidad_inicial') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Área de Apoyo Preferente</label>
                                ...
                                @error('area_apoyo_preferente') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Fecha de Ingreso *</label>
                                <input type="date" wire:model="fecha_ingreso" {{ !$isEdit ? 'readonly tabindex="-1"' : '' }} class="w-full h-10 rounded-xl border border-borde bg-fondo-panel {{ !$isEdit ? 'opacity-70 pointer-events-none' : '' }} px-4 py-2 text-sm font-bold text-parrafo outline-none transition focus:border-borde-fuerte">
                        ...
                        <div class="md:col-span-2 grid gap-6 border-t border-borde-suave pt-4 animate-in fade-in duration-300">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-borde-suave pb-2">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest">Vinculacion con adulto mayor</h4>
                                </div>
                            ...
                            <div class="p-4 rounded-2xl bg-fondo-panel border border-borde-suave space-y-4 animate-in slide-in-from-top-4 duration-300">
                                <div class="flex items-center gap-2 border-b border-borde-suave pb-1.5">
                                    ...
                                    <h5 class="text-[9px] font-black uppercase tracking-widest text-parrafo">Registro Rápido de Adulto Mayor</h5>
                                </div>
                            ...
                            <div class="space-y-2">
                                <h5 class="text-[9px] font-black uppercase tracking-widest text-parrafo/80 flex items-center gap-1.5">
                            ...
                            <div>
                                <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-parrafo">Observación General de Vinculación Familiar</label>
                                ...
                                @error('observacion_vinculo') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        @endif
                ...
                <div class="space-y-4 animate-in slide-in-from-right-4 duration-300" x-data="{ showPass: false, showConfirm: false }">
                    <div class="flex items-center gap-3 border-b border-borde-suave pb-2">
                        ...
                        <h3 class="text-xs font-black text-parrafo uppercase tracking-widest">Seguridad de Acceso</h3>
                    </div>
                            ...
                            @if(!$isEdit)
                                ...
                                <div class="bg-fondo-panel border-l-4 border-borde-fuerte p-4 rounded-r-xl space-y-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest">Contraseña Temporal y Notificación</h4>
                                    </div>
                                    ...
                                    <p class="text-[10px] font-black text-boton-acento uppercase leading-relaxed">
                                ...
                                <div class="space-y-4">
                                     <div class="bg-fondo-panel border-l-4 border-borde-fuerte p-4 rounded-r-xl space-y-2">
                                         <div class="flex items-center gap-2">
                                             <i class="ph-bold ph-key text-parrafo text-lg"></i>
                                             <h4 class="text-[10px] font-black text-parrafo uppercase tracking-widest">Contraseña Temporal de Acceso</h4>
                                         </div>
                                         <p class="text-[10px] font-bold text-parrafo/75 leading-relaxed">
                                     ...
                                     <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 bg-fondo-panel border border-borde-suave p-4 rounded-2xl" x-data="{ showGenPass: false }">
                                         ...
                                         <button type="button" 
                                                 ...
                                                 class="h-11 px-5 inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento text-[10px] font-black uppercase text-inverso shadow-md shadow-[#E27D60]/20 hover:bg-fondo-panel active:scale-95 transition">
                            ...
                            @if($usuarioId === auth()->id())
                                <div class="md:col-span-2 grid gap-4 md:grid-cols-3">
                                    <div x-data="{ showActual: false }">
                                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-boton-acento">Contraseña Actual *</label>
                                        <div class="relative">
                                        ...
                                        @error('password_actual') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                                    </div>
                                    <div>
                                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Nueva Contraseña</label>
                                        <div class="relative">
                                        ...
                                        @error('password') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                                    </div>
                                    <div>
                                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Confirmar Contraseña</label>
                                        <div class="relative">
                            ...
                            @else
                                <div class="md:col-span-2 flex flex-col items-center justify-center p-6 bg-fondo-panel border border-borde-fuerte rounded-2xl space-y-3">
                                    ...
                                    <div class="text-center max-w-md">
                                        <h4 class="text-xs font-black text-parrafo uppercase tracking-wider">Restablecimiento de Credenciales</h4>
                                    ...
                                    <button type="button"
                                            ...
                                            class="inline-flex items-center gap-2 rounded-xl bg-boton-principal px-5 py-2.5 text-[9px] font-black uppercase tracking-wider text-inverso shadow-md hover:bg-boton-acento active:scale-95 transition-all duration-300">
                ...
                <div class="space-y-4 animate-in zoom-in duration-300" x-data="{ showPassSummary: false }">
                    <div class="flex items-center gap-3 border-b border-borde-suave pb-2">
                        ...
                        <h3 class="text-xs font-black text-parrafo uppercase tracking-widest">Resumen de Registro</h3>
                    </div>
                    <div class="grid gap-4 lg:grid-cols-2">
                        <div class="rounded-xl bg-fondo-card/50 p-5 border border-borde-suave space-y-4">
                            <div class="flex items-center gap-4">
                                ...
                                @else
                                    <div class="flex h-16 w-16 items-center justify-center rounded-[1.1rem] bg-boton-principal text-xl font-black text-inverso shadow uppercase">
                                        {{ mb_substr($nombres ?? 'U', 0, 1) }}{{ mb_substr($ap_paterno ?? 'I', 0, 1) }}
                                    </div>
                                @endif
                                <div>
                                    <h4 class="text-sm font-black text-parrafo uppercase leading-tight">{{ $nombres }} {{ $ap_paterno }} {{ $ap_materno }}</h4>
                            ...
                            <div class="grid grid-cols-2 gap-3 border-t border-borde-suave pt-3">
                                <div>
                                    ...
                                    <p class="text-[10px] font-black text-parrafo uppercase mt-0.5">{{ $numero_documento }} {{ $expedido }}</p>
                                </div>
                                <div>
                                    <p class="text-[8px] font-black text-meta uppercase tracking-wider">Nacionalidad / Emisor</p>
                                    <p class="text-[10px] font-black text-parrafo uppercase mt-0.5">{{ $pais_documento }}</p>
                                </div>
                                <div>
                                    <p class="text-[8px] font-black text-meta uppercase tracking-wider">Celular de Contacto</p>
                                    <p class="text-[10px] font-black text-parrafo mt-0.5">{{ $codigo_telefono }} {{ $telefono }}</p>
                                </div>
                                <div>
                                    <p class="text-[8px] font-black text-meta uppercase tracking-wider">Correo Institucional</p>
                                    <p class="text-[10px] font-black text-parrafo lowercase mt-0.5 truncate">{{ $correo }}</p>
                                </div>
                                <div class="col-span-2 border-t border-borde/10 pt-2">
                                    ...
                                    <p class="text-[10px] font-black text-parrafo mt-0.5 leading-tight">
            ...
            <footer class="border-t border-borde-suave bg-fondo-panel px-4 py-2.5 backdrop-blur-xl shrink-0 flex flex-col-reverse sm:flex-row items-center justify-between gap-2">
                <button type="button" wire:click="cerrarFormulario" 
                        class="w-full sm:w-auto px-6 py-2.5 rounded-xl border-2 border-borde-fuerte text-meta text-[9px] font-black uppercase tracking-widest transition hover:bg-boton-principal hover:text-inverso active:scale-95 shadow-sm">
                    Cancelar
                </button>
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <button type="button" wire:click="anteriorPaso" 
                            class="flex-1 sm:flex-none px-5 py-2.5 rounded-xl border-2 border-borde-fuerte text-parrafo text-[9px] font-black uppercase tracking-widest transition hover:bg-boton-principal hover:text-inverso active:scale-95">
                        Anterior
                    </button>
                    @endif
                    ...
                    <button type="button" wire:click="siguientePaso" 
                            class="flex-1 sm:flex-none px-10 py-2.5 rounded-xl bg-boton-principal text-inverso text-[9px] font-black uppercase tracking-widest shadow-xl shadow-[#2F3E5C]/20 transition hover:bg-boton-acento active:scale-95">
                    ...
                    <button type="button" wire:click="guardarUsuario" 
                            ...
                            class="flex-1 sm:flex-none px-12 py-2.5 rounded-xl bg-boton-acento text-inverso text-[9px] font-black uppercase tracking-widest shadow-xl shadow-[#E27D60]/20 transition hover:bg-boton-principal active:scale-95 disabled:opacity-70 inline-flex items-center justify-center gap-2 min-w-[140px]">
        ...
        <div class="relative w-full max-w-5xl max-h-full overflow-hidden rounded-[2rem] border border-borde-suave bg-fondo-app shadow-[0_25px_65px_rgba(0,0,0,0.6)] flex flex-col"
            ...
            <header class="relative flex items-center justify-between border-b border-borde-suave bg-fondo-panel px-6 py-4 backdrop-blur-xl shrink-0">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-black tracking-tight text-parrafo">Ficha de <span class="text-boton-acento">Usuario</span></h2>
                        <p class="text-[10px] font-black uppercase tracking-widest text-meta">Ficha institucional</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="lg:col-span-4 flex flex-col items-center space-y-6">
                        ...
                        <div class="text-center w-full">
                            ...
                            <div class="mt-4 flex flex-wrap justify-center gap-2">
                                <span class="rounded-full {{ $usuarioVista->estado === 'ACTIVO' ? 'bg-estado-exitoBg text-estado-exito' : 'bg-fondo-panel text-meta' }} px-4 py-1.5 text-xs font-black uppercase">
                                    <i class="ph-bold {{ $usuarioVista->estado === 'ACTIVO' ? 'ph-check-circle' : 'ph-minus-circle' }} mr-1"></i>
                                    {{ $usuarioVista->estado }}
                                </span>
                                <span class="rounded-full bg-fondo-panel px-4 py-1.5 text-xs font-black uppercase text-parrafo">
                        ...
                        <div class="w-full rounded-2xl bg-fondo-card/40 border border-borde-suave p-5 space-y-4 shadow-sm">
                            <div>
                                <p class="text-[9px] font-black uppercase tracking-widest text-meta">Acceso al Sistema</p>
                            ...
                            <div>
                                <p class="text-[9px] font-black uppercase tracking-widest text-meta">Último Acceso</p>
                    ...
                    <div class="lg:col-span-8 space-y-6">
                        ...
                        <div class="rounded-[1.5rem] bg-fondo-card/60 border border-borde-suave p-6 shadow-sm">
                            <h4 class="mb-4 flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-boton-acento">
                                <i class="ph-bold ph-identification-card text-lg"></i> Datos de Identidad
                            </h4>
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-y-5 gap-x-4">
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest text-meta">Documento</p>
                                    <p class="mt-1 text-sm font-black text-parrafo">
                                ...
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest text-meta">Nacionalidad</p>
                                    <p class="mt-1 text-sm font-black text-parrafo">{{ $usuarioVista->pais_documento ?? 'Bolivia' }}</p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest text-meta">Género</p>
                                    <p class="mt-1 text-sm font-black text-parrafo">{{ $usuarioVista->genero ?? 'No especificado' }}</p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest text-meta">Nacimiento</p>
                                    <p class="mt-1 text-sm font-black text-parrafo">
                        ...
                        <div class="rounded-[1.5rem] bg-fondo-card/60 border border-borde-suave p-6 shadow-sm">
                            ...
                            <div class="grid grid-cols-2 gap-y-5 gap-x-4">
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest text-meta">Área Asignada</p>
                                    <p class="mt-1 text-sm font-black text-parrafo">{{ $vistaAreaDisplay }}</p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest text-meta">Cargo / Especialidad</p>
                                    <p class="mt-1 text-sm font-black text-parrafo uppercase">{{ $vistaPerfilDetalle }}</p>
                                </div>
                                @if($vistaRoleKey === 'personal_salud' && $usuarioVista->personalSalud?->fecha_ing)
                                    <div>
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Fecha de Ingreso</p>
                                        <p class="mt-1 text-sm font-black text-parrafo">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="rounded-[1.5rem] bg-fondo-card/60 border border-borde-suave p-6 shadow-sm">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Teléfono</p>
                                        <p class="mt-1 text-sm font-black text-parrafo">{{ $usuarioVista->codigo_telefono }} {{ $usuarioVista->telefono ?? 'Sin registrar' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Correo Electrónico</p>
                            ...
                            <div class="rounded-[1.5rem] bg-fondo-card/60 border border-borde-suave p-6 shadow-sm">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Creado en el sistema</p>
                                        <p class="mt-1 text-sm font-black text-parrafo">
                                            {{ $usuarioVista->created_at ? $usuarioVista->created_at->format('d/m/Y H:i') : 'Sin dato' }}
                                        </p>
                                    </div>
                                    <div>
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Última actualización</p>
                                        <p class="mt-1 text-sm font-black text-parrafo">
                        ...
                        @if($usuarioVista->observaciones)
                            <div class="rounded-[1.5rem] bg-fondo-panel border border-borde-focus p-6 shadow-sm">
                                <h4 class="mb-2 flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-boton-acento">
            ...
            <footer class="flex items-center justify-end gap-3 border-t border-borde-suave bg-fondo-panel px-6 py-4 backdrop-blur-xl shrink-0">
                <button type="button" wire:click="cerrarVistaCompleta" class="rounded-full bg-fondo-card/50 px-6 py-2.5 text-xs font-black text-parrafo transition hover:bg-fondo-card active:scale-95 shadow-sm">
                    Cerrar
                </button>
                @if($usuarioVista->estado === 'ACTIVO')
                    <button type="button" wire:click="editarUsuario('{{ $usuarioVista->cod_usu }}')" class="flex items-center gap-2 rounded-full bg-boton-acento px-6 py-2.5 text-xs font-black text-inverso transition hover:bg-fondo-panel active:scale-95 shadow-lg">
        ...
        <aside class="relative z-10 flex h-screen w-full flex-col overflow-hidden border-l border-borde-suave bg-fondo-app shadow-[0_0_60px_rgba(0,0,0,0.3)] sm:max-w-xl lg:max-w-2xl"
            ...
            <header class="flex shrink-0 items-center justify-between border-b border-borde-suave bg-fondo-panel px-6 py-4 backdrop-blur-xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-base font-black text-parrafo">Ficha <span class="text-boton-acento">Rápida</span></h2>
                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Resumen institucional</p>
                    </div>
                </div>
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar px-6 py-6 space-y-5">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="mt-4 text-xl font-black uppercase text-parrafo leading-tight">{{ $fichaNombreCompleto }}</h3>
                    <p class="mt-1 text-sm font-semibold lowercase text-parrafo/55">{{ $usuarioFicha->correo ?: 'Sin correo' }}</p>

                    <div class="mt-3 flex flex-wrap justify-center gap-2">
                        <span class="rounded-full {{ $usuarioFicha->estado === 'ACTIVO' ? 'bg-estado-exitoBg text-estado-exito' : 'bg-fondo-panel text-meta' }} px-3 py-1 text-[10px] font-black uppercase">
                            {{ $usuarioFicha->estado }}
                        </span>
                        <span class="rounded-full bg-fondo-panel px-3 py-1 text-[10px] font-black uppercase text-parrafo">
                            {{ match($fichaRoleKey) {
                                'personal_admin' => 'PERSONAL ADMINISTRATIVO',
                                'personal_salud' => 'PERSONAL DE SALUD',
                                'voluntario' => 'VOLUNTARIO',
                ...
                <div class="space-y-3">
                    <div class="rounded-2xl border border-borde-suave bg-fondo-card/45 p-4 space-y-3">
                        <h4 class="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-boton-acento">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <p class="text-xs font-black text-parrafo">{{ $fichaAreaDisplay }}</p>
                            </div>
                            <div>
                                <p class="text-[8px] font-black uppercase tracking-wider text-parrafo/35">Perfil</p>
                                <p class="text-xs font-black text-parrafo uppercase">{{ $fichaPerfilDetalle }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border border-borde-suave bg-fondo-card/45 p-4 space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <p class="text-xs font-black text-parrafo">{{ $usuarioFicha->codigo_telefono }} {{ $usuarioFicha->telefono ?? 'Sin registrar' }}</p>
                            </div>
                            <div>
                    ...
                    <div class="rounded-2xl border border-borde-suave bg-fondo-card/45 p-4 space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <p class="text-xs font-black text-parrafo">
                            ...
                            <div>
                                ...
                                <p class="text-xs font-black {{ $usuarioFicha->acceso_sistema === 'HABILITADO' ? 'text-estado-exito' : 'text-boton-acento' }}">
            ...
            <footer class="shrink-0 border-t border-borde-suave bg-fondo-panel px-6 py-4 backdrop-blur-xl">
                <div class="flex flex-wrap items-center justify-center gap-2">
                    <button type="button"
                            ...
                            class="inline-flex items-center gap-2 rounded-full bg-boton-principal px-5 py-2.5 text-[10px] font-black text-inverso shadow-lg transition hover:bg-fondo-panel active:scale-95">
                    ...
                    @if($usuarioFicha->estado === 'ACTIVO')
                        <button type="button"
                                ...
                                class="inline-flex items-center gap-2 rounded-full bg-boton-acento px-5 py-2.5 text-[10px] font-black text-inverso shadow-lg transition hover:bg-fondo-panel active:scale-95">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
        <div class="relative w-full max-w-lg rounded-[2rem] border border-borde-suave bg-fondo-app shadow-2xl p-6 md:p-8 space-y-6">
            ...
            <div class="rounded-2xl border border-borde-suave bg-fondo-card/40 p-4 space-y-2">
                <div class="flex items-center gap-2">
                    @if($correoRequisitosEnviado)
                        ...
                        <span class="text-xs font-black uppercase text-estado-exito">Correo de requisitos enviado</span>
                    @else
                        <i class="ph-bold ph-warning text-lg text-boton-acento"></i>
                        <span class="text-xs font-black uppercase text-boton-acento">Advertencia de correo</span>
                    @endif
                </div>
            ...
            <div class="rounded-2xl border border-borde-suave bg-fondo-card/40 p-4 space-y-2">
                <span class="text-[9px] font-black uppercase tracking-widest text-apoyo block">Credenciales de Acceso</span>
            ...
            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 space-y-3">
                <div class="flex justify-between items-center border-b border-borde/25 pb-1">
                    <span class="text-[9px] font-black uppercase tracking-widest text-boton-acento">Requisitos Documentales Obligatorios</span>
            ...
            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 space-y-3 shadow-inner">
                <span class="text-[9px] font-black uppercase tracking-widest text-apoyo block text-center">Gestión de Paquete Documental Institucional</span>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <a href="{{ route('admin.usuarios.documentos.pdf', $usuarioPostRegistro->cod_usu) }}" target="_blank"
                       class="inline-flex h-9 items-center justify-center gap-1.5 rounded-xl bg-fondo-panel text-xs font-black text-parrafo border border-borde-fuerte transition hover:bg-boton-principal hover:text-inverso active:scale-95 shadow-sm">
                        <i class="ph-bold ph-printer"></i> Imprimir
                    </a>
                    ...
                    <button type="button" 
                            ...
                            class="inline-flex h-9 items-center justify-center gap-1.5 rounded-xl bg-estado-peligroBg text-xs font-black text-boton-acento border border-borde-focus transition hover:bg-boton-acento hover:text-inverso active:scale-95 shadow-sm">
                        <i class="ph-bold ph-envelope"></i> Enviar Correo
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 space-y-3 shadow-inner max-h-48 overflow-y-auto custom-scrollbar">
                <span class="text-[9px] font-black uppercase tracking-widest text-apoyo block">Documentos Individuales Generados</span>
                    ...
                    @foreach($docsInstitucionalesPR as $docInst)
                        <div class="flex items-center justify-between p-2 rounded-xl border border-borde-suave bg-fondo-card">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-[10px] font-black text-parrafo uppercase">{{ $docInst['nombre'] }}</span>
                            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-2 pt-2">
                <button type="button"
                        ...
                        class="flex-1 inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-boton-principal px-5 text-xs font-black text-inverso shadow-lg transition hover:bg-boton-acento active:scale-95">
                    <i class="ph-bold ph-eye text-sm"></i>
                    Ver Ficha
                </button>
                <button type="button"
                        wire:click="cerrarPostRegistro"
                        class="flex-1 inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde-suave px-5 text-xs font-black text-parrafo transition hover:bg-fondo-card/80 active:scale-95">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
        <div class="relative w-full max-w-md rounded-[2rem] border border-borde-suave bg-fondo-app shadow-2xl p-6 space-y-5">
            <header class="flex items-center justify-between border-b border-borde-suave pb-3">
                <div>
                    <span class="text-[9px] font-black uppercase tracking-[0.2em] text-boton-acento">Gestión Documental</span>
                    <h3 class="text-base font-black text-parrafo uppercase leading-tight">{{ $tipoDocNombre }}</h3>
                </div>
            ...
            <form wire:submit.prevent="guardarDocumento" class="space-y-4">
                {{-- Archivo Temporal --}}
                <div class="space-y-1">
                    <label class="block text-[9px] font-black uppercase tracking-widest text-apoyo">Archivo (PDF, JPG, JPEG, PNG - Max 10MB) *</label>
                    <div class="relative flex flex-col items-center justify-center border-2 border-dashed border-borde rounded-xl bg-fondo-card/40 p-4 transition hover:bg-fondo-card/60">
                        ...
                        <div class="text-center space-y-1 pointer-events-none">
                            ...
                            <p class="text-xs font-black text-parrafo/80">
                                @if($archivoTemporal)
                    ...
                    @error('archivoTemporal') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                </div>

                {{-- Fechas --}}
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Fecha de Emisión</label>
                        ...
                        @error('fechaEmisionDoc') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Fecha de Vencimiento</label>
                        ...
                        @error('fechaVencimientoDoc') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                    </div>
                </div>

                {{-- Observaciones --}}
                <div>
                    <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Observaciones / Detalles</label>
                    ...
                    @error('observacionesDoc') <span class="mt-1 block text-[9px] font-black text-boton-acento uppercase">{{ $message }}</span> @enderror
                </div>

                {{-- Botones --}}
                <div class="flex items-center gap-2 pt-2">
                    <button type="button" wire:click="cerrarModalSubirDoc" class="flex-1 inline-flex h-10 items-center justify-center rounded-xl bg-fondo-card border border-borde-suave text-xs font-black text-parrafo transition hover:bg-fondo-card/80 active:scale-95">
                        Cancelar
                    </button>
                    <button type="submit" class="flex-1 inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-boton-principal text-xs font-black text-inverso shadow-lg transition hover:bg-estado-exitoBg active:scale-95">
