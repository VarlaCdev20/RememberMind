<div class="space-y-6">
    ...
    <header class="relative overflow-hidden rounded-[2.5rem] border border-borde-suave bg-fondo-panel p-6 md:p-8 shadow-[0_16px_38px_rgba(47,62,92,0.06)] backdrop-blur-xl">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
                ...
                <div>
                    <span class="text-[9px] font-black uppercase tracking-[0.3em] text-boton-acento">
                        Expediente digital
                    </span>
                    ...
                    <div class="mt-3 flex flex-wrap justify-center gap-2 sm:justify-start">
                        <span class="inline-flex items-center gap-1 rounded-full bg-fondo-panel px-3.5 py-1 text-[10px] font-black uppercase text-parrafo">
                            <i class="ph-bold ph-shield-star"></i> {{ $nombre_rol }}
                        </span>
                        <span class="inline-flex items-center gap-1 rounded-full px-3.5 py-1 text-[10px] font-black {{ $usuario->acceso_sistema === 'HABILITADO' ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">
            ...
            <div class="w-full max-w-xs rounded-2xl bg-fondo-card/45 p-4 border border-borde-suave shadow-sm shrink-0 self-center lg:self-auto">
                <div class="flex items-center justify-between text-xs font-black uppercase tracking-wider text-parrafo mb-2">
                ...
                <p class="mt-2 text-[9px] font-black text-parrafo/55 uppercase tracking-wide text-center">
    ...
    <div wire:loading.remove>
        ...
        <div class="grid gap-6 md:grid-cols-3 animate-in fade-in duration-300">
            <div class="md:col-span-2 space-y-6">
                <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm">
                    <h3 class="mb-5 flex items-center gap-2 text-xs font-black uppercase tracking-widest text-boton-acento">
                        <i class="ph-bold ph-identification-card text-lg"></i> Datos de Identidad
                    </h3>
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-meta">Nombres completos</p>
                            <p class="mt-1 font-bold text-parrafo uppercase">{{ $usuario->nombres }}</p>
                        </div>
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-meta">Apellidos</p>
                            <p class="mt-1 font-bold text-parrafo uppercase">{{ $usuario->ap_paterno }} {{ $usuario->ap_materno }}</p>
                        </div>
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-meta">Documento de Identidad</p>
                        ...
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-meta">Nacionalidad / Emisor</p>
                            <p class="mt-1 font-bold text-parrafo">{{ $usuario->pais_documento ?? 'Bolivia' }}</p>
                        </div>
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-meta">Fecha de Nacimiento</p>
                            <p class="mt-1 font-bold text-parrafo">
                                {{ $usuario->fecha_nacimiento ? $usuario->fecha_nacimiento->format('d/m/Y') : 'No registrado' }}
                                @if($usuario->fecha_nacimiento)
                                    <span class="ml-1 text-[9px] font-black bg-estado-peligroBg text-boton-acento px-2 py-0.5 rounded-md uppercase">
                ...
                <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-meta">Número de Celular</p>
                            <p class="mt-1 font-bold text-parrafo">
            ...
            <div class="space-y-6">
                <section class="rounded-[2rem] border border-borde/45 bg-fondo-panel p-6 shadow-sm">
                    <h3 class="mb-4 text-xs font-black uppercase tracking-widest text-apoyo">Metadatos de Registro</h3>
                    <div class="space-y-3.5">
                        ...
                        <div class="flex justify-between items-center text-xs">
                            ...
                            <span class="rounded bg-estado-exitoBg text-estado-exito px-2 py-0.5 text-[9px] font-black uppercase tracking-widest">{{ $usuario->estado }}</span>
                        </div>
                    </div>
                </section>
                ...
                <section class="rounded-[2rem] border border-borde-focus bg-fondo-panel p-6 shadow-sm">
                    <h3 class="mb-2 text-xs font-black uppercase tracking-widest text-boton-acento">Observaciones Generales</h3>
        ...
        <div class="grid gap-6 md:grid-cols-2 animate-in fade-in duration-300">
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm space-y-5">
                <h3 class="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-boton-acento">
                ...
                <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 flex items-start gap-4">
                    ...
                    <div>
                        <p class="text-[9px] font-black uppercase tracking-widest text-parrafo/45">Área Operativa Principal</p>
                        <p class="mt-1 text-base font-black text-parrafo uppercase">{{ $area }}</p>
            ...
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm space-y-5">
                ...
                <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 flex items-start gap-4">
                    ...
                    <div class="min-w-0">
                        <p class="text-[9px] font-black uppercase tracking-widest text-parrafo/45">Cargo de Desempeño</p>
                        
                        @if($usuario->hasRole('personal_salud'))
                            <p class="mt-1 text-base font-black text-parrafo uppercase truncate">{{ $usuario->personalSalud?->especialidad?->nombre ?? 'Sin Especialidad' }}</p>
                        ...
                        @elseif($usuario->hasRole('personal_admin'))
                            <p class="mt-1 text-base font-black text-parrafo uppercase truncate">{{ $usuario->personalAdmin?->cargoAdmin?->nombre ?? ($usuario->personalAdmin?->cargo ?? 'Sin cargo') }}</p>
                            ...
                            @endif
                        @else
                            <p class="mt-1 text-base font-black text-parrafo uppercase">{{ $nombre_rol }}</p>
            ...
            <section class="md:col-span-2 rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm space-y-5">
                ...
                @if($vinculos->isEmpty())
                    <div class="rounded-2xl border border-dashed border-borde bg-fondo-card/40 p-10 text-center">
                        ...
                        <h4 class="mt-4 text-sm font-black text-parrafo">Sin vinculaciones activas</h4>
                                ...
                                @foreach($vinculos as $v)
                                    <tr class="hover:bg-fondo-panel">
                                        ...
                                        <td class="px-5 py-4 font-black">
                                            <span class="px-2.5 py-0.5 rounded bg-fondo-panel text-parrafo text-[9px] font-black uppercase">
                                                {{ $v->pivot->parentesco_vinculo ?? 'Familiar' }}
                                            </span>
                                        </td>
                                        <td class="px-5 py-4 text-center">
                                            @if($v->pivot->es_responsable)
                                                <span class="rounded bg-estado-exitoBg text-estado-exito px-2.5 py-0.5 text-[9px] font-black uppercase tracking-wider">SÍ</span>
                                            @else
                                                <span class="rounded bg-fondo-panel text-apoyo px-2.5 py-0.5 text-[9px] font-black uppercase tracking-wider">NO</span>
                                            @endif
                                        </td>
            ...
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <span class="rounded bg-estado-exitoBg text-estado-exito px-3 py-1 text-[10px] font-black uppercase tracking-wider">
                            Obligatorios: {{ $avance_documental['total_requeridos'] }}
                        </span>
                        <span class="rounded bg-fondo-panel border border-borde-suave text-parrafo px-3 py-1 text-[10px] font-black uppercase tracking-wider">
                        ...
                        <a href="{{ route('admin.usuarios.documentacion.pdf', $usuario) }}" target="_blank"
                           class="inline-flex items-center gap-1.5 rounded-xl bg-boton-principal text-inverso px-3.5 py-1.5 text-[10px] font-black uppercase tracking-wider transition hover:bg-boton-acento active:scale-95 shadow-sm">
                                        ...
                                        <div class="flex items-center justify-center gap-1.5 flex-wrap">
                                            @if(!$item['cargado'])
                                                ...
                                                <button type="button"
                                                        ...
                                                        class="inline-flex items-center gap-1 rounded-full bg-boton-acento px-3.5 py-1.5 text-[9px] font-black uppercase tracking-wider text-inverso shadow-sm hover:shadow active:scale-95">
                                            ...
                                            @else
                                                ...
                                                @if(in_array($item['estado'], ['OBSERVADO', 'VENCIDO']))
                                                    ...
                                                    <button type="button"
                                                            wire:click="abrirSubida('{{ $item['cod_tipo_doc'] }}')"
                                                            class="inline-flex items-center gap-1 rounded-full bg-boton-acento px-3.5 py-1.5 text-[9px] font-black uppercase tracking-wider text-inverso shadow-sm hover:bg-fondo-panel active:scale-95"
                                                ...
                                                @if($item['estado'] === 'CARGADO')
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            class="inline-flex items-center gap-1 rounded-full bg-estado-exitoBg px-3.5 py-1.5 text-[9px] font-black uppercase tracking-wider text-inverso shadow-sm hover:bg-fondo-panel active:scale-95"
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            class="inline-flex items-center gap-1 rounded-full bg-fondo-app border border-borde/65 px-3.5 py-1.5 text-[9px] font-black uppercase tracking-wider text-parrafo shadow-sm hover:bg-boton-acento hover:text-inverso active:scale-95"
        ...
        <div class="space-y-6 animate-in fade-in duration-300">
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm">
                ...
                @if($horarios)
                    <div class="rounded-2xl border border-borde/45 bg-fondo-panel p-5 grid gap-6 md:grid-cols-3">
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-parrafo/45">Turno Asignado</p>
                            <p class="mt-1 text-base font-black text-parrafo uppercase">{{ $horarios->turno?->nombre }}</p>
                            <p class="mt-1 text-[10px] font-bold text-parrafo/45">
                                Horario: {{ substr($horarios->turno?->hora_inicio, 0, 5) }} a {{ substr($horarios->turno?->hora_fin, 0, 5) }}
                            </p>
                        </div>
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-parrafo/45">Sector / Área</p>
                            <p class="mt-1 text-base font-black text-parrafo uppercase">{{ $horarios->area?->nombre }}</p>
                        </div>
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-parrafo/45">Días Laborales</p>
                ...
                @else
                    <div class="rounded-2xl border border-dashed border-borde bg-fondo-card/40 p-10 text-center">
                        ...
                        <h4 class="mt-4 text-sm font-black text-parrafo">Sin asignación horaria activa</h4>
                        <p class="mt-1 text-xs font-bold text-parrafo/45">
            ...
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm">
                <h3 class="mb-5 flex items-center gap-2 text-xs font-black uppercase tracking-widest text-apoyo">
        ...
        <div class="grid gap-6 md:grid-cols-3 animate-in fade-in duration-300">
                    ...
                    <div class="grid gap-4 sm:grid-cols-1">
                        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 text-center flex flex-col justify-between max-w-md mx-auto w-full">
                            <div>
                                ...
                                <h4 class="mt-3 text-sm font-black text-parrafo uppercase">Bloqueo de Cuenta</h4>
                            ...
                            @if($usuario->cod_usu !== auth()->id())
                                <button type="button"
                                        ...
                                        class="mt-4 inline-flex items-center justify-center gap-2 rounded-xl px-5 py-2.5 text-[10px] font-black uppercase text-inverso shadow-md transition hover:-translate-y-0.5 active:translate-y-0
            ...
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-panel p-6 shadow-sm space-y-4">
                <h3 class="text-xs font-black uppercase tracking-widest text-apoyo">Recomendaciones de Seguridad</h3>
        ...
        <div class="space-y-6 animate-in fade-in duration-300">
            ...
            <section class="rounded-[1.5rem] border border-borde/45 bg-fondo-card/70 p-4 shadow-sm">
                <div class="grid items-end gap-3 sm:grid-cols-4">
                    <div>
                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-meta">Acción</label>
                    ...
                    <div>
                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-meta">Desde</label>
                        <input type="date"
                               wire:model.live="filtroFechaDesde"
                               class="h-9 w-full rounded-xl border border-borde/65 bg-fondo-panel px-3 text-xs font-bold text-parrafo">
                    </div>
                    <div>
                        <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-meta">Hasta</label>
                        <input type="date"
                    ...
                    <div class="flex gap-2">
                        <button type="button"
                                ...
                                class="h-9 flex-1 rounded-xl bg-fondo-panel text-parrafo text-[10px] font-black uppercase tracking-wider transition hover:bg-boton-acento hover:text-inverso active:scale-95 shadow-sm">
                            Restablecer
                        </button>
                    </div>
                </div>
            ...
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm space-y-6">
                <h3 class="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-apoyo">
        ...
        <div class="grid gap-6 md:grid-cols-2 animate-in fade-in duration-300">
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm flex flex-col justify-between h-56">
                ...
                <a href="{{ route('admin.usuarios.ficha.pdf', $usuario) }}" target="_blank"
                   class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-principal py-3 text-xs font-black uppercase text-inverso shadow-md shadow-[#2F3E5C]/15 transition hover:-translate-y-0.5 active:translate-y-0 text-center">
            ...
            <section class="rounded-[2rem] border border-borde/45 bg-fondo-card/70 p-6 shadow-sm flex flex-col justify-between h-56">
                ...
                <button type="button"
                        ...
                        class="inline-flex items-center justify-center gap-2 rounded-xl bg-estado-exitoBg py-3 text-xs font-black uppercase text-inverso shadow-md shadow-[#8DA280]/15 transition hover:-translate-y-0.5 active:translate-y-0">
    ...
    <div class="fixed inset-0 z-[2147483640] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm px-4">
        <div class="relative w-full max-w-lg rounded-[2rem] border border-borde-suave bg-fondo-app p-6 shadow-[0_20px_50px_rgba(0,0,0,0.4)] animate-in zoom-in duration-300">
            <header class="flex items-center justify-between border-b border-borde-suave pb-3 mb-4">
                <h4 class="text-sm font-black uppercase text-parrafo tracking-wide">Cargar Credencial</h4>
            ...
            <form wire:submit.prevent="subirArchivo" class="space-y-4">
                <div>
                    <label class="block text-[10px] font-black uppercase tracking-widest text-apoyo mb-1">Tipo de Requisito</label>
                    <p class="text-xs font-black text-parrafo uppercase">{{ $selectedTipoDoc->nombre }}</p>
                </div>

                <div>
                    <label class="block text-[10px] font-black uppercase tracking-widest text-apoyo mb-1">Seleccionar Archivo (PDF, JPG, PNG) *</label>
                    <input type="file"
                    ...
                    @error('archivoSubida') <span class="text-[9px] font-black text-boton-acento uppercase mt-1 block">{{ $message }}</span> @enderror
                </div>

                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-[10px] font-black uppercase tracking-widest text-apoyo mb-1">Fecha de Emisión</label>
                        <input type="date"
                        ...
                        @error('fechaEmision') <span class="text-[9px] font-black text-boton-acento uppercase mt-1 block">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block text-[10px] font-black uppercase tracking-widest text-apoyo mb-1">Vencimiento</label>
                        <input type="date"
                               wire:model="fechaVencimiento"
                               class="w-full h-10 rounded-xl border border-borde bg-fondo-card px-3 text-xs font-bold text-parrafo"
                               {{ $selectedTipoDoc->requiere_vencimiento ? 'required' : '' }}>
                        @error('fechaVencimiento') <span class="text-[9px] font-black text-boton-acento uppercase mt-1 block">{{ $message }}</span> @enderror
                    </div>
                </div>

                <div>
                    <label class="block text-[10px] font-black uppercase tracking-widest text-apoyo mb-1">Observaciones</label>
                ...
                <div class="border-t border-borde-suave pt-4 flex items-center justify-end gap-2">
                    <button type="button"
                            ...
                            class="rounded-xl border border-borde bg-fondo-card px-4 py-2 text-[10px] font-black uppercase text-parrafo transition hover:bg-red-500 hover:text-inverso">
                        Cancelar
                    </button>
                    <button type="submit"
                            class="rounded-xl bg-boton-principal px-6 py-2.5 text-[10px] font-black uppercase text-inverso shadow-md shadow-[#2F3E5C]/15 transition hover:bg-boton-acento">
    ...
    <div class="fixed inset-0 z-[2147483640] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm px-4">
        <div class="relative w-full max-w-md rounded-[2rem] border border-borde-suave bg-fondo-app p-6 shadow-[0_20px_50px_rgba(0,0,0,0.4)] animate-in zoom-in duration-300">
            <header class="flex items-center justify-between border-b border-borde-suave pb-3 mb-4">
                <h4 class="text-sm font-black uppercase text-parrafo tracking-wide">Observar Credencial</h4>
            ...
            <form wire:submit.prevent="observarDoc" class="space-y-4">
                <div>
                    <label class="block text-[10px] font-black uppercase tracking-widest text-apoyo mb-1">Motivo de la Observación / Rechazo *</label>
                    <textarea wire:model="motivoRechazo"
                              rows="4"
                              class="w-full rounded-xl border border-borde bg-fondo-card p-3 text-xs font-bold text-parrafo outline-none"
                              placeholder="Ej. El archivo no es legible o le falta firma..."></textarea>
                    @error('motivoRechazo') <span class="text-[9px] font-black text-boton-acento uppercase mt-1 block">{{ $message }}</span> @enderror
                </div>

                <div class="border-t border-borde-suave pt-4 flex items-center justify-end gap-2">
                    <button type="button"
                            wire:click="$set('mostrarObservacionModal', false)"
                            class="rounded-xl border border-borde bg-fondo-card px-4 py-2 text-[10px] font-black uppercase text-parrafo">
                        Cancelar
                    </button>
                    <button type="submit"
                            class="rounded-xl bg-boton-acento px-6 py-2.5 text-[10px] font-black uppercase text-inverso shadow-md transition hover:bg-boton-principal">
                        Rechazar Requisito
                    </button>
                </div>
            </form>
    ...
    <div class="fixed inset-0 z-[2147483640] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm px-4">
        <div class="relative w-full max-w-md rounded-[2rem] border border-borde-suave bg-fondo-app p-6 shadow-[0_20px_50px_rgba(0,0,0,0.4)] animate-in zoom-in duration-300">
            <header class="flex items-center justify-between border-b border-borde-suave pb-3 mb-4">
                <h4 class="text-sm font-black uppercase text-parrafo tracking-wide">Anular Credencial</h4>
            ...
            <form wire:submit.prevent="anularDoc" class="space-y-4">
                ...
                <div>
                    <label class="block text-[10px] font-black uppercase tracking-widest text-apoyo mb-1">Motivo de Anulación *</label>
                    <textarea wire:model="motivoRechazo"
                              rows="4"
                              class="w-full rounded-xl border border-borde bg-fondo-card p-3 text-xs font-bold text-parrafo outline-none"
                ...
                <div class="border-t border-borde-suave pt-4 flex items-center justify-end gap-2">
                    ...
                    <button type="submit"
                            class="rounded-xl bg-red-700 px-6 py-2.5 text-[10px] font-black uppercase text-inverso shadow-md transition hover:bg-boton-principal">
                        Confirmar Anulación
                    </button>
                </div>
            </form>
