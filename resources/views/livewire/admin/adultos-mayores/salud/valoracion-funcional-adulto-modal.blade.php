<div>
    ...
    <div class="rounded-[24px] border border-borde bg-fondo-panel p-5 shadow-sm">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h3 class="text-xl font-black text-titulo">Valoración Funcional</h3>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm md:col-span-2">
                    <div class="grid gap-4 md:grid-cols-2 items-center">
                        <div>
                            <label class="mb-1 block text-[11px] font-black uppercase tracking-widest text-apoyo">Fecha de Valoración *</label>
                        ...
                        <div class="text-right">
                            <span class="block text-[11px] font-black uppercase tracking-widest text-apoyo">Nivel de Dependencia Calculado</span>
                            <div class="mt-1 inline-flex items-center rounded-xl border border-borde-suave bg-fondo-panel px-4 py-2">
                                <span class="text-lg font-black text-titulo">{{ $nivel_dependencia }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">1. Actividades de la Vida Diaria</h4>
                    <div class="space-y-3">
                ...
                <!-- 2. Movilidad y Apoyo -->
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">2. Movilidad y Apoyos</h4>
                    <div class="space-y-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">3. Comunicación y Sentidos</h4>
                    <div class="space-y-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">4. Cognitivo y Ambiental</h4>
                    <div class="space-y-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <!-- Observaciones -->
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm md:col-span-2">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">5. Observación Adicional</h4>
