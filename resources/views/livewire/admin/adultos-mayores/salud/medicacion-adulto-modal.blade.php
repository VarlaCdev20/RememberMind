<div>
 ...
 <div class="space-y-4">
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Seleccionar Adulto Mayor *</label>
 <div class="relative">
 ...
 <a href="#" @click.prevent="$dispatch('cerrarModal'); $dispatch('cambiarAdulto', { cod_am: '{{ $adultoSeleccionado->cod_am }}' })" class="text-[10px] font-bold uppercase tracking-wider text-boton-acento hover:underline">Ver historial</a>
 </div>
 @endif
 </div>
 </div>
 ...
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Nombre del Medicamento *</label>
 <div class="relative">
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Dosis *</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Vía de Adm. *</label>
 ...
 <div class="md:col-span-2">
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Frecuencia *</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Hora Inicial *</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Fecha Inicio *</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Fecha Fin (Opcional)</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Estado del Tratamiento</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Médico que indica / Prescripción</label>
 <div class="relative">
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Observaciones Propias de la Medicación</label>
 ...
 <button type="submit" form="formMedicacion" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-inverso shadow-[0_8px_16px_rgba(226,125,96,0.2)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95 disabled:opacity-50" wire:loading.attr="disabled">
