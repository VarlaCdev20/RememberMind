<div>
 ...
 <div>
 <h3 class="text-xl font-extrabold text-titulo">Estados Institucionales</h3>
 ...
 <span class="text-[10px] font-bold uppercase bg-fondo-panel px-2 py-1 rounded-lg text-apoyo">
