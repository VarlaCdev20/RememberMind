<div>
    ...
    <div class="rounded-[24px] border border-borde bg-fondo-panel p-5 shadow-sm">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h3 class="text-xl font-black text-titulo">Ficha Médica Base</h3>
            ...
            <div class="mt-4 space-y-3">
                @foreach($fichaList as $ficha)
                    <div class="rounded-xl border border-borde-suave bg-fondo-card p-4 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                        <div>
                            <span class="text-xs font-black uppercase text-apoyo">Ficha registrada el {{ $ficha->created_at->format('d/m/Y') }}</span>
        ...
        <form wire:submit.prevent="guardar" id="formFichaMedica">
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">1. Enfermedades Crónicas</h4>
                    <div class="space-y-3">
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">2. Antecedentes Neurológicos</h4>
                    <div class="space-y-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">3. Estado Emocional / Sueño</h4>
                    <div class="space-y-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <!-- 4. Sensorial y Dolor -->
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">4. Sensorial y Dolor</h4>
                    <div class="space-y-3">
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm md:col-span-2">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">5. Otros Antecedentes</h4>
                    <div class="grid gap-4 md:grid-cols-2">
                        <div>
                            <label class="mb-1 block text-[11px] font-black uppercase tracking-widest text-apoyo">Alergias</label>
                        ...
                        <div>
                            <label class="mb-1 block text-[11px] font-black uppercase tracking-widest text-apoyo">Restricciones Alimentarias</label>
                        ...
                        <div>
                            <label class="mb-1 block text-[11px] font-black uppercase tracking-widest text-apoyo">Hospitalizaciones Previas</label>
                        ...
                        <div>
                            <label class="mb-1 block text-[11px] font-black uppercase tracking-widest text-apoyo">Cirugías Previas</label>
                ...
                <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm md:col-span-2">
                    <h4 class="mb-3 text-sm font-black uppercase text-titulo">6. Observación Médica</h4>
