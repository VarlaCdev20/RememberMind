            ...
            <div class="relative w-full max-w-4xl rounded-[24px] border border-borde-suave bg-fondo-app shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)] flex flex-col max-h-[94vh]">
                ...
                <div class="flex items-center justify-between border-b border-borde-suave p-4 sm:px-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h2 class="text-lg font-black text-titulo">{{ $isEdit ? 'Actualizar Ficha: '.$ci : 'Admisión Nuevo Ingreso' }}</h2>
                        </div>
                    </div>
                ...
                <div class="flex-1 overflow-y-auto p-5 sm:px-8 sm:py-6 custom-scrollbar">
                    ...
                    <div class="space-y-8 animate-fade-in">
                            ...
                            <div class="flex-1 space-y-6 w-full">
                                <div class="grid gap-4 md:grid-cols-2">
                                    <div class="space-y-1.5">
                                        <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Nombres *</label>
                                    ...
                                    <div class="space-y-1.5">
                                        <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Apellido Paterno *</label>
                                    ...
                                    <div class="space-y-1.5">
                                        <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Apellido Materno</label>
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <div class="col-span-2 space-y-1.5">
                                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">C.I. *</label>
                                        ...
                                        <div class="space-y-1.5">
                                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Comp.</label>
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            <div class="space-y-1.5">
                                <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Expedición *</label>
                            ...
                            <div class="space-y-1.5">
                                <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Estado Civil *</label>
                    ...
                    <div class="grid gap-8 md:grid-cols-3 animate-fade-in">
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Fecha Nacimiento *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Edad Estimada</label>
                            @if($this->edad !== null && $this->edad < 60)
                            <div class="flex h-[48px] w-full items-center gap-2 rounded-2xl border-2 border-terracota/30 bg-boton-acento/5 px-5 text-sm font-black text-terracota">
                                <i class="ph-fill ph-warning text-base"></i>
                                {{ $this->edad }} años — menor de 60
                            </div>
                            @else
                            <div class="flex h-[48px] w-full items-center rounded-2xl border-2 border-dashed border-borde-suave bg-fondo-card/30 px-5 text-sm font-black text-titulo/40">
                                {{ $this->edad ? $this->edad . ' años' : '--' }}
                            </div>
                            @endif
                        </div>
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Género *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Grupo Sanguíneo *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Seguro de Salud *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Nivel Educativo *</label>
                        ...
                        <div class="col-span-full space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Alergias Conocidas *</label>
                    ...
                    <div class="grid gap-8 md:grid-cols-2 animate-fade-in">
                        <div class="col-span-full flex items-center gap-4 rounded-[28px] bg-boton-principal/5 p-6 border-2 border-azul-profundo/10 shadow-inner">
                            ...
                            <div>
                                <h4 class="text-sm font-black text-titulo">¿Cuenta con dispositivo móvil personal?</h4>
                        ...
                        @if($tiene_celular)
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Número de Celular *</label>
                        ...
                        <div class="flex items-center gap-3 pt-6">
                            ...
                            <label for="ws_check" class="text-sm font-black text-titulo/70 cursor-pointer">Sabe utilizar WhatsApp activamente</label>
                        </div>
                        @endif

                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Teléfono Fijo / Referencia</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Dpto. Residencia *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Ciudad / Municipio *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Zona / Barrio *</label>
                        ...
                        <div class="space-y-2 md:col-span-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Calle / Avenida / Referencia Visual *</label>
                    ...
                    <div class="grid gap-8 md:grid-cols-2 animate-fade-in">
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Nombre Completo del Responsable *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Parentesco *</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Celular de Contacto *</label>
                        ...
                        <div class="space-y-6 pt-6">
                            <div class="flex items-center gap-3">
                                ...
                                <label for="resp_main" class="text-sm font-black text-titulo/70 cursor-pointer">Es responsable principal (Firma legal)</label>
                            </div>
                            <div class="flex items-center gap-3">
                                ...
                                <label for="aut_med" class="text-sm font-black text-titulo/70 cursor-pointer">Autorizado para recibir informes médicos</label>
                            </div>
                        </div>
                        <div class="col-span-full space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Dirección del Contacto</label>
                    ...
                    <div class="grid gap-8 md:grid-cols-4 animate-fade-in">
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Fecha de Ingreso Institucional *</label>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Hora de Ingreso</label>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Tipo de Ingreso *</label>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Permanencia *</label>
                        ...
                        <div class="col-span-full space-y-2">
                            <label class="text-xs font-black uppercase tracking-widest text-titulo/50">Observaciones de Ingreso</label>
                        ...
                        <div class="rounded-[32px] bg-fondo-card p-8 shadow-inner border-2 border-borde-suave space-y-6">
                            <div class="flex items-center gap-4 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-[10px] font-black uppercase text-titulo/30">Titular del expediente</p>
                                    <h4 class="text-lg font-black text-titulo truncate">{{ $nombres }} {{ $ap_paterno }} {{ $ap_materno }}</h4>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-4 text-left">
                                ...
                                <div>
                                    <p class="text-[10px] font-black uppercase text-titulo/30">Documento Identidad</p>
                                    <h4 class="text-lg font-black text-titulo">{{ $ci }} {{ $complemento_ci }} - {{ $expedicion_ci }}</h4>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 mt-8 pt-6 border-t border-borde-suave">
                                ...
                                <label for="cons_check" class="text-sm font-black text-titulo/70 text-left cursor-pointer">
                ...
                <div class="border-t border-borde-suave p-4 sm:px-8 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-4">
                    <button type="button" wire:click="anterior" wire:loading.attr="disabled" @if($paso == 1) disabled @endif
                            class="flex h-11 items-center justify-center gap-2 rounded-xl bg-fondo-card px-6 text-xs font-black text-titulo shadow-sm transition hover:bg-boton-principal hover:text-inverso disabled:opacity-30 disabled:cursor-not-allowed active:scale-95">
                        <i class="ph-bold ph-arrow-left"></i> Anterior
                    </button>

                    <div class="flex gap-3">
                        <button type="button" wire:click="cerrar" wire:loading.attr="disabled" class="h-11 items-center justify-center rounded-xl bg-fondo-app px-5 text-xs font-black text-titulo transition hover:bg-boton-acento hover:text-inverso active:scale-95 disabled:opacity-30 disabled:cursor-not-allowed hidden sm:flex">
                            Cancelar
                        </button>
                        ...
                        @if($paso < $totalPasos)
                            ...
                            <button type="button" wire:click="siguiente" wire:loading.attr="disabled" wire:target="siguiente"
                                    ...
                                    class="flex h-11 items-center justify-center gap-2 rounded-xl bg-boton-principal px-8 text-xs font-black text-inverso shadow-[0_12px_24px_-8px_rgba(47,62,92,0.4)] transition hover:-translate-y-1 hover:bg-fondo-panel active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed">
                        ...
                        @else
                            <button type="button" wire:click="guardar" wire:loading.attr="disabled" wire:target="guardar"
                                    class="flex h-11 items-center justify-center gap-2 rounded-xl bg-boton-acento px-8 text-xs font-black text-inverso shadow-[0_12px_24px_-8px_rgba(226,125,96,0.4)] transition hover:-translate-y-1 hover:bg-fondo-panel active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed">
