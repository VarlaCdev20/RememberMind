            ...
            <div class="relative w-full max-w-2xl rounded-[24px] border border-borde-suave bg-fondo-app shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)] flex flex-col max-h-[90vh]">
                ...
                <div class="flex items-center justify-between border-b border-borde-suave p-4 sm:px-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h2 class="text-lg font-black text-titulo">Registrar Evaluación Geriátrica Integral</h2>
                        </div>
                    </div>
                ...
                <form wire:submit.prevent="guardar" class="flex-1 overflow-y-auto p-6 sm:px-8 space-y-5 custom-scrollbar">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {{-- Área --}}
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Área de Evaluación</label>
                        ...
                        {{-- Instrumento --}}
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Instrumento / Escala</label>
                    ...
                    @if($instrumentoSeleccionado)
                        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 space-y-2 text-xs font-semibold text-titulo/80">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="rounded-lg bg-boton-acento/10 px-2 py-0.5 text-[10px] font-black text-terracota uppercase tracking-widest">{{ $instrumentoSeleccionado->tipo_resultado }}</span>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-4 pt-2 border-t border-borde-suave">
                                @if($instrumentoSeleccionado->puntaje_maximo)
                                    <div>
                                        <span class="text-[10px] font-black uppercase text-titulo/50">Puntaje Máximo:</span>
                                ...
                                @if($instrumentoSeleccionado->punto_corte_normal)
                                    <div>
                                        <span class="text-[10px] font-black uppercase text-titulo/50">Punto de Corte Normal:</span>
                                ...
                                @if($instrumentoSeleccionado->punto_corte_riesgo)
                                    <div>
                                        <span class="text-[10px] font-black uppercase text-titulo/50">Punto de Corte Riesgo:</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {{-- Fecha --}}
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Fecha de Evaluación</label>
                        ...
                        {{-- Hora --}}
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Hora (Opcional)</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">
                        ...
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Categoría / Resultado Clínico</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {{-- Nivel de Alerta --}}
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Nivel de Alerta</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Nivel de Riesgo (Opcional)</label>
                    ...
                    {{-- Observaciones --}}
                    <div>
                        <label class="block text-[10px] font-black uppercase tracking-wider text-titulo/60 mb-1.5">Observaciones Adicionales</label>
                ...
                <div class="flex items-center justify-end gap-3 border-t border-borde-suave p-4 sm:px-8 bg-fondo-panel">
                    <button type="button" wire:click="cerrar" class="rounded-xl bg-fondo-card/80 px-5 py-2.5 text-xs font-black uppercase tracking-wider text-titulo transition hover:bg-fondo-card active:scale-95 shadow-sm border border-borde-suave">
                        Cancelar
                    </button>
                    <button type="button" wire:click="guardar" class="rounded-xl bg-boton-principal px-6 py-2.5 text-xs font-black uppercase tracking-wider text-inverso transition hover:bg-fondo-panel active:scale-95 shadow-md flex items-center gap-2">
