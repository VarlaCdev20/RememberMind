<div class="relative mx-auto max-w-7xl space-y-5">
    ...
    <section class="rounded-2xl border border-borde-suave bg-fondo-panel p-6 shadow-[0_18px_45px_rgba(47,62,92,0.1)] backdrop-blur-xl relative overflow-hidden">
        ...
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between relative z-10">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-panel border border-borde-suave px-4 py-2.5 text-xs font-black text-titulo transition hover:bg-fondo-panel active:scale-95">
                    <i class="ph-bold ph-arrow-left text-sm"></i> Panel de Inicio
                </a>

                <button type="button" wire:click="crearAdultoMayor" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-4 py-2.5 text-xs font-black text-inverso shadow-[0_8px_20px_rgba(233,122,95,0.22)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
                    <i class="ph-bold ph-plus-circle text-sm"></i> Registrar adulto mayor
                </button>

                <a href="{{ route('admin.adultos-mayores.reporte-general') }}" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-principal px-4 py-2.5 text-xs font-black text-inverso shadow-[0_8px_20px_rgba(47,62,92,0.12)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
    ...
    <section class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm relative overflow-hidden transition hover:shadow-md">
            ...
            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo leading-none">Total registrados</p>
        ...
        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm relative overflow-hidden transition hover:shadow-md">
            ...
            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo leading-none">Activos</p>
        ...
        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm relative overflow-hidden transition hover:shadow-md">
            ...
            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo leading-none">En seguimiento</p>
        ...
        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm relative overflow-hidden transition hover:shadow-md">
            ...
            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo leading-none">Archivados</p>
        ...
        <div class="rounded-2xl border border-borde-suave bg-estado-peligroBg p-4 shadow-sm relative overflow-hidden transition hover:shadow-md">
            ...
            <p class="text-[9px] font-black uppercase tracking-widest text-boton-acento leading-none">Sin eval. cognitiva</p>
        ...
        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm relative overflow-hidden transition hover:shadow-md">
            ...
            <p class="text-[9px] font-black uppercase tracking-widest text-apoyo leading-none">Docs pendientes</p>
    ...
    <div x-data="{ tab: 'tarjetas' }" class="space-y-4">
        ...
        <nav class="flex space-x-2 rounded-2xl border border-borde-suave bg-fondo-panel p-2 shadow-sm overflow-x-auto">
            <button @click="tab = 'tarjetas'" :class="tab === 'tarjetas' ? 'bg-boton-principal text-inverso shadow-sm' : 'text-titulo hover:bg-fondo-app'" class="rounded-xl px-4 py-2.5 text-xs font-black transition whitespace-nowrap">
                <i class="ph-bold ph-cards mr-1 text-sm"></i> Vista Tarjetas
            </button>
            <button @click="tab = 'tabla'" :class="tab === 'tabla' ? 'bg-boton-principal text-inverso shadow-sm' : 'text-titulo hover:bg-fondo-app'" class="rounded-xl px-4 py-2.5 text-xs font-black transition whitespace-nowrap">
                <i class="ph-bold ph-table mr-1 text-sm"></i> Tabla General
            </button>
            <button @click="tab = 'archivados'" :class="tab === 'archivados' ? 'bg-boton-principal text-inverso shadow-sm' : 'text-titulo hover:bg-fondo-app'" class="rounded-xl px-4 py-2.5 text-xs font-black transition whitespace-nowrap">
                <i class="ph-bold ph-archive mr-1 text-sm"></i> Expedientes Archivados
            </button>
            <button @click="tab = 'alertas'" :class="tab === 'alertas' ? 'bg-boton-principal text-inverso shadow-sm' : 'text-titulo hover:bg-fondo-app'" class="rounded-xl px-4 py-2.5 text-xs font-black transition whitespace-nowrap">
        ...
        <section class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 shadow-sm" x-show="tab !== 'alertas'">
            <div class="grid gap-3 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-9 items-end">
                <div class="sm:col-span-2 md:col-span-2 xl:col-span-2">
                    <label class="mb-1 block text-[10px] font-black uppercase tracking-widest text-apoyo">Buscar</label>
                ...
                <div>
                    <label class="mb-1 block text-[10px] font-black uppercase tracking-widest text-apoyo">Estado</label>
                ...
                <div>
                    <label class="mb-1 block text-[10px] font-black uppercase tracking-widest text-apoyo">Ciudad/Muni.</label>
                ...
                <div>
                    <label class="mb-1 block text-[10px] font-black uppercase tracking-widest text-apoyo">Rango de Edad</label>
                ...
                <div>
                    <label class="mb-1 block text-[10px] font-black uppercase tracking-widest text-apoyo">Género</label>
                ...
                <div>
                    <label class="mb-1 block text-[10px] font-black uppercase tracking-widest text-apoyo">Permanencia</label>
                ...
                <div>
                    <label class="mb-1 block text-[10px] font-black uppercase tracking-widest text-apoyo">Desde (Ingreso)</label>
                ...
                <div class="flex gap-2">
                    <button type="button" wire:click="$refresh" class="w-full rounded-xl bg-boton-principal px-3 py-2.5 text-xs font-black text-inverso hover:bg-fondo-panel transition" title="Refrescar">
                        <i class="ph-bold ph-arrows-counter-clockwise text-sm"></i>
                    </button>
                    <button type="button" wire:click="$set('buscar', ''); $set('estado', ''); $set('genero', ''); $set('permanencia', ''); $set('ciudad_municipio', ''); $set('rango_edad', ''); $set('fecha_desde', ''); $set('fecha_hasta', '');" class="flex w-full items-center justify-center rounded-xl bg-fondo-app px-3 py-2.5 text-xs font-black text-titulo hover:bg-fondo-panel transition" title="Limpiar Filtros">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    @if(!$esArchivado)
                        ...
                        <div class="rounded-2xl border {{ $colorBg }} p-0 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex flex-col justify-between overflow-hidden relative">
                            ...
                            <div class="p-5 flex flex-col items-center border-b border-borde-suave bg-gradient-to-b from-[#E6DDD3]/10 to-transparent">
                                ...
                                <span class="absolute top-4 left-4 text-[9px] font-black uppercase tracking-widest text-apoyo bg-fondo-panel px-2 py-1 rounded-md border border-borde-suave shadow-sm"><i class="ph-bold ph-hash mr-0.5"></i>{{ $adulto->cod_am }}</span>
                                ...
                                <h3 class="text-base font-black text-titulo text-center leading-tight">
                                    {{ $adulto->nombres }}<br>
                            ...
                            <div class="p-4 px-5 space-y-2.5">
                                ...
                                <div class="flex justify-between items-start text-xs border-b border-borde-suave pb-2">
                                    ...
                                    <span class="font-black text-titulo text-right truncate max-w-[120px]">
                                        ...
                                        @else
                                            <span class="text-boton-acento uppercase text-[9px] font-black"><i class="ph-bold ph-warning mr-0.5"></i>Sin registrar</span>
                                        @endif
                                    </span>
                                </div>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <div x-data="{ open: false }" class="relative">
                                        ...
                                        <div x-cloak x-show="open" class="absolute bottom-full mb-2 right-0 bg-fondo-card rounded-xl shadow-lg border border-borde-suave p-1.5 min-w-[130px] z-50">
                                            <p class="text-[9px] font-black uppercase text-apoyo px-2 py-1 border-b border-borde-suave mb-1">Cambiar Estado:</p>
                                            @foreach($estadosAdulto as $est)
                ...
                @if(!$hayTarjetasActivas)
                    <div class="col-span-full rounded-2xl border border-borde-suave bg-fondo-panel p-5 text-center">
                        ...
                        <p class="text-sm font-black text-apoyo">No se encontraron adultos mayores activos con los filtros aplicados.</p>
                    </div>
                @endif
            </div>
        </section>
                    ...
                    <tbody class="divide-y divide-[#C7B5A3]/25">
                        @foreach($adultos as $adulto)
                            ...
                            <tr class="hover:bg-fondo-panel transition">
                                <td class="px-5 py-3.5 font-black text-xs text-boton-acento">{{ $adulto->cod_am }}</td>
                                ...
                                <td class="px-5 py-3.5">
                                    <span class="rounded-lg px-2 py-0.5 text-[9px] font-black uppercase {{ strtoupper($adulto->estado_adulto) === 'ACTIVO' ? 'bg-estado-exitoBg text-parrafo' : 'bg-estado-peligroBg text-boton-acento' }}">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 shadow-sm flex flex-col justify-between transition hover:shadow-md">
                            <div>
                                <div class="mb-3 flex items-center justify-between">
                                    <span class="rounded-lg bg-fondo-panel px-2.5 py-1 text-[9px] font-black uppercase text-parrafo tracking-wider border border-borde shadow-sm">{{ $adulto->estado_adulto }}</span>
                                    <span class="text-[10px] font-black text-apoyo"><i class="ph-bold ph-hash mr-0.5"></i>{{ $adulto->cod_am }}</span>
                                </div>
                                <h3 class="text-base font-black text-apoyo leading-tight">{{ $adulto->nombres }} {{ $adulto->ap_paterno }}</h3>
                                ...
                                <div class="mt-4 space-y-2 border-t border-borde-suave pt-3 text-xs">
                                    ...
                                    <div class="flex flex-col mt-2 gap-1 bg-fondo-card/40 p-2 rounded-xl border border-borde-suave"><span class="text-apoyo text-[10px] font-black uppercase leading-none">Motivo:</span><span class="font-semibold text-[11px] text-apoyo mt-1">{{ $adulto->motivo_archivado ?: 'Archivado administrativamente.' }}</span></div>
                                </div>
                            </div>
                ...
                @if(!$hayArchivados)
                    <div class="col-span-full rounded-2xl border border-borde-suave bg-fondo-panel p-5 text-center">
                        ...
                        <p class="text-sm font-black text-apoyo">No existen expedientes archivados en este censo.</p>
                    </div>
                @endif
            </div>
        </section>
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div class="rounded-2xl border border-borde-focus bg-fondo-card p-5 shadow-sm flex flex-col justify-between transition hover:-translate-y-0.5 hover:shadow-md relative overflow-hidden">
                            ...
                            <div>
                                <div class="flex justify-between items-start mb-3">
                                    <div>
                                        <span class="text-[9px] font-black text-boton-acento bg-estado-peligroBg px-2 py-0.5 rounded-full border border-borde-focus tracking-widest uppercase">{{ $adulto->cod_am }}</span>
                                        <h3 class="text-base font-black text-titulo leading-tight mt-1">{{ $adulto->nombres }} {{ $adulto->ap_paterno }}</h3>
                                    </div>
                            ...
                            <a href="{{ route('admin.adultos-mayores.show', $adulto->cod_am) }}" class="mt-5 flex justify-center items-center rounded-xl bg-boton-principal py-2 text-inverso hover:bg-fondo-panel transition text-xs font-black w-full shadow-sm">
                ...
                @if(!$hayAlertas)
                    <div class="col-span-full rounded-2xl border border-borde-suave bg-fondo-card p-5 text-center flex flex-col items-center">
                        ...
                        <h3 class="text-lg font-black text-titulo">Expedientes Completos</h3>
