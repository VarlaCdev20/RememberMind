<div class="space-y-6 pb-8">
            ...
            <table class="w-full text-left text-xs whitespace-nowrap">
                ...
                <tbody class="divide-y divide-borde/40">
                    ...
                    @php
                        ...
                        $lvlPA   = \App\Livewire\Admin\Medico\SignosVitalesPanel::alertaPA($sist, $diast);
                        $lvlFC   = \App\Livewire\Admin\Medico\SignosVitalesPanel::alertaFC($fc);
                        $lvlFR   = \App\Livewire\Admin\Medico\SignosVitalesPanel::alertaFR($fr);
                        $lvlTemp = \App\Livewire\Admin\Medico\SignosVitalesPanel::alertaTemp($temp);
                        $lvlSat  = \App\Livewire\Admin\Medico\SignosVitalesPanel::alertaSat($sat);
                        $lvlGluc = \App\Livewire\Admin\Medico\SignosVitalesPanel::alertaGluc($gluc);
                        $lvlGlobal = $sv ? \App\Livewire\Admin\Medico\SignosVitalesPanel::nivelGlobal($sist, $diast, $fc, $fr, $temp, $sat, $gluc) : 'sin_dato';
    ...
    Alpine.data('signosVitalesCharts', () => ({
        ...
        initTendencia() {
            const data = @js($chartTendencia7d);
