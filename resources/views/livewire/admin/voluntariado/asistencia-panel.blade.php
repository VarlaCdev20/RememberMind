...
>
 ...
 <a href="{{ $linksCabecera['asignaciones'] }}" class="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-borde-suave bg-fondo-panel px-4 text-[11px] font-bold uppercase tracking-wider text-titulo shadow-sm transition hover:border-borde-focus hover:text-boton-acento active:scale-95">
 ...
 <label class="block">
 <span class="mb-1 block text-[9px] font-bold uppercase tracking-widest text-apoyo">Buscar voluntario</span>
 ...
 <div>
 <span class="text-[10px] font-bold uppercase tracking-[0.18em] text-boton-acento">Asignaciones pendientes</span>
 <h2 class="mt-0.5 text-base font-extrabold text-titulo">Pendientes de asistencia</h2>
 </div>
 ...
 <div class="flex items-start justify-between gap-2">
 <div class="min-w-0">
 <p class="truncate text-xs font-bold text-titulo">{{ $pendiente->voluntario_nombre ?: 'Voluntario' }}</p>
 ...
 <button type="button" wire:click="abrirCrearDesdeAsignacion({{ $pendiente->cod_asig_vol }})" class="inline-flex h-8 items-center justify-center gap-1.5 rounded-xl bg-boton-principal px-3 text-[9px] font-bold uppercase tracking-wider text-inverso transition hover:bg-boton-acento">
 ...
 <h3 class="mt-3 text-sm font-bold text-titulo">No existen asignaciones pendientes de asistencia.</h3>
 ...
 <div class="mb-3 flex items-center justify-between gap-3">
 <div>
 <span class="text-[10px] font-bold uppercase tracking-[0.18em] text-boton-acento">Detalle</span>
 <h2 class="mt-0.5 text-base font-extrabold text-titulo">Asistencia seleccionada</h2>
 </div>
 ...
 <p class="mt-1 text-sm font-bold text-titulo">{{ $detalleAsistencia->voluntario_nombre ?: 'Voluntario' }}</p>
 ...
 <p class="mt-1 text-xs font-bold text-titulo">{{ $detalleAsistencia->tiempo_colaborado }}</p>
 ...
 <div class="flex flex-wrap gap-2">
 <span class="rounded-full border px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider {{ $detalleClase }}">{{ $detalleAsistencia->estado_normalizado }}</span>
 <span class="rounded-full bg-fondo-panel px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider text-titulo">{{ $detalleAsistencia->fecha_texto }}</span>
 <span class="rounded-full bg-estado-advertenciaBg px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider text-estado-advertencia">{{ $detalleAsistencia->turno }}</span>
 </div>

 @if($detalleAsistencia->actividad_realizada || $detalleAsistencia->observaciones)
 <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-3">
 <p class="text-[10px] font-bold uppercase tracking-widest text-apoyo">Registro</p>
 ...
 <h3 class="mt-3 text-sm font-bold text-titulo">Selecciona una asistencia.</h3>
 ...
 <h2 class="mt-0.5 text-base font-extrabold text-titulo">Asistencias registradas</h2>
 </div>
 ...
 <th class="px-3 py-3 text-[10px] font-bold uppercase tracking-widest text-apoyo">Asignación / apoyo</th>
 <th class="px-3 py-3 text-[10px] font-bold uppercase tracking-widest text-apoyo">Fecha</th>
 <th class="px-3 py-3 text-[10px] font-bold uppercase tracking-widest text-apoyo">Horario programado</th>
 <th class="px-3 py-3 text-[10px] font-bold uppercase tracking-widest text-apoyo">Llegada / salida</th>
 <th class="px-3 py-3 text-[10px] font-bold uppercase tracking-widest text-apoyo">Tiempo</th>
 <th class="px-3 py-3 text-[10px] font-bold uppercase tracking-widest text-apoyo">Estado</th>
 <th class="px-3 py-3 text-[10px] font-bold uppercase tracking-widest text-apoyo">Registrado por</th>
 ...
 <p class="max-w-[170px] truncate text-xs font-bold text-titulo">{{ $registro->voluntario_nombre ?: 'Voluntario' }}</p>
 ...
 <td class="px-3 py-3 align-top">
 <p class="max-w-[150px] truncate text-xs font-bold text-titulo">{{ $registro->horario_programado }}</p>
 <p class="mt-0.5 text-[10px] font-bold text-estado-advertencia">{{ $registro->turno }}</p>
 </td>
 <td class="px-3 py-3 align-top">
 <p class="text-xs font-bold text-titulo">{{ $registro->hora_entrada ? substr((string) $registro->hora_entrada, 0, 5) : '--:--' }}</p>
 <p class="mt-0.5 text-[10px] font-bold text-apoyo">Salida {{ $registro->hora_salida ? substr((string) $registro->hora_salida, 0, 5) : '--:--' }}</p>
 </td>
 <td class="px-3 py-3 align-top">
 <p class="text-xs font-bold text-titulo">{{ $registro->tiempo_colaborado }}</p>
 </td>
 <td class="px-3 py-3 align-top">
 ...
 <td class="px-3 py-3 align-top">
 <p class="text-[10px] font-bold uppercase tracking-wider text-apoyo">{{ $registro->registrado_por }}</p>
 ...
 <div>
 <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-boton-acento">{{ $isEdit ? 'Editar control' : 'Nuevo control' }}</span>
 <h2 class="mt-1 text-xl font-extrabold text-titulo">{{ $isEdit ? 'Editar asistencia' : 'Registrar asistencia' }}</h2>
 ...
 <span class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-apoyo">Asignación programada</span>
 ...
 <label class="block">
 <span class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-apoyo">Hora de llegada</span>
 ...
 <label class="block">
 <span class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-apoyo">Hora de salida</span>
 ...
 <span class="block text-[9px] font-bold uppercase tracking-widest text-apoyo">Programación asociada</span>
 <p class="mt-1 text-sm font-bold text-titulo">{{ $programacionFormulario['horario'] }}</p>
 ...
 <div>
 <p class="text-xs font-bold text-estado-advertencia">Asignación por revisar</p>
 ...
 <label class="block sm:col-span-2">
 <span class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-apoyo">Actividad realizada</span>
 ...
 <label class="block sm:col-span-2">
 <span class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-apoyo">Motivo / observación</span>
