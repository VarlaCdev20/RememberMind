    ...
    <div class="mx-auto max-w-7xl space-y-5">
        <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-[0_16px_46px_rgba(47,62,92,0.12)] backdrop-blur-xl">
            ...
            <div class="flex flex-col gap-4 p-4 sm:p-5 xl:flex-row xl:items-end xl:justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ $linksCabecera['disponibilidad'] }}" class="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-borde-suave bg-fondo-panel px-4 text-[11px] font-black uppercase tracking-wider text-titulo shadow-sm transition hover:border-borde-focus hover:text-boton-acento active:scale-95">
                        <i class="ph-bold ph-calendar-dots text-sm"></i>
                        Ver disponibilidad
                    </a>

                    <a href="{{ $linksCabecera['asistencia'] }}" class="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-borde-suave bg-fondo-panel px-4 text-[11px] font-black uppercase tracking-wider text-titulo shadow-sm transition hover:border-estado-exitoBorde hover:text-estado-exito active:scale-95">
        ...
        <section class="rounded-[1.35rem] border border-borde-suave bg-fondo-panel p-3.5 shadow-sm backdrop-blur-xl">
            <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-[1.35fr_0.8fr_0.8fr_0.8fr_0.9fr_0.8fr_0.9fr_auto_auto]">
                <label class="block">
                    <span class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Buscar</span>
                ...
                <label class="block">
                    <span class="mb-1 block text-[9px] font-black uppercase tracking-widest text-apoyo">Asistencia</span>
            ...
            <aside class="space-y-5">
                <div class="rounded-[1.45rem] border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl">
                    <div class="mb-3 flex items-center justify-between gap-3">
                        <div>
                            <span class="text-[10px] font-black uppercase tracking-[0.18em] text-boton-acento">Próximas asignaciones</span>
                            <h2 class="mt-0.5 text-base font-black text-titulo">Agenda operativa</h2>
                        </div>
                    ...
                    <div class="space-y-2.5">
                        @forelse($proximasAsignaciones as $proxima)
                            ...
                            <button type="button" wire:click="verDetalle({{ $proxima->cod_asig_vol }})" class="block w-full rounded-2xl border border-borde-suave bg-fondo-panel p-3 text-left transition hover:-translate-y-0.5 hover:border-borde-focus hover:shadow-sm">
                                <div class="flex items-start justify-between gap-2">
                                    <div class="min-w-0">
                                        <p class="truncate text-xs font-black text-titulo">{{ $proxima->voluntario_nombre ?: 'Voluntario' }}</p>
                        ...
                        @empty
                            <div class="rounded-2xl border border-dashed border-borde-suave bg-fondo-panel p-6 text-center">
                                ...
                                <h3 class="mt-3 text-sm font-black text-titulo">No existen asignaciones próximas registradas.</h3>
                ...
                <div class="rounded-[1.45rem] border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl">
                    <div class="mb-3 flex items-center justify-between gap-3">
                        <div>
                            <span class="text-[10px] font-black uppercase tracking-[0.18em] text-boton-acento">Detalle operativo</span>
                            <h2 class="mt-0.5 text-base font-black text-titulo">Asignación seleccionada</h2>
                        </div>
                    ...
                    @if($detalleAsignacion)
                        ...
                        <div class="space-y-3">
                            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-3">
                                ...
                                <p class="mt-1 text-sm font-black text-titulo">{{ $detalleAsignacion->voluntario_nombre ?: 'Voluntario' }}</p>
                                <p class="mt-0.5 text-[11px] font-bold text-apoyo">CI {{ $detalleAsignacion->numero_documento ?: 'No registrado' }}</p>
                            </div>

                            <div class="grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
                                <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-3">
                                    <p class="text-[10px] font-black uppercase tracking-widest text-apoyo">Apoyo</p>
                                    <p class="mt-1 text-xs font-black text-titulo">{{ $detalleAsignacion->tipo_operativo }}</p>
                                    <p class="mt-0.5 text-[11px] font-bold text-apoyo">{{ $detalleAsignacion->adulto_nombre ?: 'Sin adulto mayor relacionado' }}</p>
                                </div>
                                <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-3">
                                    <p class="text-[10px] font-black uppercase tracking-widest text-apoyo">Fecha y disponibilidad</p>
                                    <p class="mt-1 text-xs font-black text-titulo">{{ $detalleAsignacion->fecha_texto }} · {{ $detalleAsignacion->dia_semana }}</p>
                            ...
                            @if($detalleAsignacion->obser)
                                <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-3">
                                    <p class="text-[10px] font-black uppercase tracking-widest text-apoyo">Observación</p>
                                    <p class="mt-1 text-xs font-bold leading-relaxed text-apoyo">{{ $detalleAsignacion->obser }}</p>
                                </div>
                            @endif

                            <a href="{{ route('admin.voluntariado.asistencia.index', ['voluntario' => $detalleAsignacion->cod_vol, 'fecha' => $detalleAsignacion->fecha_asig, 'asignacion' => $detalleAsignacion->cod_asig_vol]) }}" class="inline-flex h-9 items-center justify-center gap-2 rounded-xl bg-boton-principal px-3 text-[10px] font-black uppercase tracking-wider text-inverso transition hover:bg-boton-acento">
                    ...
                    @else
                        <div class="rounded-2xl border border-dashed border-borde-suave bg-fondo-panel p-6 text-center">
                            ...
                            <h3 class="mt-3 text-sm font-black text-titulo">Selecciona una asignación.</h3>
            ...
            <div class="rounded-[1.45rem] border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl">
                <div class="mb-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h2 class="mt-0.5 text-base font-black text-titulo">Asignaciones registradas</h2>
                    </div>
                    ...
                    <table class="min-w-[980px] w-full divide-y divide-[#C7B5A3]/45 text-left">
                        <thead class="bg-fondo-panel">
                            <tr>
                                ...
                                <th class="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-apoyo">Apoyo</th>
                                <th class="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-apoyo">Fecha</th>
                                <th class="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-apoyo">Horario</th>
                                <th class="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-apoyo">Estado</th>
                                <th class="px-3 py-3 text-[10px] font-black uppercase tracking-widest text-apoyo">Responsable / Asistencia</th>
                            ...
                            @forelse($registros as $registro)
                                ...
                                <tr class="transition hover:bg-fondo-panel">
                                    <td class="px-3 py-3 align-top">
                                        <p class="max-w-[180px] truncate text-xs font-black text-titulo">{{ $registro->voluntario_nombre ?: 'Voluntario' }}</p>
                                        <p class="mt-0.5 text-[10px] font-bold text-apoyo">CI {{ $registro->numero_documento ?: 'No registrado' }}</p>
                                    </td>
                                    <td class="px-3 py-3 align-top">
                                        <p class="max-w-[210px] truncate text-xs font-black text-titulo">{{ $registro->tipo_operativo }}</p>
                                    ...
                                    <td class="px-3 py-3 align-top">
                                        <p class="max-w-[150px] truncate text-xs font-black text-titulo">{{ $registro->horario }}</p>
                                    ...
                                    <td class="px-3 py-3 align-top">
                                        <p class="text-[10px] font-black uppercase tracking-wider text-apoyo">{{ $registro->responsable_operativo }}</p>
        ...
        <div class="fixed inset-0 z-[90] flex items-center justify-center px-4 py-6">
            ...
            <section class="relative flex max-h-[92vh] w-full max-w-2xl flex-col overflow-hidden rounded-[1.5rem] border border-borde-suave bg-fondo-app shadow-[0_24px_70px_rgba(47,62,92,0.28)]">
                <header class="flex items-start justify-between gap-4 border-b border-borde-suave bg-fondo-panel px-5 py-4">
                    <div>
                        <span class="text-[10px] font-black uppercase tracking-[0.2em] text-boton-acento">{{ $isEdit ? 'Editar programación' : 'Nueva programación' }}</span>
                        <h2 class="mt-1 text-xl font-black text-titulo">{{ $isEdit ? 'Editar asignación' : 'Registrar asignación' }}</h2>
                ...
                <div class="flex-1 overflow-y-auto p-5">
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <label class="block sm:col-span-2">
                            <span class="mb-1.5 block text-[9px] font-black uppercase tracking-widest text-apoyo">Adulto mayor relacionado</span>
                        ...
                        <label class="block">
                            <span class="mb-1.5 block text-[9px] font-black uppercase tracking-widest text-apoyo">Fecha fin</span>
                        ...
                        <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-3">
                            <span class="block text-[9px] font-black uppercase tracking-widest text-apoyo">Disponibilidad del día</span>
                            <p class="mt-1 text-sm font-black text-titulo">{{ $disponibilidadFormulario['horario'] }}</p>
                        ...
                        @if($advertenciaDisponibilidad)
                            <div class="sm:col-span-2 rounded-2xl border border-estado-advertenciaBorde bg-estado-advertenciaBg p-3">
                                <div class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <p class="text-xs font-black text-estado-advertencia">Disponibilidad por revisar</p>
                        ...
                        <label class="block sm:col-span-2">
                            <span class="mb-1.5 block text-[9px] font-black uppercase tracking-widest text-apoyo">Observación / tarea</span>
                ...
                <footer class="flex flex-col-reverse gap-2 border-t border-borde-suave bg-fondo-panel px-5 py-4 sm:flex-row sm:justify-end">
                    ...
                    @if($advertenciaDisponibilidad)
                        <button type="button" wire:click="guardarBajoResponsabilidad" class="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-estado-advertenciaBorde bg-estado-advertenciaBg px-4 text-[11px] font-black uppercase tracking-wider text-estado-advertencia transition hover:bg-estado-advertenciaBg hover:text-inverso">
