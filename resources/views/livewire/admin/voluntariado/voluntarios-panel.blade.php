    ...
    <div class="mx-auto max-w-7xl space-y-6">
        <section class="overflow-hidden rounded-[1.65rem] border border-borde-suave bg-fondo-panel shadow-[0_20px_58px_rgba(47,62,92,0.13)] backdrop-blur-xl">
            ...
            <div class="flex flex-col gap-5 p-5 sm:p-7 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-3xl">
                    <span class="inline-flex items-center gap-2 rounded-full border border-borde-focus bg-estado-peligroBg px-3 py-1 text-xs font-black uppercase tracking-[0.15em] text-boton-acento">
                ...
                <div class="flex flex-wrap gap-2">
                    @can('voluntarios.crear')
                        <button
                            ...
                            class="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-boton-acento px-4 text-xs font-black uppercase tracking-wider text-inverso shadow-[0_10px_24px_rgba(226,125,96,0.25)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95"
                        >
                    ...
                    <a
                        ...
                        class="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-borde-suave bg-fondo-panel px-4 text-xs font-black uppercase tracking-wider text-titulo shadow-sm transition hover:border-borde-focus hover:text-boton-acento active:scale-95"
                    >
                    ...
                    <a
                        ...
                        class="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-borde-suave bg-fondo-panel px-4 text-xs font-black uppercase tracking-wider text-titulo shadow-sm transition hover:bg-fondo-panel active:scale-95"
                    >
        ...
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            @foreach($metricas as $metrica)
                ...
                <article class="relative min-h-[132px] overflow-hidden rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl transition duration-300 hover:-translate-y-0.5 hover:border-borde-focus hover:shadow-[0_16px_34px_rgba(47,62,92,0.11)]">
                    ...
                    <p class="mt-2 text-xs font-black uppercase leading-snug tracking-[0.12em] text-apoyo">{{ $metrica['label'] }}</p>
                </article>
            @endforeach
        </section>
        ...
        <section class="rounded-[1.5rem] border border-borde-suave bg-fondo-panel p-5 shadow-sm backdrop-blur-xl">
            <div class="mb-4 flex items-center justify-between gap-3">
                <div>
                    <span class="text-xs font-black uppercase tracking-[0.15em] text-boton-acento">Flujo del voluntario</span>
                    <h2 class="mt-1 text-lg font-black text-titulo">Punto de partida del apoyo institucional</h2>
                </div>
        ...
        <section class="rounded-[1.5rem] border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl sm:p-5">
            <div class="grid gap-3 lg:grid-cols-[1.3fr_0.8fr_0.8fr_0.8fr_0.8fr_auto]">
                <label class="block">
                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Buscar por nombre, cédula o correo</span>
                ...
                <label class="block">
                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Estado</span>
                ...
                <label class="block">
                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Área de apoyo</span>
                ...
                <label class="block">
                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Tipo</span>
                ...
                <label class="block">
                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Disponibilidad</span>
                ...
                <div class="flex items-end">
                    <button
                        ...
                        class="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-borde-suave bg-fondo-panel px-4 text-xs font-black uppercase tracking-wider text-titulo transition hover:bg-fondo-panel active:scale-95 lg:w-auto"
                    >
            ...
            <div class="overflow-x-auto">
                <table class="min-w-[1120px] w-full text-left">
                    <thead class="border-b border-borde-suave bg-fondo-panel">
                        <tr class="text-xs font-black uppercase tracking-[0.12em] text-apoyo">
                            ...
                            <tr class="bg-fondo-panel align-top transition hover:bg-fondo-panel">
                                <td class="px-4 py-4">
                                    <button type="button" wire:click="verPerfil({{ $vol->cod_vol }})" class="group flex min-w-0 items-center gap-3 text-left">
                                        <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-boton-principal text-sm font-black text-inverso shadow-sm transition group-hover:bg-boton-acento">
                                        ...
                                        <span class="min-w-0">
                                            <span class="block max-w-[220px] truncate text-sm font-black text-titulo group-hover:text-boton-acento">{{ $nombre ?: 'Voluntario sin nombre' }}</span>
                                ...
                                <td class="px-4 py-4">
                                    @if((int) $vol->disponibilidad_count > 0)
                                        <span class="inline-flex items-center gap-1.5 rounded-full bg-estado-exitoBg px-2.5 py-1 text-xs font-black uppercase tracking-wide text-estado-exito">
                                            <i class="ph-bold ph-check-circle"></i>
                                            {{ $vol->disponibilidad_count }} registrada(s)
                                        </span>
                                    @else
                                        <span class="inline-flex items-center gap-1.5 rounded-full bg-estado-peligroBg px-2.5 py-1 text-xs font-black uppercase tracking-wide text-boton-acento">
                                            <i class="ph-bold ph-calendar-x"></i>
                                            Sin registrar
                                        </span>
                                    @endif
                                </td>
                                <td class="px-4 py-4 text-xs font-black text-titulo">{{ $vol->asignaciones_activas_count }}</td>
                                <td class="px-4 py-4 text-xs font-bold text-apoyo">
        ...
        <div class="fixed inset-0 z-[90] flex justify-end">
            ...
            <aside class="relative flex h-full w-full max-w-4xl flex-col overflow-hidden border-l border-borde-suave bg-fondo-app shadow-[-22px_0_60px_rgba(47,62,92,0.26)] sm:rounded-l-[2rem]">
                <header class="flex items-center justify-between gap-4 border-b border-borde-suave bg-fondo-panel px-5 py-4 sm:px-7">
                    <div>
                        <span class="text-xs font-black uppercase tracking-[0.15em] text-boton-acento">{{ $isEdit ? 'Editar registro' : 'Nuevo registro' }}</span>
                        <h2 class="mt-1 text-xl font-black text-titulo">{{ $isEdit ? 'Editar voluntario' : 'Registrar voluntario' }}</h2>
                    </div>
                ...
                <div class="flex-1 overflow-y-auto p-5 sm:p-7">
                    <div class="grid gap-5 lg:grid-cols-2">
                        <section class="rounded-2xl border border-borde-suave bg-fondo-panel p-4">
                            <h3 class="text-sm font-black uppercase tracking-wider text-titulo">Datos personales</h3>
                            <div class="mt-4 grid gap-4 sm:grid-cols-2">
                                <label class="block sm:col-span-2">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Nombres</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Apellido paterno</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Apellido materno</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Cédula</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Expedido</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Fecha de nacimiento</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Género</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Celular</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Correo</span>
                                ...
                                <label class="block sm:col-span-2">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Dirección</span>
                        ...
                        <section class="rounded-2xl border border-borde-suave bg-fondo-panel p-4">
                            <h3 class="text-sm font-black uppercase tracking-wider text-titulo">Datos institucionales</h3>
                            <div class="mt-4 grid gap-4">
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Fecha de registro</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Disponibilidad inicial</span>
                                ...
                                <label class="block">
                                    <span class="mb-1.5 block text-xs font-black uppercase tracking-widest text-apoyo">Observaciones administrativas / habilidades</span>
                ...
                <footer class="flex flex-col-reverse gap-2 border-t border-borde-suave bg-fondo-panel px-5 py-4 sm:flex-row sm:justify-end sm:px-7">
                    <button type="button" wire:click="cerrarFormulario" class="inline-flex h-11 items-center justify-center rounded-xl border border-borde-suave bg-fondo-panel px-4 text-xs font-black uppercase tracking-wider text-titulo transition hover:bg-fondo-panel">
                        Cancelar
                    </button>
                    <button type="button" @click="confirmarGuardar()" class="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-boton-principal px-5 text-xs font-black uppercase tracking-wider text-inverso shadow-[0_10px_24px_rgba(47,62,92,0.18)] transition hover:bg-boton-acento active:scale-95">
        ...
        <div class="fixed inset-0 z-[80] flex justify-end">
            ...
            <aside class="relative flex h-full w-full max-w-5xl flex-col overflow-hidden border-l border-borde-suave bg-fondo-app shadow-[-22px_0_60px_rgba(47,62,92,0.26)] sm:rounded-l-[2rem]">
                <header class="flex items-start justify-between gap-4 border-b border-borde-suave bg-fondo-panel px-5 py-4 sm:px-7">
                    <div class="min-w-0">
                        <span class="inline-flex items-center gap-2 rounded-full bg-estado-peligroBg px-3 py-1 text-xs font-black uppercase tracking-[0.15em] text-boton-acento">
                ...
                <div class="flex-1 overflow-y-auto p-5 sm:p-7">
                    <div class="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
                        <section class="space-y-5">
                            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5">
                                <div class="flex items-center justify-between gap-3">
                                    <div>
                                        <p class="text-xs font-black uppercase tracking-[0.12em] text-apoyo">Estado operativo</p>
                                        <p class="mt-1 text-lg font-black text-titulo">{{ \Illuminate\Support\Str::headline(\Illuminate\Support\Str::lower($estadoPerfil)) }}</p>
                                    </div>
                                ...
                                <div class="mt-4 grid grid-cols-3 gap-2">
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center">
                                        <p class="text-xl font-black text-titulo">{{ $perfil['stats']['disponibilidades'] }}</p>
                                        <p class="text-xs font-black uppercase text-apoyo">Disponibilidad</p>
                                    </div>
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center">
                                        <p class="text-xl font-black text-estado-exito">{{ $perfil['stats']['asignaciones_activas'] }}</p>
                                        <p class="text-xs font-black uppercase text-apoyo">Asignaciones</p>
                                    </div>
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center">
                                        <p class="text-xl font-black text-boton-acento">{{ $perfil['stats']['asistencias'] }}</p>
                                        <p class="text-xs font-black uppercase text-apoyo">Asistencias</p>
                                    </div>
                                </div>
                            </div>

                            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5">
                                <h3 class="text-sm font-black uppercase tracking-wider text-titulo">Datos principales</h3>
                            ...
                            <div class="grid gap-2 sm:grid-cols-3">
                                <a href="{{ $perfil['links']['disponibilidad'] }}" class="rounded-xl border border-borde-suave bg-fondo-panel p-3 text-center text-xs font-black uppercase tracking-wide text-titulo transition hover:border-borde-focus hover:text-boton-acento">
                                    <i class="ph-bold ph-calendar-dots mb-1 block text-lg"></i>
                                    Disponibilidad
                                </a>
                                <a href="{{ $perfil['links']['asignaciones'] }}" class="rounded-xl border border-borde-suave bg-fondo-panel p-3 text-center text-xs font-black uppercase tracking-wide text-titulo transition hover:border-borde-focus hover:text-boton-acento">
                                    <i class="ph-bold ph-handshake mb-1 block text-lg"></i>
                                    Asignaciones
                                </a>
                                <a href="{{ $perfil['links']['asistencia'] }}" class="rounded-xl border border-borde-suave bg-fondo-panel p-3 text-center text-xs font-black uppercase tracking-wide text-titulo transition hover:border-borde-focus hover:text-boton-acento">
                        ...
                        <section class="space-y-5">
                            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5">
                                <h3 class="text-sm font-black uppercase tracking-wider text-titulo">Disponibilidad resumida</h3>
                            ...
                            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5">
                                <h3 class="text-sm font-black uppercase tracking-wider text-titulo">Asignaciones activas</h3>
                                <div class="mt-4 space-y-2">
                                    @forelse($perfil['asignaciones'] as $asig)
                                        <div class="rounded-xl bg-fondo-panel px-3 py-3">
                                            <p class="text-xs font-black text-titulo">{{ trim(($asig->nombres ?? '') . ' ' . ($asig->ap_paterno ?? '') . ' ' . ($asig->ap_materno ?? '')) ?: 'Adulto mayor asignado' }}</p>
                            ...
                            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5">
                                <h3 class="text-sm font-black uppercase tracking-wider text-titulo">Últimas asistencias</h3>
                                <div class="mt-4 space-y-2">
                                    @forelse($perfil['asistencias'] as $asis)
                                        <div class="rounded-xl bg-fondo-panel px-3 py-3">
                                            <div class="flex items-center justify-between gap-2">
                                                <p class="text-xs font-black text-titulo">{{ \Carbon\Carbon::parse($asis->fecha)->format('d/m/Y') }}</p>
                                                <span class="rounded-full bg-estado-exitoBg px-2.5 py-1 text-xs font-black uppercase tracking-wide text-estado-exito">{{ $asis->estado }}</span>
                                            </div>
                            ...
                            <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5">
                                <h3 class="text-sm font-black uppercase tracking-wider text-titulo">Observaciones administrativas</h3>
