<div class="p-6 md:p-8 space-y-8 relative min-h-screen bg-fondo-panel print:bg-white print:p-0 print:space-y-4" 
        ...
        <div class="flex items-center gap-3">
            @can('areas.reportes')
                <button type="button"
                        ...
                        class="inline-flex items-center justify-center gap-2 rounded-full border-2 border-borde-suave bg-fondo-card px-5 py-2.5 text-xs font-black text-meta shadow-md transition-all duration-300 hover:bg-fondo-panel active:scale-95">
            ...
            @can('areas.crear')
                <button type="button"
                        ...
                        class="inline-flex items-center justify-center gap-2 rounded-full bg-boton-acento px-6 py-2.5 text-xs font-black text-inverso shadow-lg shadow-[#E27D60]/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl active:translate-y-0 active:scale-95">
    ...
    <section class="grid grid-cols-2 md:grid-cols-6 gap-4 no-print">
        {{-- Total Áreas --}}
        <div class="rounded-2xl border-none bg-fondo-card p-4 shadow-[0_12px_24px_rgba(47,62,92,0.05)] transition duration-300 hover:shadow-lg">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-black uppercase tracking-wider text-parrafo">Total Áreas</span>
        ...
        <div class="rounded-2xl border-none bg-fondo-card p-4 shadow-[0_12px_24px_rgba(47,62,92,0.05)] transition duration-300 hover:shadow-lg">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-black uppercase tracking-wider text-parrafo">Activas</span>
        ...
        <div class="rounded-2xl border-none bg-fondo-card p-4 shadow-[0_12px_24px_rgba(47,62,92,0.05)] transition duration-300 hover:shadow-lg">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-black uppercase tracking-wider text-parrafo">Inactivas</span>
        ...
        <div class="rounded-2xl border-none bg-fondo-card p-4 shadow-[0_12px_24px_rgba(47,62,92,0.05)] transition duration-300 hover:shadow-lg">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-black uppercase tracking-wider text-parrafo">Personal</span>
                <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-estado-peligroBg text-boton-acento">
        ...
        <div class="rounded-2xl border-none bg-fondo-card p-4 shadow-[0_12px_24px_rgba(47,62,92,0.05)] transition duration-300 hover:shadow-lg">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-black uppercase tracking-wider text-parrafo">Sin Responsable</span>
        ...
        <div class="rounded-2xl border-none bg-fondo-card p-4 shadow-[0_12px_24px_rgba(47,62,92,0.05)] transition duration-300 hover:shadow-lg">
            <div class="flex items-center justify-between">
                <span class="text-[10px] font-black uppercase tracking-wider text-parrafo">Sin Personal</span>
    ...
    <section class="rounded-2xl bg-fondo-card/70 backdrop-blur-md p-4 shadow-[0_8px_30px_rgba(47,62,92,0.04)] border border-borde-suave no-print">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div class="relative md:col-span-2">
                ...
                <input type="text"
                       ...
                       class="w-full rounded-xl border-borde-suave bg-fondo-card/80 py-2.5 pl-10 pr-4 text-xs font-semibold text-titulo placeholder-[#967B66]/60 shadow-sm transition focus:border-borde-focus focus:ring-1 focus:ring-[#E27D60]">
            </div>

            {{-- Tipo de Área --}}
            <div>
                <select wire:model.live="filtroTipo"
                        class="w-full rounded-xl border-borde-suave bg-fondo-card py-2.5 text-xs font-semibold text-titulo shadow-sm focus:border-borde-focus focus:ring-1 focus:ring-[#E27D60]">
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-6 no-print">
        @forelse($areas as $area)
            ...
            @endphp
            <div class="group relative rounded-3xl transition-all duration-300 hover:-translate-y-1 bg-fondo-panel shadow-[0_14px_30px_rgba(47,62,92,0.06)] hover:shadow-[0_20px_40px_rgba(47,62,92,0.12)] overflow-hidden border-2 border-transparent hover:border-borde-suave flex flex-col {{ $esInactiva ? 'opacity-70 grayscale bg-fondo-panel' : '' }}">
                ...
                <div class="relative h-36 w-full shrink-0 overflow-hidden bg-slate-100">
                    ...
                    <div class="absolute bottom-4 left-4 right-4">
                        <h3 class="text-base font-black text-inverso leading-snug drop-shadow-sm truncate">
                            {{ $area->nombre }}
                        </h3>
                    </div>
                </div>
                ...
                <div class="p-5 flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <div class="rounded-2xl bg-fondo-panel p-3 flex items-center justify-between border border-borde-suave">
                        <div class="flex items-center gap-2">
                            <div class="flex h-7 w-7 items-center justify-center rounded-full text-[10px] font-black text-inverso shadow-sm" style="background-color: {{ $colorAccent }}">
                                {{ $area->responsable ? substr($area->responsable->nombres, 0, 1) . substr($area->responsable->ap_paterno, 0, 1) : '?' }}
                            </div>
                            <div>
                                <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">Responsable</p>
                                <p class="text-[10px] font-black text-titulo truncate max-w-[140px]">
                        ...
                        <div class="text-right">
                            <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">Personal</p>
                            <span class="inline-flex items-center gap-1 text-[11px] font-black text-boton-acento">
                    ...
                    <div class="pt-4 border-t border-borde-suave flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <button type="button"
                                    ...
                                    class="inline-flex h-8 items-center gap-1.5 rounded-full bg-fondo-panel px-3 text-[10px] font-black text-titulo hover:bg-boton-principal hover:text-inverso transition duration-200"
                            ...
                            @can('areas.reportes')
                                <button type="button"
                                        ...
                                        class="inline-flex h-8 items-center gap-1.5 rounded-full bg-estado-exitoBg px-3 text-[10px] font-black text-estado-exito hover:bg-estado-exitoBg hover:text-inverso transition duration-200"
        ...
        @empty
            <div class="col-span-full rounded-3xl bg-fondo-card p-12 text-center shadow-[0_12px_24px_rgba(0,0,0,0.02)]">
                ...
                <h3 class="text-base font-black text-titulo">No se encontraron áreas institucionales</h3>
    ...
    @if($mostrarFicha && $areaSeleccionada)
        <div class="fixed inset-0 z-50 overflow-hidden no-print" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
            <div class="absolute inset-0 overflow-hidden">
                <div class="absolute inset-0 bg-fondo-panel backdrop-blur-sm transition-opacity" wire:click="cerrarFicha"></div>

                <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                    <div class="pointer-events-auto w-screen max-w-5xl transform bg-fondo-panel shadow-[0_20px_60px_rgba(47,62,92,0.25)] transition duration-500 ease-in-out">
                        <div class="flex h-full flex-col bg-fondo-card">
                            ...
                            <div class="flex-1 overflow-y-auto bg-fondo-panel p-6 space-y-6" 
                                 x-data="{
                                    activeChart: null,
                                    rolChart: null,
                                    lineChart: null,
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-2">
                                            <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">INFORMACIÓN DEL ÁREA</h4>
                                        ...
                                        <div class="space-y-2">
                                            <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">RESPONSABLE DEL ÁREA</h4>
                                            <div class="flex items-center gap-3 bg-fondo-card p-3.5 rounded-2xl shadow-sm border border-borde-suave">
                                                <div class="flex h-9 w-9 items-center justify-center rounded-full text-xs font-black text-inverso shadow-sm" style="background-color: {{ $areaSeleccionada->color ?? '#E27D60' }}">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">
                                        ...
                                        {{-- USUARIOS VINCULADOS --}}
                                        <div class="space-y-2">
                                            <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">USUARIOS VINCULADOS</h4>
                                                ...
                                                @forelse($areaSeleccionada->usuarios as $u)
                                                    <div class="flex items-center justify-between bg-fondo-card p-2.5 rounded-xl border border-borde-suave shadow-sm transition hover:border-borde-focus">
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-fondo-app text-[10px] font-black text-meta">
                                                                {{ substr($u->nombres, 0, 1) . substr($u->ap_paterno, 0, 1) }}
                                                            </div>
                                                            <div>
                                                                <h5 class="text-xs font-black text-titulo leading-snug">{{ $u->name }}</h5>
                                                                <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">
                                        ...
                                        @if($areaSeleccionada->observaciones)
                                            <div class="space-y-2">
                                                <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">OBSERVACIONES</h4>
                                                <p class="text-xs font-semibold text-meta bg-fondo-panel p-3 rounded-2xl border border-orange-200/50 leading-relaxed italic">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="space-y-2">
                                            <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">ESTADÍSTICAS DEL ÁREA</h4>
                                            <div class="grid grid-cols-2 gap-3">
                                                {{-- Total Vinculados --}}
                                                <div class="bg-fondo-card p-3 rounded-xl border border-borde-suave shadow-sm">
                                                    <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">Total Personal</p>
                                                    <p class="text-lg font-black text-titulo mt-0.5">{{ $totalUsuarios }}</p>
                                                </div>
                                                {{-- Activos --}}
                                                <div class="bg-fondo-card p-3 rounded-xl border border-borde-suave shadow-sm">
                                                    <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">Activos</p>
                                                    <p class="text-lg font-black text-estado-exito mt-0.5">{{ $activosUsuarios }}</p>
                                                </div>
                                                {{-- Inactivos --}}
                                                <div class="bg-fondo-card p-3 rounded-xl border border-borde-suave shadow-sm">
                                                    <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">Inactivos</p>
                                                    <p class="text-lg font-black text-red-600 mt-0.5">{{ $inactivosUsuarios }}</p>
                                                </div>
                                                {{-- Porcentaje --}}
                                                <div class="bg-fondo-card p-3 rounded-xl border border-borde-suave shadow-sm">
                                                    <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">% Activos</p>
                                                    <p class="text-lg font-black text-boton-acento mt-0.5">{{ $porcActivos }}%</p>
                                                </div>
                                                {{-- Estado del Área --}}
                                                <div class="bg-fondo-card p-3 rounded-xl border border-borde-suave shadow-sm">
                                                    <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">Estado Área</p>
                                                    <p class="text-xs font-black mt-1 {{ $areaSeleccionada->estado === 'ACTIVA' ? 'text-estado-exito' : 'text-red-600' }}">{{ $areaSeleccionada->estado }}</p>
                                                </div>
                                                {{-- Responsable Status --}}
                                                <div class="bg-fondo-card p-3 rounded-xl border border-borde-suave shadow-sm">
                                                    <p class="text-[9px] font-black text-parrafo uppercase tracking-wider">Responsable</p>
                                                    <p class="text-xs font-black mt-1 {{ $areaSeleccionada->responsable_id ? 'text-estado-exito' : 'text-red-600' }}">
                                        ...
                                        <div class="space-y-4">
                                            <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">GRÁFICAS DEL ÁREA</h4>
                                            
                                            @if($totalUsuarios > 0)
                                                {{-- Gráfico Dona Activos vs Inactivos --}}
                                                <div class="bg-fondo-card p-4 rounded-2xl border border-borde-suave shadow-sm">
                                                    <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Usuarios Activos vs Inactivos</h5>
                                                ...
                                                <div class="bg-fondo-card p-4 rounded-2xl border border-borde-suave shadow-sm">
                                                    <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Usuarios por Rol</h5>
                                            ...
                                            @if(count($this->obtenerDatosGraficoEvolucionArea($areaSeleccionada->cod_area)) >= 2)
                                                <div class="bg-fondo-card p-4 rounded-2xl border border-borde-suave shadow-sm">
                                                    <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Evolución Asignación Personal</h5>
                                                    <div class="relative h-44 w-full">
                                ...
                                @can('areas.reportes')
                                    <div class="mt-6 border-t border-borde-suave pt-4 space-y-2">
                                        <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">REPORTES DEL ÁREA</h4>
                                        <div class="bg-fondo-panel p-4 rounded-2xl border border-borde-suave space-y-3">
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                <button type="button"
                                                        ...
                                                        class="inline-flex items-center gap-1.5 rounded-full bg-boton-principal px-3.5 py-2 text-[10px] font-black text-inverso hover:bg-fondo-panel shadow-md transition duration-200">
                                                ...
                                                <button type="button"
                                                        ...
                                                        class="inline-flex items-center gap-1.5 rounded-full bg-estado-peligroBg px-3.5 py-2 text-[10px] font-black text-boton-acento hover:bg-boton-acento hover:text-inverso transition duration-200">
                                                    <i class="ph-bold ph-file-pdf text-xs"></i>
                                                    Exportar PDF
                                                </button>
                                                <button type="button"
                                                        wire:click="exportarUsuariosAreaExcel('{{ $areaSeleccionada->cod_area }}')"
                                                        class="inline-flex items-center gap-1.5 rounded-full bg-estado-exitoBg px-3.5 py-2 text-[10px] font-black text-estado-exito hover:bg-estado-exitoBg hover:text-inverso transition duration-200">
                                ...
                                {{-- TRAZABILIDAD --}}
                                <div class="mt-6 border-t border-borde-suave pt-4 space-y-2">
                                    <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">TRAZABILIDAD</h4>
                            ...
                            <div class="border-t border-borde-suave p-4 bg-fondo-card flex items-center justify-end gap-2">
                                @can('areas.reportes')
                                    <button type="button"
                                            wire:click="abrirReporteArea('{{ $areaSeleccionada->cod_area }}')"
                                            class="inline-flex items-center gap-1.5 rounded-full border border-borde-suave bg-fondo-card px-4 py-2 text-xs font-black text-meta hover:bg-fondo-panel transition duration-200">
                                        <i class="ph-bold ph-file-chart"></i>
                                        Generar reporte del área
                                    </button>
                                @endcan
                                @can('areas.editar')
                                    <button type="button"
                                            ...
                                            class="inline-flex items-center gap-1.5 rounded-full bg-boton-acento px-4 py-2 text-xs font-black text-inverso hover:bg-fondo-panel shadow transition duration-200">
                                        <i class="ph-bold ph-pencil-simple"></i>
                                        Editar
                                    </button>
                                @endcan
                                <button type="button"
                                        wire:click="cerrarFicha"
                                        class="inline-flex items-center gap-1.5 rounded-full border border-borde-suave bg-fondo-card px-4 py-2 text-xs font-black text-apoyo hover:bg-fondo-panel transition duration-200">
                                    Cerrar
                                </button>
                            </div>
                        </div>
    ...
    @if($mostrarFormulario)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-x-hidden overflow-y-auto no-print" role="dialog" aria-modal="true">
            <div class="fixed inset-0 bg-fondo-panel backdrop-blur-sm transition-opacity" wire:click="cerrarFormulario"></div>

            <div class="relative w-full max-w-2xl rounded-[2.2rem] bg-fondo-card p-6 shadow-[0_20px_50px_rgba(47,62,92,0.2)] border border-borde-suave transform transition-all duration-300">
                
                {{-- Encabezado Modal --}}
                <header class="flex items-center justify-between pb-4 border-b border-borde-suave">
                    <div>
                        <h3 class="text-xl font-black text-titulo">{{ $isEdit ? 'Editar Área Institucional' : 'Nueva Área Institucional' }}</h3>
                ...
                <form wire:submit.prevent="guardarArea" class="mt-4 space-y-4">
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 max-h-[60vh] overflow-y-auto p-1 pr-2 [scrollbar-width:thin] [scrollbar-color:#C7B5A3_transparent]">
                        ...
                        <div class="space-y-4 md:col-span-2">
                            <h4 class="text-[10px] font-black text-boton-acento uppercase tracking-widest border-b border-borde-focus pb-1">1. Identidad del Área</h4>
                        </div>

                        {{-- Nombre --}}
                        <div class="md:col-span-2">
                            <label class="block text-xs font-black text-titulo mb-1">Nombre de la Área</label>
                            <input type="text"
                                   wire:model="nombre"
                                   placeholder="Ej: Área de Atención Médica"
                                   class="w-full rounded-xl border-borde-suave py-2 text-xs font-semibold text-titulo shadow-sm focus:border-borde-focus focus:ring-[#E27D60]">
                            @error('nombre') <span class="text-[10px] font-bold text-red-600">{{ $message }}</span> @enderror
                        </div>

                        {{-- Tipo de Área --}}
                        <div>
                            <label class="block text-xs font-black text-titulo mb-1">Tipo de Área</label>
                        ...
                        {{-- Orden --}}
                        <div>
                            <label class="block text-xs font-black text-titulo mb-1">Orden de Visualización</label>
                            <input type="number"
                                   wire:model="orden"
                                   min="0"
                                   class="w-full rounded-xl border-borde-suave py-2 text-xs font-semibold text-titulo shadow-sm focus:border-borde-focus">
                            @error('orden') <span class="text-[10px] font-bold text-red-600">{{ $message }}</span> @enderror
                        </div>

                        {{-- Descripción --}}
                        <div class="md:col-span-2">
                            <label class="block text-xs font-black text-titulo mb-1">Descripción Funcional</label>
                            <textarea wire:model="descripcion"
                                      rows="3"
                                      placeholder="Describa el rol operativo y responsabilidades institucionales del área..."
                                      class="w-full rounded-xl border-borde-suave py-2 text-xs font-semibold text-titulo shadow-sm focus:border-borde-focus focus:ring-[#E27D60]"></textarea>
                            @error('descripcion') <span class="text-[10px] font-bold text-red-600">{{ $message }}</span> @enderror
                        </div>

                        {{-- Estado --}}
                        <div>
                            <label class="block text-xs font-black text-titulo mb-1">Estado de Área</label>
                        ...
                        <div class="space-y-4 md:col-span-2 mt-2">
                            <h4 class="text-[10px] font-black text-boton-acento uppercase tracking-widest border-b border-borde-focus pb-1">2. Presentación Visual</h4>
                        </div>

                        {{-- Portada Upload --}}
                        <div class="md:col-span-2">
                            <label class="block text-xs font-black text-titulo mb-1">Imagen de Portada</label>
                        ...
                        {{-- Color --}}
                        <div>
                            <label class="block text-xs font-black text-titulo mb-1">Color Institucional</label>
                        ...
                        <div class="space-y-4 md:col-span-2 mt-2">
                            <h4 class="text-[10px] font-black text-boton-acento uppercase tracking-widest border-b border-borde-focus pb-1">3. Responsable del Área</h4>
                        </div>

                        {{-- Responsable (Limitado a usuarios del área en edición; deshabilitado en creación) --}}
                        <div class="md:col-span-2">
                            <label class="block text-xs font-black text-titulo mb-1">Asignar Responsable</label>
                            @if(!$isEdit)
                                <select disabled class="w-full rounded-xl border-borde-suave bg-fondo-panel py-2 text-xs font-semibold text-apoyo cursor-not-allowed">
                        ...
                        <div class="space-y-4 md:col-span-2 mt-2">
                            <h4 class="text-[10px] font-black text-boton-acento uppercase tracking-widest border-b border-borde-focus pb-1">4. Observaciones</h4>
                        </div>

                        {{-- Observaciones internas --}}
                        <div class="md:col-span-2">
                            <label class="block text-xs font-black text-titulo mb-1">Observaciones Internas</label>
                            <textarea wire:model="observaciones"
                                      rows="2"
                                      placeholder="Observaciones de administración interna..."
                                      class="w-full rounded-xl border-borde-suave py-2 text-xs font-semibold text-titulo shadow-sm focus:border-borde-focus"></textarea>
                    ...
                    <footer class="flex items-center justify-end gap-2 pt-4 border-t border-borde-suave">
                        <button type="button"
                                wire:click="cerrarFormulario"
                                class="rounded-full border-2 border-borde-suave bg-fondo-card px-5 py-2 text-xs font-black text-meta shadow-sm transition hover:bg-fondo-panel">
                            Cancelar
                        </button>
                        <button type="submit"
                                class="rounded-full bg-boton-acento px-6 py-2 text-xs font-black text-inverso shadow-lg transition hover:bg-fondo-panel">
                            Guardar cambios
                        </button>
                    </footer>
                </form>
    ...
    @if($mostrarReportes && $reporteData)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-x-hidden overflow-y-auto print:relative print:z-auto print:p-0" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 bg-fondo-panel backdrop-blur-sm transition-opacity no-print" wire:click="cerrarReportes"></div>

            {{-- Contenedor del Modal --}}
            <div class="relative w-full max-w-4xl rounded-[2.2rem] bg-fondo-card p-6 shadow-[0_20px_50px_rgba(47,62,92,0.2)] border border-borde-suave transform transition-all duration-300 print:shadow-none print:border-none print:p-0 print:m-0 print:max-w-none">
                    ...
                    <div class="flex gap-2">
                        @if($reporteTipo === 'general')
                            <a href="{{ route('admin.areas-institucionales.reportes.general.pdf') }}"
                               target="_blank"
                               class="flex h-8 items-center gap-2 rounded-lg bg-boton-acento px-3 text-xs font-black text-inverso hover:bg-fondo-panel transition duration-200">
                                <i class="ph-bold ph-file-pdf"></i>
                                Exportar PDF
                            </a>
                            <a href="{{ route('admin.areas-institucionales.reportes.general.excel') }}"
                               target="_blank"
                               class="flex h-8 items-center gap-2 rounded-lg bg-estado-exitoBg px-3 text-xs font-black text-inverso hover:bg-fondo-panel transition duration-200">
                                <i class="ph-bold ph-file-xls"></i>
                                Exportar Excel
                            </a>
                            <a href="{{ route('admin.areas-institucionales.reportes.general.csv') }}"
                               target="_blank"
                               class="flex h-8 items-center gap-2 rounded-lg bg-fondo-panel px-3 text-xs font-black text-inverso hover:bg-fondo-panel transition duration-200">
                    ...
                    @if($reporteTipo === 'general')
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="text-center pb-4 border-b border-borde-suave">
                                ...
                                <p class="text-xs font-black text-parrafo uppercase tracking-widest mt-1">CENTRO GERIÁTRICO JARDÍN DE LOS RECUERDOS • Sistema RememberMind</p>
                            ...
                            <div class="space-y-2">
                                <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">RESUMEN EJECUTIVO ORGANIZACIONAL</h4>
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div class="bg-fondo-panel p-4 rounded-2xl border border-borde-suave text-center shadow-sm">
                                        ...
                                        <p class="text-[9px] font-black text-parrafo uppercase tracking-wider mt-1">Total Áreas</p>
                                    ...
                                    <div class="bg-fondo-panel p-4 rounded-2xl border border-borde-suave text-center shadow-sm">
                                        ...
                                        <p class="text-[9px] font-black text-parrafo uppercase tracking-wider mt-1">Personal Asignado</p>
                                    ...
                                    <div class="bg-fondo-panel p-4 rounded-2xl border border-borde-suave text-center shadow-sm">
                                        ...
                                        <p class="text-[9px] font-black text-parrafo uppercase tracking-wider mt-1">Área con Más Usuarios</p>
                                    ...
                                    <div class="bg-fondo-panel p-4 rounded-2xl border border-borde-suave text-center shadow-sm">
                                        ...
                                        <p class="text-[9px] font-black text-parrafo uppercase tracking-wider mt-1">Cobertura Liderazgo</p>
                            ...
                            <div class="space-y-4 no-print">
                                <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">GRÁFICAS ANALÍTICAS GENERALES</h4>
                                
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {{-- Barras: usuarios por area --}}
                                    <div class="bg-fondo-card p-4 rounded-xl border border-borde-suave shadow-sm">
                                        <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Personal por Área Institucional</h5>
                                        <div class="relative h-44 w-full">
                                    ...
                                    {{-- Dona: areas por tipo --}}
                                    <div class="bg-fondo-card p-4 rounded-xl border border-borde-suave shadow-sm">
                                        <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Distribución de Áreas por Tipo</h5>
                                        <div class="relative h-44 w-full">
                                    ...
                                    <div class="bg-fondo-card p-4 rounded-xl border border-borde-suave shadow-sm">
                                        <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Personal Activo vs Inactivo por Área</h5>
                                        <div class="relative h-44 w-full">
                                    ...
                                    {{-- Evolucion mensual --}}
                                    <div class="bg-fondo-card p-4 rounded-xl border border-borde-suave shadow-sm">
                                        <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Evolución Mensual Asignación General</h5>
                                    ...
                                    <div class="bg-fondo-card p-4 rounded-xl border border-borde-suave shadow-sm col-span-1 md:col-span-2">
                                        <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Top 5 Áreas con Mayor Número de Personal</h5>
                            ...
                            {{-- Tabla de Áreas --}}
                            <div class="space-y-2">
                                <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">INFORMACIÓN GENERAL</h4>
                                    ...
                                    <tbody class="divide-y divide-[#C7B5A3]/30">
                                        @foreach($reporteData['areas'] as $rep)
                                            <tr class="hover:bg-fondo-panel">
                                                ...
                                                <td class="p-3 text-center font-black text-[10px] {{ $rep['estado'] === 'ACTIVA' ? 'text-estado-exito' : 'text-red-600' }}">{{ $rep['estado'] }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    @elseif($reporteTipo === 'especifico' && isset($reporteData['area']))
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="text-center pb-4 border-b border-borde-suave">
                                ...
                                <h3 class="text-lg font-black text-boton-acento mt-1">{{ $reporteData['area']['nombre'] }}</h3>
                                <p class="text-xs font-black text-parrafo uppercase tracking-widest mt-0.5">CENTRO GERIÁTRICO JARDÍN DE LOS RECUERDOS • Sistema RememberMind</p>
                                <p class="text-[10px] text-parrafo mt-2 font-bold">Fecha: {{ $reporteData['fecha'] }} | Generado por: {{ $reporteData['usuario'] }}</p>
                            </div>
                            ...
                            {{-- Resumen Estadístico --}}
                            <div class="space-y-2">
                                <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">RESUMEN ESTADÍSTICO</h4>
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                                    <div class="bg-fondo-app p-3 rounded-xl border border-borde-suave">
                                        <p class="text-xl font-black text-titulo">{{ $reporteData['totalUsuarios'] }}</p>
                                        <p class="text-[8px] font-black text-parrafo uppercase tracking-wider">Total Personal</p>
                                    </div>
                                    <div class="bg-fondo-app p-3 rounded-xl border border-borde-suave">
                                        <p class="text-xl font-black text-estado-exito">{{ $reporteData['usuariosActivos'] }}</p>
                                    ...
                                    <div class="bg-fondo-app p-3 rounded-xl border border-borde-suave">
                                        <p class="text-xl font-black text-boton-acento">{{ $reporteData['porcentajeActivos'] }}%</p>
                            ...
                            <div class="space-y-4 no-print">
                                ...
                                @if(count($this->obtenerDatosGraficoEvolucionArea($reporteData['area']['cod_area'])) >= 2)
                                    <div class="bg-fondo-card p-4 rounded-xl border border-borde-suave shadow-sm">
                                        <h5 class="text-[10px] font-black text-titulo mb-2 uppercase tracking-wide">Evolución Mensual Asignación</h5>
                                        <div class="relative h-44 w-full">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-[11px] font-black uppercase tracking-[0.18em] text-apoyo">PERSONAL VINCULADO</h4>
                                @if(count($reporteData['area']['usuarios']) > 0)
                                    <table class="w-full text-left text-xs border border-borde-suave rounded-xl overflow-hidden bg-fondo-card font-sans">
                                        <thead>
                                            <tr class="bg-fondo-app text-titulo font-black border-b border-borde-suave">
                ...
                <footer class="flex items-center justify-end mt-4 pt-4 border-t border-borde-suave no-print">
                    <button type="button"
                            wire:click="cerrarReportes"
                            class="rounded-full bg-boton-principal px-6 py-2 text-xs font-black text-inverso shadow-lg transition hover:bg-fondo-panel">
                        Cerrar panel
                    </button>
                </footer>
            </div>
