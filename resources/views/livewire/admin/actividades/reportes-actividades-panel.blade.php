<div class="min-h-screen bg-fondo-panel px-4 py-5 text-titulo sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl space-y-5">
            ...
            <div class="p-5 sm:p-7">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div class="flex shrink-0 flex-wrap items-center gap-2">
                        ...
                        <a
                            href="{{ $urlPreview }}"
                            class="inline-flex items-center gap-2 rounded-xl border border-borde-fuerte bg-fondo-panel px-3.5 py-2 text-xs font-black text-apoyo transition hover:bg-fondo-panel hover:text-titulo"
                        >
                        ...
                        @can('reportes.exportar_pdf')
                            <a
                                ...
                                @click.prevent="
                                    ...
                                    @endif
                                "
                                class="inline-flex items-center gap-2 rounded-xl border border-borde-focus bg-estado-peligroBg px-3.5 py-2 text-xs font-black text-boton-acento transition hover:bg-estado-peligroBg"
                            >
                        ...
                        @can('reportes.exportar_pdf')
                            <a
                                ...
                                @click.prevent="
                                    ...
                                    @endif
                                "
                                class="inline-flex items-center gap-2 rounded-xl border border-estado-exitoBorde bg-estado-exitoBg px-3.5 py-2 text-xs font-black text-estado-exito transition hover:bg-estado-exitoBg"
                            >
                        ...
                        @if($hasFiltros)
                            <button
                                ...
                                class="inline-flex items-center gap-1.5 rounded-xl border border-borde-suave bg-fondo-panel px-3.5 py-2 text-xs font-black text-apoyo transition hover:bg-fondo-app"
                            >
        ...
        <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-sm backdrop-blur-xl">
            <div class="border-b border-borde-suave bg-fondo-panel px-5 py-3">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-xs font-black uppercase tracking-[0.15em] text-titulo">Filtros de reporte</h2>
                    @if($hasFiltros)
                        <span class="ml-1 rounded-full bg-estado-advertenciaBg px-2 py-0.5 text-[9px] font-black text-estado-advertencia">Activos</span>
                    @endif
                </div>
            </div>
            <div class="p-4 sm:p-5">
                <div class="flex flex-wrap items-end gap-3">
                    ...
                    <div class="min-w-0 flex-1 basis-44">
                        <label class="mb-1 block text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Buscar adulto mayor</label>
                        <div class="relative">
                    ...
                    {{-- Tipo --}}
                    <div class="basis-40">
                        <label class="mb-1 block text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Tipo de actividad</label>
                        <select
                    ...
                    {{-- Fecha desde --}}
                    <div class="basis-36">
                        <label class="mb-1 block text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Fecha desde</label>
                        <input
                            type="date"
                    ...
                    {{-- Fecha hasta --}}
                    <div class="basis-36">
                        <label class="mb-1 block text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Fecha hasta</label>
                        <input
                            type="date"
        ...
        <div class="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-4" wire:loading.class="opacity-60">
            ...
            <div class="flex flex-col justify-between overflow-hidden rounded-2xl border border-borde-fuerte bg-fondo-panel p-4 shadow-sm">
                <div class="flex items-start justify-between gap-2">
                    <p class="text-[10px] font-black uppercase tracking-[0.12em] text-apoyo">Total actividades</p>
            ...
            <div class="flex flex-col justify-between overflow-hidden rounded-2xl border border-estado-advertenciaBorde bg-estado-advertenciaBg p-4 shadow-sm">
                <div class="flex items-start justify-between gap-2">
                    <p class="text-[10px] font-black uppercase tracking-[0.12em] text-estado-advertencia">Programadas</p>
            ...
            <div class="flex flex-col justify-between overflow-hidden rounded-2xl border border-estado-exitoBorde bg-estado-exitoBg p-4 shadow-sm">
                <div class="flex items-start justify-between gap-2">
                    <p class="text-[10px] font-black uppercase tracking-[0.12em] text-estado-exito">Adultos vinculados</p>
                    <span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-estado-exitoBg">
            ...
            <div class="flex flex-col justify-between overflow-hidden rounded-2xl border border-borde-fuerte bg-fondo-panel p-4 shadow-sm">
                <div class="flex items-start justify-between gap-2">
                    <p class="text-[10px] font-black uppercase tracking-[0.12em] text-apoyo">Tipos utilizados</p>
                    <span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-fondo-panel">
            ...
            <div class="flex flex-col justify-between overflow-hidden rounded-2xl border border-estado-advertenciaBorde bg-estado-advertenciaBg p-4 shadow-sm">
                <div class="flex items-start justify-between gap-2">
                    <p class="text-[10px] font-black uppercase tracking-[0.12em] text-estado-advertencia">Período</p>
                    <span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-estado-advertenciaBg">
                        <i class="ph-bold ph-calendar-dots text-xs text-estado-advertencia"></i>
                    </span>
                </div>
                <p class="mt-2 text-sm font-black leading-tight text-estado-advertencia">{{ $stats['periodo'] }}</p>
                    ...
                    <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-sm">
                        <div class="border-b border-borde-suave bg-fondo-panel px-5 py-3.5">
                            <div class="flex items-center gap-2">
                                ...
                                <h3 class="text-xs font-black uppercase tracking-[0.15em] text-titulo">Distribución por estado</h3>
                            </div>
                        </div>
                        <div class="space-y-3 p-5">
                            @foreach($chartEstado['data'] as $item)
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="w-8 shrink-0 text-right text-xs font-black text-titulo">{{ $item['total'] }}</span>
                                </div>
                            @endforeach
                        </div>
                    </section>
                    ...
                    <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-sm">
                        <div class="border-b border-borde-suave bg-fondo-panel px-5 py-3.5">
                            <div class="flex items-center gap-2">
                                ...
                                <h3 class="text-xs font-black uppercase tracking-[0.15em] text-titulo">
                                    Actividades por mes
                            ...
                            <div class="flex items-end gap-1.5 overflow-x-auto pb-2" style="min-height: 100px;">
                                @foreach($chartMes['data'] as $item)
                                    ...
                                    <div class="flex flex-1 min-w-[28px] flex-col items-center gap-1">
                                        <span class="text-[9px] font-black text-apoyo">{{ $item['total'] }}</span>
                                        <div
            ...
            <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-sm">
                <div class="border-b border-borde-suave bg-fondo-panel px-5 py-3.5">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-xs font-black uppercase tracking-[0.15em] text-titulo">Tipos más utilizados</h3>
                    </div>
                </div>
                <div class="space-y-2.5 p-5">
                    @foreach($chartTipo['data'] as $i => $item)
                        ...
                        @endphp
                        <div class="flex items-center gap-3">
                            <span class="w-5 shrink-0 text-center text-[10px] font-black text-apoyo">{{ $i + 1 }}</span>
        ...
        <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-md">
            <div class="flex items-center justify-between border-b border-borde-suave bg-fondo-panel px-5 py-3.5">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-xs font-black uppercase tracking-[0.15em] text-titulo">Vista previa</h2>
                    <span class="ml-1 rounded-full bg-fondo-panel px-2 py-0.5 text-[9px] font-black text-apoyo">Últimos 15 registros</span>
                </div>
                <a
                    href="{{ $urlPreview }}"
                    class="inline-flex items-center gap-1.5 text-[11px] font-black text-estado-advertencia hover:underline"
                >
                ...
                <table class="min-w-[700px] w-full border-collapse text-sm">
                    <thead>
                        <tr class="border-b border-borde-suave bg-fondo-panel">
                            <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Adulto mayor</th>
                            <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Tipo de actividad</th>
                            <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Fecha</th>
                            <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Hora</th>
                            <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Estado</th>
                            <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-[0.1em] text-apoyo">Observación</th>
                        </tr>
                    </thead>
                                ...
                                <td colspan="6" class="py-12 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        @if($buscar || $filtroTipo || $filtroEstado || $fechaDesde || $fechaHasta)
                                            <p class="text-sm font-black text-apoyo">No hay actividades para los filtros seleccionados.</p>
                                            <button wire:click="limpiarFiltros" class="text-xs font-black text-estado-advertencia hover:underline">Limpiar filtros</button>
                                        @else
                                            <p class="text-sm font-black text-apoyo">No hay actividades registradas.</p>
                                        @endif
                                    </div>
                                </td>
                            </tr>
        ...
        <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-sm">
            <div class="border-b border-borde-suave bg-fondo-panel px-5 py-3.5">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-xs font-black uppercase tracking-[0.15em] text-titulo">Reportes disponibles</h2>
                </div>
            </div>
            <div class="grid gap-4 p-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="flex flex-col gap-3 overflow-hidden rounded-2xl border border-borde-fuerte bg-fondo-panel p-4 shadow-sm">
                    ...
                    <div class="min-w-0">
                        <p class="text-xs font-black text-titulo">Reporte general</p>
                    ...
                    <div class="mt-auto flex flex-wrap gap-1.5">
                        <a href="{{ $urlPreview }}" class="rounded-lg border border-borde-suave px-2.5 py-1 text-[10px] font-black text-apoyo hover:bg-fondo-app">
                            <i class="ph-bold ph-eye mr-0.5"></i>Vista previa
                        </a>
                        @can('reportes.exportar_pdf')
                            <a href="{{ $urlPdf }}" class="rounded-lg border border-borde-focus bg-estado-peligroBg px-2.5 py-1 text-[10px] font-black text-boton-acento hover:bg-estado-peligroBg">
                                <i class="ph-bold ph-file-pdf mr-0.5"></i>PDF
                            </a>
                            <a href="{{ $urlExcel }}" class="rounded-lg border border-estado-exitoBorde bg-estado-exitoBg px-2.5 py-1 text-[10px] font-black text-estado-exito hover:bg-estado-exitoBg">
                ...
                <div class="flex flex-col gap-3 overflow-hidden rounded-2xl border border-estado-exitoBorde bg-fondo-panel p-4 shadow-sm">
                    ...
                    <div class="min-w-0">
                        <p class="text-xs font-black text-titulo">Participación</p>
                    ...
                    <div class="mt-auto flex flex-wrap gap-1.5">
                        ...
                        @endphp
                        <a href="{{ route('admin.reportes.actividades.preview', $filtrosConRealizada) }}" class="rounded-lg border border-borde-suave px-2.5 py-1 text-[10px] font-black text-apoyo hover:bg-fondo-app">
                            <i class="ph-bold ph-eye mr-0.5"></i>Vista previa
                        </a>
                        @can('reportes.exportar_pdf')
                            <a href="{{ route('admin.reportes.actividades.excel', $filtrosConRealizada) }}" class="rounded-lg border border-estado-exitoBorde bg-estado-exitoBg px-2.5 py-1 text-[10px] font-black text-estado-exito hover:bg-estado-exitoBg">
                                <i class="ph-bold ph-file-xls mr-0.5"></i>Excel
                            </a>
                        @endcan
                    </div>
                ...
                <div class="flex flex-col gap-3 overflow-hidden rounded-2xl border border-estado-advertenciaBorde bg-fondo-panel p-4 shadow-sm">
                    ...
                    <div class="min-w-0">
                        <p class="text-xs font-black text-titulo">Por tipo de actividad</p>
                    ...
                    <div class="mt-auto flex flex-wrap gap-1.5">
                        <a href="{{ route('admin.actividades.tipos') }}" class="rounded-lg border border-borde-suave px-2.5 py-1 text-[10px] font-black text-apoyo hover:bg-fondo-app">
                            <i class="ph-bold ph-list-bullets mr-0.5"></i>Ver tipos
                        </a>
                        @can('reportes.exportar_pdf')
                            <a href="{{ $urlExcel }}" class="rounded-lg border border-estado-advertenciaBorde bg-estado-advertenciaBg px-2.5 py-1 text-[10px] font-black text-estado-advertencia hover:bg-estado-advertenciaBg">
                                <i class="ph-bold ph-file-xls mr-0.5"></i>Excel
                            </a>
                        @endcan
                    </div>
                ...
                <div class="flex flex-col gap-3 overflow-hidden rounded-2xl border border-borde bg-fondo-panel p-4 shadow-sm">
                    ...
                    <div class="min-w-0">
                        <p class="text-xs font-black text-titulo">Cumplimiento</p>
                    ...
                    <div class="mt-auto flex flex-wrap gap-1.5">
                        <a href="{{ route('admin.actividades.asistencia') }}" class="rounded-lg border border-borde-suave px-2.5 py-1 text-[10px] font-black text-apoyo hover:bg-fondo-app">
                            <i class="ph-bold ph-clipboard-text mr-0.5"></i>Asistencia
                        </a>
                        @can('reportes.exportar_pdf')
                            <a href="{{ $urlPdf }}" class="rounded-lg border border-borde bg-fondo-panel px-2.5 py-1 text-[10px] font-black text-parrafo hover:bg-fondo-panel">
                                <i class="ph-bold ph-file-pdf mr-0.5"></i>PDF
                            </a>
                        @endcan
                    </div>
        ...
        <div class="flex items-start gap-3 rounded-2xl border border-borde-suave bg-fondo-panel p-4">
            ...
            <div class="min-w-0">
                <p class="text-[11px] font-black text-apoyo">Acerca de estos reportes</p>
