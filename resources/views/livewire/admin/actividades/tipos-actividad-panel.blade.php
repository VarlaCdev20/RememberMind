        ...
        <section class="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
            ...
            <article class="relative min-h-[105px] overflow-hidden rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(47,62,92,0.10)]">
                ...
                <div class="flex items-start justify-between gap-3">
                    <p class="text-[10px] font-black uppercase leading-snug tracking-[0.13em] text-apoyo">Total en catálogo</p>
            ...
            <article class="relative min-h-[105px] overflow-hidden rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(47,62,92,0.10)]">
                ...
                <div class="flex items-start justify-between gap-3">
                    <p class="text-[10px] font-black uppercase leading-snug tracking-[0.13em] text-apoyo">Tipos con actividades</p>
            ...
            <article class="relative min-h-[105px] overflow-hidden rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(47,62,92,0.10)]">
                ...
                <div class="flex items-start justify-between gap-3">
                    <p class="text-[10px] font-black uppercase leading-snug tracking-[0.13em] text-apoyo">Sin actividades</p>
            ...
            <article class="relative min-h-[105px] overflow-hidden rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(47,62,92,0.10)]">
                ...
                <div class="flex items-start justify-between gap-3">
                    <p class="text-[10px] font-black uppercase leading-snug tracking-[0.13em] text-apoyo">Actividades clasificadas</p>
            ...
            <article class="relative min-h-[105px] overflow-hidden rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(47,62,92,0.10)]">
                ...
                <div class="flex items-start justify-between gap-3">
                    <p class="text-[10px] font-black uppercase leading-snug tracking-[0.13em] text-apoyo">Tipo más utilizado</p>
            ...
            <article class="relative min-h-[105px] overflow-hidden rounded-2xl border border-borde-suave bg-fondo-panel p-4 shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(47,62,92,0.10)]">
                <div class="absolute inset-x-0 top-0 h-1 bg-fondo-panel"></div>
                <div class="flex items-start justify-between gap-3">
                    <p class="text-[10px] font-black uppercase leading-snug tracking-[0.13em] text-apoyo">Promedio por tipo</p>
        ...
        <section class="overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-sm backdrop-blur-xl">
            <div class="border-b border-borde-suave bg-fondo-panel px-5 py-3">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-[10px] font-black uppercase tracking-[0.15em] text-titulo">Filtros</span>
                </div>
            </div>
            <div class="p-4">
            ...
            <div class="border-b border-borde-suave bg-fondo-panel px-5 py-3.5">
                <div class="flex items-center justify-between gap-3">
                    <div class="flex items-center gap-2.5">
                        ...
                        <h2 class="text-sm font-black uppercase tracking-[0.15em] text-titulo">Catálogo de tipos</h2>
                    </div>
                                    ...
                                    <tr wire:key="tipo-{{ $tipo->cod_tipo_act }}" class="group transition hover:bg-fondo-panel">
                                        ...
                                        <td class="py-3 pr-4 text-center">
                                            @if($tipo->actividades_count > 0)
                                                <span class="inline-flex items-center rounded-full border border-estado-exitoBorde bg-estado-exitoBg px-2.5 py-0.5 text-[10px] font-black text-estado-exito">
                                                    {{ number_format($tipo->actividades_count) }}
                                                </span>
                                            @else
                                                <span class="inline-flex items-center rounded-full border border-borde-suave bg-fondo-panel px-2.5 py-0.5 text-[10px] font-black text-meta">
                                                    0
                                                </span>
                                            @endif
                                        </td>
                                        {{-- Estado --}}
                                        <td class="py-3 pr-4">
                                            <span class="inline-flex items-center rounded-full border border-estado-exitoBorde bg-estado-exitoBg px-2 py-0.5 text-[9px] font-black uppercase tracking-wide text-estado-exito">
                                                Activo
                                            </span>
                                        </td>
                                        {{-- Acciones --}}
            ...
            <div class="w-full max-w-lg overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-2xl">
                ...
                <div class="flex items-center justify-between border-b border-borde-suave bg-fondo-panel px-5 py-4">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            <p class="text-[10px] font-black uppercase tracking-[0.15em] text-apoyo">Catálogo</p>
                            <h3 class="text-sm font-black text-titulo">Registrar tipo de actividad</h3>
                        </div>
                    </div>
            ...
            <div class="w-full max-w-lg overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-2xl">
                ...
                <div class="flex items-center justify-between border-b border-borde-suave bg-fondo-panel px-5 py-4">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            <p class="text-[10px] font-black uppercase tracking-[0.15em] text-apoyo">Catálogo</p>
                            <h3 class="text-sm font-black text-titulo">Editar tipo #{{ $editandoId }}</h3>
                        </div>
                    </div>
                    <button wire:click="cerrarModales" class="flex h-8 w-8 items-center justify-center rounded-xl border border-borde-suave text-apoyo transition hover:border-borde-focus hover:text-boton-acento">
                        <i class="ph-bold ph-x text-sm"></i>
            ...
            <div class="w-full max-w-xl overflow-hidden rounded-[1.45rem] border border-borde-suave bg-fondo-panel shadow-2xl">
                ...
                <div class="flex items-center justify-between border-b border-borde-suave bg-fondo-panel px-5 py-4">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            <p class="text-[10px] font-black uppercase tracking-[0.15em] text-apoyo">Catálogo</p>
                            <h3 class="text-sm font-black text-titulo">Detalle del tipo</h3>
                        </div>
                    </div>
                    <button wire:click="cerrarModales" class="flex h-8 w-8 items-center justify-center rounded-xl border border-borde-suave text-apoyo transition hover:border-borde-focus hover:text-boton-acento">
                        <i class="ph-bold ph-x text-sm"></i>
                ...
                <div class="p-5 space-y-4">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <h4 class="mt-1 text-lg font-black text-titulo">{{ $detalle->tipo }}</h4>
                        </div>
                        <div class="flex shrink-0 flex-col items-end gap-1.5">
                            <span class="inline-flex items-center rounded-full border border-estado-exitoBorde bg-estado-exitoBg px-2.5 py-1 text-[9px] font-black uppercase tracking-wide text-estado-exito">
                                Activo
                            </span>
                    ...
                    <div class="rounded-xl border border-borde-suave bg-fondo-panel px-4 py-3">
                        <p class="text-[10px] font-black uppercase tracking-[0.13em] text-apoyo">Descripción</p>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel px-4 py-3 text-center">
                            <p class="text-[10px] font-black uppercase tracking-[0.13em] text-apoyo">Actividades asociadas</p>
                            <p class="mt-1 text-2xl font-black text-titulo">{{ number_format($detalle->actividades_count) }}</p>
                        </div>
                        <div class="rounded-xl border border-borde-suave bg-fondo-panel px-4 py-3 text-center">
                            <p class="text-[10px] font-black uppercase tracking-[0.13em] text-apoyo">Identificador visual</p>
                    ...
                    @if($detalle->actividades->isNotEmpty())
                        <div>
                            <p class="mb-2 text-[10px] font-black uppercase tracking-[0.13em] text-apoyo">
                                ...
                                @foreach($detalle->actividades as $act)
                                    ...
                                    <div class="flex items-center justify-between gap-3 rounded-xl border border-borde-suave bg-fondo-panel px-3 py-2">
                                        <div class="min-w-0 flex-1">
                                            <p class="truncate text-[10px] font-black text-titulo">
