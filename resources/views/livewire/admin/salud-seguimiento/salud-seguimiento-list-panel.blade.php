<div class="relative mx-auto max-w-7xl space-y-5 overflow-hidden rounded-[2rem] border border-borde/70 bg-fondo-panel p-3 text-parrafo shadow-[0_22px_70px_rgba(47,62,92,0.16)] backdrop-blur-xl sm:p-5 lg:p-6">
    ...
    <div class="relative z-10 space-y-5">
        @if($seccionActiva === 'resumen')
            ...
            <section class="overflow-hidden rounded-[1.75rem] border border-borde/80 bg-gradient-to-br from-[#E6DDD3]/95 via-[#F3ECE4]/92 to-[#D5C7B9]/85 shadow-[0_18px_46px_rgba(47,62,92,0.13)]">
                ...
                <div class="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
                    <div class="max-w-3xl">
                        <span class="inline-flex items-center gap-2 rounded-full border border-borde-focus bg-estado-peligroBg px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em] text-boton-acento">
                        ...
                        <div class="mt-4 flex flex-wrap gap-2">
                            @can('salud.ficha.crear')
                                <button wire:click="cambiarSeccion('ficha')" type="button" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-4 py-2.5 text-xs font-black uppercase tracking-wider text-inverso shadow-[0_10px_24px_rgba(226,125,96,0.25)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
                                    <i class="ph-bold ph-plus-circle text-sm"></i>
                                    Nuevo registro de salud
                                </button>
                            @endcan
                            <button wire:click="cambiarSeccion('reportes')" type="button" class="inline-flex items-center justify-center gap-2 rounded-xl border border-borde/80 bg-fondo-panel px-4 py-2.5 text-xs font-black uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-95">
                    ...
                    <div class="grid w-full grid-cols-2 gap-3 sm:grid-cols-3 xl:max-w-xl">
                        ...
                        @foreach($metricasHeader as $metrica)
                            <div class="relative overflow-hidden rounded-2xl border border-borde/55 {{ $metrica['bg'] }} p-3.5 shadow-sm backdrop-blur-md">
                                ...
                                <p class="pr-7 text-[10px] font-black uppercase leading-tight tracking-[0.12em] text-apoyo">{{ $metrica['label'] }}</p>
            ...
            <div class="flex min-w-max items-center gap-2">
                ...
                @foreach($tabs as $key => $tab)
                    <button
                        ...
                        type="button"
                        class="inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-xl border px-3.5 text-[11px] font-black uppercase tracking-wide transition active:scale-95 {{ $seccionActiva === $key ? 'border-borde-fuerte bg-boton-principal text-inverso shadow-[0_8px_18px_rgba(47,62,92,0.18)]' : 'border-transparent bg-fondo-panel text-parrafo/72 hover:border-borde/70 hover:bg-fondo-panel hover:text-boton-acento' }}"
                    >
            ...
            <section class="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
                <div class="space-y-5">
                    <div class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl">
                        <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-boton-acento">Resumen ejecutivo</span>
                                <h2 class="mt-1 text-xl font-black text-parrafo">Mapa operativo de salud</h2>
                            </div>
                            <span class="inline-flex items-center gap-2 rounded-full bg-fondo-panel px-3 py-1 text-[10px] font-black uppercase tracking-wider text-parrafo/65">
                            ...
                            @foreach([
                                ...
                                <div class="rounded-2xl border border-borde/45 bg-fondo-panel p-4">
                                    <div class="mb-3 flex items-center justify-between gap-2">
                                        <p class="text-[10px] font-black uppercase tracking-[0.12em] text-apoyo">{{ $barra['label'] }}</p>
                    ...
                    <div class="grid gap-5 xl:grid-cols-2">
                        <div class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl">
                            <div class="mb-4 flex items-center justify-between">
                                <h3 class="text-sm font-black uppercase tracking-wider text-parrafo">Ultimos controles</h3>
                            ...
                            <div class="space-y-3">
                                @forelse($resumenData['controlesRecientes'] as $control)
                                    <div class="flex items-center justify-between gap-3 rounded-2xl border border-borde/35 bg-fondo-panel px-3 py-3">
                                        <div class="min-w-0">
                                            <p class="truncate text-xs font-black text-parrafo">{{ $control->adultoMayor?->nombres }} {{ $control->adultoMayor?->ap_paterno }}</p>
                        ...
                        <div class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl">
                            <div class="mb-4 flex items-center justify-between">
                                <h3 class="text-sm font-black uppercase tracking-wider text-parrafo">Medicacion activa</h3>
                                ...
                                @forelse($resumenData['medicaciones'] as $med)
                                    <div class="rounded-2xl border border-borde/35 bg-fondo-panel px-3 py-3">
                                        <div class="flex items-start justify-between gap-3">
                                            <div class="min-w-0">
                                                <p class="truncate text-xs font-black text-parrafo">{{ $med->nombre_medicamento }}</p>
                                                <p class="mt-0.5 text-[10px] font-bold text-parrafo/55">{{ $med->adultoMayor?->nombres }} {{ $med->adultoMayor?->ap_paterno }}</p>
                                            </div>
                                            <span class="rounded-full bg-estado-exitoBg px-2 py-1 text-xs font-black uppercase text-estado-exito">Activo</span>
                                        </div>
                ...
                <aside class="space-y-5">
                    <div class="rounded-[1.6rem] border border-borde-focus bg-estado-peligroBg p-5 shadow-sm backdrop-blur-xl">
                        <div class="mb-4 flex items-center justify-between">
                            <div>
                                <span class="text-[10px] font-black uppercase tracking-[0.18em] text-boton-acento">Alertas</span>
                                <h3 class="mt-1 text-lg font-black text-parrafo">Prioridades preventivas</h3>
                            </div>
                        ...
                        <div class="space-y-3">
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="flex flex-wrap items-center gap-2">
                                                <p class="truncate text-xs font-black text-parrafo">{{ $alerta['titulo'] }}</p>
                                                <span class="rounded-full bg-fondo-panel px-2 py-0.5 text-[10px] font-black uppercase tracking-wide text-apoyo">{{ $alerta['tipo'] }}</span>
                                            </div>
                            ...
                            @empty
                                <div class="rounded-2xl border border-estado-exitoBorde bg-estado-exitoBg p-5 text-center">
                                    ...
                                    <p class="mt-2 text-xs font-black text-parrafo">Sin alertas pendientes</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <div class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl">
                        <h3 class="text-sm font-black uppercase tracking-wider text-parrafo">Accesos rapidos</h3>
                        <div class="mt-4 grid grid-cols-2 gap-2">
                            @foreach([
                                ...
                                <button wire:click="cambiarSeccion('{{ $atajo['key'] }}')" type="button" class="group rounded-2xl border border-borde/45 bg-fondo-panel px-3 py-3 text-left transition hover:-translate-y-0.5 hover:border-borde-focus hover:bg-fondo-panel">
                                    ...
                                    <p class="mt-2 text-xs font-black uppercase leading-tight tracking-wide text-parrafo">{{ $atajo['label'] }}</p>
                                </button>
                            @endforeach
                        </div>
                    </div>
        ...
        @else
            ...
            <div class="mb-2">
                <button wire:click="cambiarSeccion('resumen')" class="inline-flex items-center gap-2 rounded-xl bg-fondo-panel px-4 py-2.5 text-xs font-black uppercase tracking-wider text-parrafo transition-all hover:bg-fondo-panel hover:shadow-sm">
            ...
            <section class="space-y-5 animate-in fade-in duration-200">
                <div class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-4 shadow-sm backdrop-blur-xl sm:p-5">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div class="max-w-2xl">
                            <span class="text-xs font-black uppercase tracking-[0.15em] text-boton-acento">{{ $contexto['titulo'] }}</span>
                            <h2 class="mt-1 text-xl font-black text-parrafo">Seleccionar expediente</h2>
                        ...
                        <div class="grid w-full gap-3 sm:grid-cols-[1fr_auto] lg:max-w-xl">
                            <label class="relative block">
                                <span class="mb-1.5 block text-[10px] font-black uppercase tracking-widest text-parrafo/55">Buscar adulto mayor</span>
                            ...
                            <div class="flex items-end">
                                <button type="button" wire:click="$refresh" class="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-borde/70 bg-fondo-panel px-4 text-xs font-black uppercase tracking-wider text-parrafo transition hover:bg-fondo-panel active:scale-95">
                ...
                <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <article class="group relative overflow-hidden rounded-[1.55rem] border border-borde bg-fondo-panel shadow-sm backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-borde-focus hover:shadow-[0_18px_38px_rgba(47,62,92,0.14)]">
                            ...
                            <div class="relative bg-gradient-to-b from-[#D5C7B9]/72 to-[#E6DDD3]/30 px-5 pb-5 pt-4 text-center">
                                <div class="mb-3 flex items-center justify-between gap-2">
                                    ...
                                    <span class="rounded-full border border-borde/45 bg-fondo-panel px-2.5 py-1 text-xs font-black uppercase tracking-wide text-parrafo/55">{{ $adulto->cod_am }}</span>
                                </div>
                                ...
                                <div class="mx-auto h-20 w-20 overflow-hidden rounded-2xl border-[4px] border-borde bg-boton-principal shadow-md transition group-hover:scale-105">
                                    ...
                                    @else
                                        <div class="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#2F3E5C] to-[#5B5F97] text-xl font-black text-inverso">
                                            {{ substr($adulto->nombres, 0, 1) }}{{ substr($adulto->ap_paterno, 0, 1) }}
                                        </div>
                                    @endif
                                </div>
                                <h3 class="mt-3 text-base font-black leading-tight text-parrafo">{{ $adulto->nombres }}</h3>
                            ...
                            <div class="space-y-3 px-5 py-4">
                                <div class="grid grid-cols-2 gap-2">
                                    <div class="rounded-xl border border-borde/35 bg-fondo-panel px-3 py-2">
                                        <p class="text-[10px] font-black uppercase tracking-wide text-parrafo/55">Edad</p>
                                        <p class="mt-0.5 text-xs font-black text-parrafo">{{ $edad }}</p>
                                    </div>
                                    <div class="rounded-xl border border-borde/35 bg-fondo-panel px-3 py-2">
                                        <p class="text-[10px] font-black uppercase tracking-wide text-parrafo/55">C.I.</p>
                                        <p class="mt-0.5 truncate text-xs font-black text-parrafo">{{ $adulto->ci ?: 'S/D' }}</p>
                                    </div>
                                </div>
                                ...
                                @if($seccionActiva === 'ficha')
                                    <div class="rounded-2xl border border-borde/35 bg-fondo-panel p-3">
                                        <div class="flex items-center justify-between gap-2">
                                            <span class="text-[10px] font-black uppercase tracking-wide text-apoyo">Estado de ficha</span>
                                            <span class="rounded-full px-2.5 py-0.5 text-xs font-black uppercase {{ $ficha ? 'bg-estado-exitoBg text-estado-exito' : 'bg-estado-peligroBg text-boton-acento' }}">{{ $ficha ? 'Registrada' : 'Pendiente' }}</span>
                                        </div>
                                ...
                                @elseif($seccionActiva === 'signos')
                                    <div class="grid grid-cols-3 gap-2 text-center">
                                        <div class="rounded-xl bg-fondo-panel px-2 py-2">
                                            <p class="text-[10px] font-black uppercase text-parrafo/55">P.A.</p>
                                            <p class="text-xs font-black text-parrafo">{{ $signo?->presion_formateada ?? 'S/D' }}</p>
                                        </div>
                                        <div class="rounded-xl bg-fondo-panel px-2 py-2">
                                            <p class="text-[10px] font-black uppercase text-parrafo/55">Temp.</p>
                                            <p class="text-xs font-black text-boton-acento">{{ $signo?->temperatura ? number_format($signo->temperatura, 1) . 'C' : 'S/D' }}</p>
                                        </div>
                                        <div class="rounded-xl bg-fondo-panel px-2 py-2">
                                            <p class="text-[10px] font-black uppercase text-parrafo/55">SpO2</p>
                                            <p class="text-xs font-black text-estado-exito">{{ $signo?->saturacion !== null ? $signo->saturacion . '%' : 'S/D' }}</p>
                                        </div>
                                    </div>
                                @elseif($seccionActiva === 'valoracion')
                                    <div class="rounded-2xl border border-borde/35 bg-fondo-panel p-3">
                                        <div class="flex items-center justify-between gap-2">
                                            <span class="text-[10px] font-black uppercase tracking-wide text-apoyo">Dependencia</span>
                                            <span class="rounded-full bg-fondo-panel px-2.5 py-0.5 text-xs font-black uppercase text-parrafo">{{ $valoracion?->nivel_dependencia ?? 'Sin dato' }}</span>
                                        </div>
                                ...
                                @else
                                    <div class="rounded-2xl border border-borde/35 bg-fondo-panel p-3">
                                        <div class="flex items-center justify-between gap-2">
                                            <span class="text-[10px] font-black uppercase tracking-wide text-apoyo">Tratamientos activos</span>
                                            <span class="rounded-full bg-estado-exitoBg px-2.5 py-0.5 text-xs font-black uppercase text-estado-exito">{{ $medicacionesActivas }}</span>
                                        </div>
                            ...
                            <div class="border-t border-borde/35 bg-fondo-panel p-4">
                                <button wire:click="abrirExpediente('{{ $adulto->cod_am }}')" type="button" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-boton-principal px-4 py-2.5 text-xs font-black uppercase tracking-wider text-inverso shadow-[0_8px_18px_rgba(47,62,92,0.18)] transition hover:bg-fondo-panel active:scale-95">
                    ...
                    @empty
                        <div class="col-span-full rounded-[1.6rem] border border-dashed border-borde/70 bg-fondo-panel p-12 text-center shadow-inner">
                            ...
                            <h3 class="mt-3 text-base font-black text-parrafo">No se encontraron expedientes</h3>
                ...
                <div class="relative z-10 flex items-center justify-between border-b border-borde bg-fondo-panel px-5 py-4 backdrop-blur-xl sm:px-7">
                    <div class="flex min-w-0 items-center gap-4">
                        <div class="h-12 w-12 shrink-0 overflow-hidden rounded-2xl border-[3px] border-borde bg-boton-principal shadow-sm">
                            ...
                            @else
                                <div class="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#2F3E5C] to-[#5B5F97] text-sm font-black text-inverso">
                                    {{ substr($adultoSeleccionadoParaModal->nombres, 0, 1) }}{{ substr($adultoSeleccionadoParaModal->ap_paterno, 0, 1) }}
                                </div>
                            @endif
                        </div>
                        <div class="min-w-0">
                            <span class="inline-flex items-center gap-1.5 rounded-full bg-estado-peligroBg px-2.5 py-1 text-[9px] font-black uppercase tracking-wider text-boton-acento">
                                <i class="ph-bold {{ $contexto['icono'] }}"></i>
                                {{ $contexto['titulo'] }}
                            </span>
                            <h2 class="mt-1 truncate text-lg font-black text-parrafo">
