<div class="salud-resumen-scope space-y-6 animate-[fadeIn_0.3s_ease-out]">
    ...
    <section class="overflow-hidden rounded-[1.6rem] border border-borde/65 bg-fondo-panel shadow-sm backdrop-blur-xl">
        ...
        <div class="p-5">
            <span class="text-[10px] font-black uppercase tracking-[0.2em] text-boton-acento">Resumen individual</span>
            <h2 class="mt-1 text-xl font-black tracking-tight text-parrafo">Panel clínico-asistencial</h2>
            ...
            <div class="lg:col-span-4 space-y-5">
                ...
                <div class="overflow-hidden rounded-2xl border border-borde-suave bg-fondo-card shadow-sm">
                    ...
                    <div class="relative px-5 pb-5 pt-10 flex flex-col items-center">
                        ...
                        <h2 class="text-base font-black text-titulo text-center leading-tight">
                ...
                <div class="rounded-2xl border border-borde-suave bg-fondo-card p-5 shadow-sm">
                    <div class="flex items-center gap-2 mb-4 border-b border-borde-suave pb-3">
                        ...
                        <h3 class="text-xs font-black uppercase tracking-widest text-titulo">
                            Alertas de Seguimiento
                        </h3>
                        @if(count($alertas) > 0)
                            <span class="ml-auto rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-black text-estado-advertencia">
                                {{ count($alertas) }}
                            </span>
                        @endif
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <div class="rounded-xl bg-emerald-50 border border-emerald-100 p-3 text-center">
                                ...
                                <p class="text-xs font-black text-estado-exito">Sin alertas de seguimiento activas</p>
                            </div>
                        @endforelse
                ...
                <div class="rounded-2xl border border-borde-suave bg-fondo-panel p-5 shadow-sm">
                    <h3 class="text-xs font-black uppercase tracking-widest text-titulo mb-3 border-b border-borde-suave pb-3">
                        Acciones Rápidas
                    </h3>
                    ...
                    <div class="mt-4 pt-3 border-t border-borde-suave space-y-1.5">
                        <p class="text-[10px] font-black uppercase tracking-widest text-meta mb-2">
                            Historial Complementario
                        </p>
            ...
            <div class="lg:col-span-8 space-y-5">
                ...
                <div class="rounded-2xl border border-borde-suave bg-fondo-card shadow-sm overflow-hidden">
                    <div class="bg-boton-principal px-5 py-3.5 flex items-center justify-between">
                        <h3 class="text-sm font-black uppercase tracking-wider text-inverso flex items-center gap-2">
                            <i class="ph-bold ph-file-text text-boton-acento text-base"></i>
                            Ficha Médica Base
                        </h3>
                        @can('salud.ficha.ver')
                        <a href="{{ route('admin.salud-seguimiento.ficha', $adulto) }}"
                           class="rounded-lg bg-fondo-card/10 px-3 py-1.5 text-xs font-black text-inverso hover:bg-fondo-card/20 transition-colors">
                            Gestionar Ficha
                        </a>
                        @endcan
                    </div>
                    <div class="p-5">
                        @if($fichaMedica)
                            <div class="grid gap-5 md:grid-cols-2">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        <p class="text-[10px] font-black uppercase tracking-widest text-meta mb-1">Alergias</p>
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black uppercase tracking-widest text-meta mb-1">Observación Médica</p>
                                        <p class="text-xs font-bold text-titulo bg-fondo-panel px-3 py-2 rounded-lg border border-borde-suave">
                        ...
                        @else
                            <div class="py-6 text-center">
                                ...
                                <p class="text-sm font-black text-meta">Sin ficha médica activa registrada</p>
                                @can('salud.ficha.crear')
                                <a href="{{ route('admin.salud-seguimiento.ficha', $adulto) }}"
                                   class="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-boton-principal px-3 py-1.5 text-xs font-black text-inverso hover:opacity-90 transition-opacity">
                ...
                <div class="rounded-2xl border border-borde-suave bg-fondo-card shadow-sm overflow-hidden">
                    <div class="bg-boton-principal px-5 py-3.5 flex items-center justify-between">
                        <h3 class="text-sm font-black uppercase tracking-wider text-inverso flex items-center gap-2">
                            ...
                            @if($medicacionActiva->isNotEmpty())
                                <span class="rounded-full bg-fondo-card/15 px-2 py-0.5 text-[10px] font-black">
                    ...
                    <div>
                        <table class="w-full text-left text-xs text-titulo">
                            <thead class="bg-fondo-panel text-[10px] font-black uppercase text-apoyo">
                                <tr>
                                ...
                                @forelse($medicacionActiva->take(5) as $med)
                                    <tr class="hover:bg-fondo-panel/50 transition-colors">
                                        ...
                                        <td class="px-5 py-3 text-right">
                                            <span class="rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-black uppercase text-estado-exito">
                                                Activo
                                            </span>
                                        </td>
                                    </tr>
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div class="rounded-2xl border border-borde-suave bg-fondo-card shadow-sm overflow-hidden">
                        <div class="bg-boton-principal px-5 py-3.5 flex items-center justify-between">
                            <h3 class="text-xs font-black uppercase tracking-wider text-inverso flex items-center gap-2">
                                <i class="ph-bold ph-activity text-boton-acento text-sm"></i>
                                Últimos Signos Vitales
                            </h3>
                            @can('salud.signos.ver')
                            <a href="{{ route('admin.salud-seguimiento.signos', $adulto) }}"
                               class="rounded-lg bg-fondo-card/10 px-2 py-1 text-[10px] font-black uppercase text-inverso hover:bg-fondo-card/20 transition-colors"
                        ...
                        <div class="p-5">
                            @if($ultimoSigno)
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center border border-borde-suave">
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">P. Arterial</p>
                                        <p class="mt-1 text-base font-black text-titulo leading-tight">
                                            {{ $ultimoSigno->presion_arterial ?? '—' }}
                                        </p>
                                        <p class="text-[9px] text-meta">mmHg</p>
                                    </div>
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center border border-borde-suave">
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">F. Cardíaca</p>
                                        <p class="mt-1 text-base font-black text-boton-acento leading-tight">
                                            {{ $ultimoSigno->frecuencia_cardiaca ?? '—' }}
                                        </p>
                                        <p class="text-[9px] text-meta">bpm</p>
                                    </div>
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center border border-borde-suave">
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Saturación</p>
                                    ...
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center border border-borde-suave">
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Temperatura</p>
                                        <p class="mt-1 text-base font-black text-estado-advertencia leading-tight">
                                    ...
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center border border-borde-suave">
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">Peso</p>
                                        <p class="mt-1 text-base font-black text-titulo leading-tight">
                                            {{ $ultimoSigno->peso !== null ? $ultimoSigno->peso . ' kg' : '—' }}
                                        </p>
                                    </div>
                                    <div class="rounded-xl bg-fondo-panel p-3 text-center border border-borde-suave">
                                        <p class="text-[9px] font-black uppercase tracking-widest text-meta">IMC</p>
                                        <p class="mt-1 text-base font-black text-titulo leading-tight">
                            ...
                            @else
                                <div class="py-8 text-center">
                                    ...
                                    <p class="text-xs font-black text-meta">Sin registros de signos vitales</p>
                        ...
                        <div class="p-5">
                            @if($valoracionFuncional)
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between">
                                        <p class="text-[10px] font-black uppercase tracking-widest text-meta">Riesgo de Caída</p>
                                        <span class="rounded-full border px-3 py-0.5 text-xs font-black uppercase {{ $riesgoBadge }}">
                                            {{ $valoracionFuncional->riesgo_caida ?? '—' }}
                                        </span>
                                    </div>
                                    <div>
                                        <p class="text-[10px] font-black uppercase tracking-widest text-meta mb-1">Nivel de Dependencia</p>
                                    ...
                                    <div class="bg-fondo-panel rounded-xl p-3 border border-borde-suave">
                                        <div class="flex items-center justify-between mb-1">
                                            <p class="text-[10px] font-black uppercase tracking-widest text-meta">Índice de Barthel</p>
                                            <span class="text-lg font-black text-titulo">{{ $barthel }}<span class="text-xs text-meta">/100</span></span>
                                        </div>
                                        @if($barthelTexto)
                            ...
                            @else
                                <div class="py-8 text-center">
                                    ...
                                    <p class="text-xs font-black text-meta">Sin valoración funcional vigente</p>
                ...
                <div class="grid gap-5 md:grid-cols-3">
                    ...
                    <div class="rounded-2xl border border-borde-suave bg-fondo-card shadow-sm overflow-hidden">
                        <div class="bg-fondo-panel px-4 py-3 flex items-center justify-between">
                            <h3 class="text-xs font-black uppercase tracking-wider text-inverso flex items-center gap-1.5">
                                <i class="ph-bold ph-stethoscope text-sm"></i>
                                Atenciones
                            </h3>
                            <a href="{{ route('admin.adultos-mayores.atenciones.index', $adulto) }}"
                               class="text-inverso/70 hover:text-inverso transition-colors text-[10px] font-black">
                                Ver todas →
                            </a>
                        </div>
                        <div class="p-4">
                            @forelse($atenciones as $atencion)
                                <div class="mb-3 pb-3 border-b border-borde-suave last:mb-0 last:pb-0 last:border-0">
                                    <p class="text-[10px] font-black text-meta uppercase tracking-wide">
