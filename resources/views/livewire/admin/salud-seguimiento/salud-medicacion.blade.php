<div class="space-y-6" x-data>
 ...
 <div>
 <h2 class="text-xl font-extrabold tracking-tight text-parrafo">Medicación</h2>
 ...
 <button type="button" @click="$dispatch('abrirModalMedicacion', { cod_am: '{{ $adulto ? $adulto->cod_am : '' }}' })" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-inverso shadow-[0_10px_22px_rgba(226,125,96,0.24)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
 ...
 <p class="pr-7 text-[9px] font-bold uppercase tracking-[0.15em] text-parrafo/55">{{ $item['label'] }}</p>
 ...
 <div>
 <h3 class="text-sm font-bold text-parrafo">{{ $adulto->nombres }} {{ $adulto->ap_paterno }}</h3>
 <span class="inline-block mt-0.5 rounded bg-fondo-panel px-2 py-0.5 text-[9px] font-bold uppercase text-apoyo">ID: {{ $adulto->cod_am }}</span>
 </div>
 </div>
 ...
 <h3 class="mb-3 text-[10px] font-bold uppercase tracking-widest text-boton-acento flex items-center gap-1.5">
 ...
 <div>
 <h3 class="text-sm font-bold uppercase tracking-wider text-parrafo">Filtros de Búsqueda</h3>
 </div>
 ...
 <div>
 <label class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-parrafo/55">Medicamento</label>
 <div class="relative">
 ...
 <div>
 <label class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-parrafo/55">Estado</label>
 <div class="relative">
 ...
 <div>
 <label class="mb-1.5 block text-[9px] font-bold uppercase tracking-widest text-parrafo/55">Vía</label>
 <div class="relative">
 ...
 <h3 class="text-sm font-bold uppercase tracking-wider text-parrafo">
 @if($adulto) 
 ...
 <span class="inline-flex w-max items-center gap-2 rounded-full bg-fondo-panel px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-parrafo/65">
 ...
 <h3 class="mt-3 text-base font-extrabold text-parrafo">No se encontraron medicamentos</h3>
 ...
 @if(!$adulto)
 <td class="px-5 py-4">
 <p class="text-xs font-bold text-parrafo">{{ $med->adultoMayor->nombres ?? 'S/D' }}</p>
 <p class="mt-0.5 text-[9px] font-bold text-meta uppercase">{{ $med->adultoMayor->cod_am ?? '' }}</p>
 </td>
 @endif
 <td class="px-5 py-4">
 <p class="text-xs font-bold text-parrafo">{{ $med->nombre_medicamento }}</p>
 ...
 <td class="px-5 py-4">
 <p class="text-xs font-bold text-parrafo">{{ $med->dosis ?: 'S/D' }}</p>
 ...
 <td class="px-5 py-4">
 <span class="rounded-full border px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider inline-flex items-center gap-1 {{ $estadoClases }}">
 ...
 @if($estado === 'ACTIVO')
 <button type="button" @click="$dispatch('abrirModalAdministracion', { cod_am: '{{ $med->cod_am }}', cod_med_adulto: {{ $med->cod_med_adulto }} })" class="inline-flex items-center gap-1.5 rounded-lg bg-estado-exitoBg px-2.5 py-1.5 text-[9px] font-bold uppercase text-inverso shadow-sm transition hover:bg-fondo-panel active:scale-95" title="Registrar toma">
 ...
 confirmButton: 'rounded-xl text-sm font-bold uppercase',
 cancelButton: 'rounded-xl text-sm font-bold uppercase text-parrafo'
 }
 }).then((result) => {
