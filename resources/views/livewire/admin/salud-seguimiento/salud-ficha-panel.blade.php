<div class="relative mx-auto max-w-7xl space-y-5 p-3 sm:p-5 lg:p-6">
    <div class="mb-2">
        <a href="{{ route('admin.salud-seguimiento.ficha.index') }}" class="inline-flex items-center gap-2 rounded-xl bg-fondo-panel px-4 py-2.5 text-[10px] font-black uppercase tracking-wider text-parrafo transition-all hover:bg-fondo-panel hover:shadow-sm">
    ...
    <section class="overflow-hidden rounded-[1.6rem] border border-borde/65 bg-fondo-panel shadow-sm backdrop-blur-xl">
        ...
        <div class="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-xl font-black tracking-tight text-parrafo">Ficha Médica</h2>
                ...
                @if($adulto)
                    @if(!$fichaActiva)
                        @can('salud.ficha.crear')
                            <button wire:click="openModalGeneral" type="button" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-5 py-2.5 text-[11px] font-black uppercase tracking-wider text-inverso shadow-[0_10px_22px_rgba(226,125,96,0.24)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
                                <i class="ph-bold ph-plus-circle text-sm"></i> Registrar Ficha Médica
                            </button>
                        @endcan
                    @else
                        @can('salud.ficha.editar')
                            <button wire:click="openModalAntecedentes" type="button" class="inline-flex items-center justify-center gap-2 rounded-xl border border-borde bg-fondo-card px-4 py-2 text-[10px] font-black uppercase tracking-wider text-parrafo transition hover:bg-fondo-app active:scale-95">
                                <i class="ph-bold ph-activity text-sm"></i> Agregar Antecedente
                            </button>
                            <button wire:click="openModalAlergias" type="button" class="inline-flex items-center justify-center gap-2 rounded-xl border border-borde bg-fondo-card px-4 py-2 text-[10px] font-black uppercase tracking-wider text-parrafo transition hover:bg-fondo-app active:scale-95">
    ...
    <section class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-4 shadow-sm backdrop-blur-xl">
        ...
        <div class="grid gap-3 md:grid-cols-[1fr_1fr_auto]">
            ...
            <div>
                <button wire:click="buscarPacienteAction" type="button" class="inline-flex h-full w-full items-center justify-center gap-2 rounded-xl bg-boton-principal px-6 text-[11px] font-black uppercase tracking-wider text-inverso shadow-sm transition hover:bg-fondo-panel active:scale-95">
    ...
    @if($adulto)
            ...
            <div class="space-y-4">
                <section class="rounded-[1.6rem] border border-estado-exitoBorde bg-estado-exitoBg p-4 shadow-sm backdrop-blur-xl relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="h-12 w-12 shrink-0 overflow-hidden rounded-xl border-2 border-borde-suave bg-boton-principal shadow-sm">
                            ...
                            @else
                                <div class="flex h-full w-full items-center justify-center text-lg font-black text-inverso">
                                    {{ strtoupper(substr($adulto->nombres, 0, 1)) }}
                                </div>
                            @endif
                        </div>
                        <div>
                            <h3 class="text-sm font-black text-parrafo">{{ trim("{$adulto->nombres} {$adulto->ap_paterno} {$adulto->ap_materno}") }}</h3>
                ...
                <section class="rounded-[1.6rem] border {{ $fichaActiva ? 'border-estado-exitoBorde bg-fondo-panel' : 'border-borde bg-fondo-app' }} p-5 shadow-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[9px] font-black uppercase tracking-widest text-meta">Estado Clínico</p>
                            @if($fichaActiva)
                                <h4 class="text-sm font-black text-estado-exito">Ficha registrada</h4>
                                <p class="text-[10px] font-bold text-apoyo mt-1">Actualizada: {{ $fichaActiva->updated_at?->format('d/m/Y') }}</p>
                            @else
                                <h4 class="text-sm font-black text-parrafo">Sin ficha médica</h4>
                ...
                <section class="rounded-[1.6rem] border border-borde/45 bg-fondo-panel p-4 shadow-sm">
                    <h4 class="mb-3 text-[10px] font-black uppercase tracking-[0.18em] text-apoyo">Accesos Relacionados</h4>
                    <div class="flex flex-col gap-2">
                        <a href="{{ route('admin.salud-seguimiento.medicacion', $adulto->cod_am) }}" class="inline-flex items-center gap-2 rounded-xl border border-borde-suave bg-fondo-card px-3 py-2 text-[10px] font-black uppercase tracking-wider text-parrafo transition hover:bg-fondo-app">
                            <i class="ph-bold ph-pills text-boton-acento"></i> Ver medicación
                        </a>
                        <a href="{{ route('admin.salud-seguimiento.signos', $adulto->cod_am) }}" class="inline-flex items-center gap-2 rounded-xl border border-borde-suave bg-fondo-card px-3 py-2 text-[10px] font-black uppercase tracking-wider text-parrafo transition hover:bg-fondo-app">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                    <div class="rounded-2xl border border-borde/45 bg-fondo-panel p-3 shadow-sm flex flex-col justify-between h-full">
                        ...
                        <div class="mt-2">
                            <p class="text-[9px] font-black uppercase tracking-[0.1em] text-meta">Alergias</p>
                            <p class="text-xs font-black text-parrafo truncate">{{ $fichaActiva?->alergias ? 'Registradas' : 'Ninguna' }}</p>
                        </div>
                    </div>
                    <div class="rounded-2xl border border-borde/45 bg-fondo-panel p-3 shadow-sm flex flex-col justify-between h-full">
                        <div class="flex items-start justify-between">
                        ...
                        <div class="mt-2">
                            <p class="text-[9px] font-black uppercase tracking-[0.1em] text-meta">Condiciones</p>
                            <p class="text-xs font-black text-parrafo truncate">{{ $patologiasActivas->count() }} registradas</p>
                        </div>
                    </div>
                    <div class="rounded-2xl border border-borde/45 bg-fondo-panel p-3 shadow-sm flex flex-col justify-between h-full">
                        <div class="flex items-start justify-between">
                        ...
                        <div class="mt-2">
                            <p class="text-[9px] font-black uppercase tracking-[0.1em] text-meta">Antecedentes</p>
                            <p class="text-xs font-black text-parrafo truncate">Quirúrgicos / Hosp.</p>
                        </div>
                    </div>
                    <div class="rounded-2xl border border-borde/45 bg-fondo-panel p-3 shadow-sm flex flex-col justify-between h-full">
                        <div class="flex items-start justify-between">
                        ...
                        <div class="mt-2">
                            <p class="text-[9px] font-black uppercase tracking-[0.1em] text-meta">Dieta / Cuidados</p>
                            <p class="text-xs font-black text-parrafo truncate">{{ $fichaActiva?->restricciones_alimentarias ? 'Especial' : 'Ninguno' }}</p>
                        </div>
                    </div>
                </div>
                ...
                @if($fichaActiva)
                    ...
                    <div x-data="{ tab: 'resumen' }" class="rounded-[1.6rem] border border-borde/65 bg-fondo-panel p-5 shadow-sm backdrop-blur-xl min-h-[400px]">
                        ...
                        <nav class="flex flex-wrap gap-2 mb-6 border-b border-borde/35 pb-4">
                            <button @click="tab = 'resumen'" :class="tab === 'resumen' ? 'bg-boton-principal text-inverso shadow-sm' : 'bg-transparent text-apoyo hover:bg-fondo-panel'" class="rounded-xl px-3 py-1.5 text-[10px] font-black uppercase tracking-wider transition">Resumen Base</button>
                            <button @click="tab = 'datos'" :class="tab === 'datos' ? 'bg-boton-principal text-inverso shadow-sm' : 'bg-transparent text-apoyo hover:bg-fondo-panel'" class="rounded-xl px-3 py-1.5 text-[10px] font-black uppercase tracking-wider transition">Datos Generales</button>
                            <button @click="tab = 'antecedentes'" :class="tab === 'antecedentes' ? 'bg-boton-principal text-inverso shadow-sm' : 'bg-transparent text-apoyo hover:bg-fondo-panel'" class="rounded-xl px-3 py-1.5 text-[10px] font-black uppercase tracking-wider transition">Antecedentes</button>
                            <button @click="tab = 'alergias'" :class="tab === 'alergias' ? 'bg-boton-principal text-inverso shadow-sm' : 'bg-transparent text-apoyo hover:bg-fondo-panel'" class="rounded-xl px-3 py-1.5 text-[10px] font-black uppercase tracking-wider transition">Alergias</button>
                            <button @click="tab = 'condiciones'" :class="tab === 'condiciones' ? 'bg-boton-principal text-inverso shadow-sm' : 'bg-transparent text-apoyo hover:bg-fondo-panel'" class="rounded-xl px-3 py-1.5 text-[10px] font-black uppercase tracking-wider transition">Condiciones</button>
                            <button @click="tab = 'restricciones'" :class="tab === 'restricciones' ? 'bg-boton-principal text-inverso shadow-sm' : 'bg-transparent text-apoyo hover:bg-fondo-panel'" class="rounded-xl px-3 py-1.5 text-[10px] font-black uppercase tracking-wider transition">Cuidados & Restr.</button>
                            <button @click="tab = 'observaciones'" :class="tab === 'observaciones' ? 'bg-boton-principal text-inverso shadow-sm' : 'bg-transparent text-apoyo hover:bg-fondo-panel'" class="rounded-xl px-3 py-1.5 text-[10px] font-black uppercase tracking-wider transition">Observaciones</button>
                        </nav>

                        {{-- A. Resumen Médico --}}
                        <div x-show="tab === 'resumen'" x-transition.opacity.duration.300ms>
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-sm font-black uppercase tracking-wider text-estado-exito">Resumen Médico</h3>
                                @can('salud.ficha.editar')
                                    <button wire:click="openModalGeneral" type="button" class="text-[10px] font-black uppercase tracking-wider text-boton-acento hover:underline">
                        ...
                        <div x-show="tab === 'datos'" x-transition.opacity.duration.300ms style="display: none;">
                            <h3 class="text-sm font-black uppercase tracking-wider text-estado-exito mb-4">Datos Clínicos Generales</h3>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="rounded-xl border border-borde/45 bg-fondo-panel p-4 flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-base font-black text-parrafo">{{ $adulto->grupo_sanguineo ?? 'No registrado' }}</p>
                                    </div>
                                </div>
                                <div class="rounded-xl border border-borde/45 bg-fondo-panel p-4 flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-base font-black text-parrafo">{{ $adulto->factor_rh ?? 'No registrado' }}</p>
                                    </div>
                                </div>
                        ...
                        <div x-show="tab === 'antecedentes'" x-transition.opacity.duration.300ms style="display: none;">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-sm font-black uppercase tracking-wider text-estado-exito">Antecedentes Quirúrgicos e Hospitalarios</h3>
                                @can('salud.ficha.editar')
                                    <button wire:click="openModalAntecedentes" type="button" class="text-[10px] font-black uppercase tracking-wider text-boton-acento hover:underline">
                                        Editar Antecedentes
                                    </button>
                                @endcan
                            </div>
                        ...
                        <div x-show="tab === 'alergias'" x-transition.opacity.duration.300ms style="display: none;">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-sm font-black uppercase tracking-wider text-estado-exito">Alergias Registradas</h3>
                                @can('salud.ficha.editar')
                                    <button wire:click="openModalAlergias" type="button" class="text-[10px] font-black uppercase tracking-wider text-boton-acento hover:underline">
                                        Editar Alergias
                                    </button>
                                @endcan
                            </div>
                        ...
                        <div x-show="tab === 'condiciones'" x-transition.opacity.duration.300ms style="display: none;">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-sm font-black uppercase tracking-wider text-estado-exito">Condiciones Médicas</h3>
                                @can('salud.ficha.editar')
                                    <button wire:click="openModalCondiciones" type="button" class="text-[10px] font-black uppercase tracking-wider text-boton-acento hover:underline">
                                        Editar Condiciones
                                    </button>
                                @endcan
                            </div>
                            <div class="rounded-xl border border-borde/45 bg-fondo-panel p-5">
                                <div class="flex flex-wrap gap-2.5">
                                    @forelse($patologiasActivas as $pat)
                                        <span class="inline-flex items-center gap-1.5 rounded-xl border border-borde-focus bg-estado-peligroBg px-3 py-2 text-[11px] font-black uppercase tracking-wider text-boton-acento shadow-sm">
                                            <i class="ph-bold {{ $pat['icon'] }}"></i>
                                            {{ $pat['label'] }}
                                        </span>
                                    @empty
                                        <span class="inline-flex items-center gap-1.5 rounded-xl border border-borde/45 bg-fondo-panel px-4 py-3 text-[11px] font-black uppercase tracking-wider text-meta">
                        ...
                        <div x-show="tab === 'restricciones'" x-transition.opacity.duration.300ms style="display: none;">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-sm font-black uppercase tracking-wider text-estado-exito">Restricciones y Cuidados</h3>
                                @can('salud.ficha.editar')
                                    <button wire:click="openModalObservaciones" type="button" class="text-[10px] font-black uppercase tracking-wider text-boton-acento hover:underline">
                        ...
                        <div x-show="tab === 'observaciones'" x-transition.opacity.duration.300ms style="display: none;">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-sm font-black uppercase tracking-wider text-estado-exito">Observaciones Médicas</h3>
                                @can('salud.ficha.editar')
                                    <button wire:click="openModalObservaciones" type="button" class="text-[10px] font-black uppercase tracking-wider text-boton-acento hover:underline">
                ...
                @else
                    <section class="rounded-[1.6rem] border border-dashed border-borde/75 bg-fondo-panel p-10 text-center shadow-inner mt-4">
                        ...
                        <h3 class="mt-4 text-lg font-black text-parrafo">No existe ficha médica registrada.</h3>
                        ...
                        @can('salud.ficha.crear')
                            <button wire:click="openModalGeneral" type="button" class="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-6 py-3 text-xs font-black uppercase tracking-wider text-inverso shadow-[0_10px_22px_rgba(226,125,96,0.24)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">
        ...
        @if(count($historialFichas) > 0)
            <section class="rounded-[1.6rem] border border-borde bg-fondo-panel p-5 shadow-sm backdrop-blur-xl mt-4">
                <h3 class="mb-4 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.18em] text-apoyo">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs text-parrafo">
                        <thead class="border-b border-borde/35 bg-fondo-panel text-[9px] font-black uppercase tracking-wider text-apoyo">
                            <tr>
                        ...
                        <tbody class="divide-y divide-[#C7B5A3]/25">
                            @foreach($historialFichas as $hist)
                                <tr class="hover:bg-fondo-panel transition">
                                    <td class="px-4 py-3">
                                        <span class="rounded-full bg-fondo-panel px-2.5 py-1 text-[9px] font-black uppercase text-apoyo">{{ $hist->estado }}</span>
                                    </td>
    ...
    @else
        <section class="rounded-[1.6rem] border border-dashed border-borde/65 bg-fondo-panel p-12 text-center shadow-inner">
            ...
            <h3 class="text-base font-black text-parrafo">Seleccione un adulto mayor para visualizar su ficha médica.</h3>
    ...
    <x-ui.modal-livewire wire:model="modalGeneral" title="{{ $fichaActiva ? 'Actualizar Resumen de Ficha' : 'Registrar Ficha Médica Completa' }}" maxWidth="2xl" closeMethod="closeModal">
        ...
        <form wire:submit.prevent="save" id="formGeneral">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="md:col-span-2">
                    <label class="mb-1.5 block text-[10px] font-black uppercase tracking-widest text-apoyo">Observación Médica General</label>
        ...
        <x-slot name="footer">
            <button type="button" wire:click="closeModal" class="rounded-xl border border-borde/70 bg-fondo-card px-5 py-2.5 text-xs font-black uppercase tracking-wider text-parrafo transition hover:bg-fondo-app active:scale-95">Cancelar</button>
            <button type="submit" form="formGeneral" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-6 py-2.5 text-xs font-black uppercase tracking-wider text-inverso shadow-[0_8px_16px_rgba(226,125,96,0.2)] transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-95">Guardar Ficha Médica</button>
        </x-slot>
    </x-ui.modal-livewire>
    ...
    <x-ui.modal-livewire wire:model="modalAntecedentes" title="Agregar / Editar Antecedentes" maxWidth="2xl" closeMethod="closeModal">
        ...
        <form wire:submit.prevent="save" id="formAntecedentes">
            <div class="grid gap-4">
                <div>
                    <label class="mb-1.5 block text-[10px] font-black uppercase tracking-widest text-apoyo">Antecedentes Quirúrgicos (Cirugías previas)</label>
                ...
                <div>
                    <label class="mb-1.5 block text-[10px] font-black uppercase tracking-widest text-apoyo">Hospitalizaciones</label>
        ...
        <x-slot name="footer">
            <button type="button" wire:click="closeModal" class="rounded-xl border border-borde/70 bg-fondo-card px-5 py-2.5 text-xs font-black uppercase tracking-wider text-parrafo">Cancelar</button>
            <button type="submit" form="formAntecedentes" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-panel px-6 py-2.5 text-xs font-black uppercase tracking-wider text-inverso transition hover:bg-fondo-panel">Actualizar Antecedentes</button>
        </x-slot>
    </x-ui.modal-livewire>
    ...
    <x-ui.modal-livewire wire:model="modalAlergias" title="Agregar / Editar Alergias" maxWidth="xl" closeMethod="closeModal">
        ...
        <form wire:submit.prevent="save" id="formAlergias">
            <div>
                <label class="mb-1.5 block text-[10px] font-black uppercase tracking-widest text-apoyo">Alergias (Medicamentosas, alimentarias u otras)</label>
        ...
        <x-slot name="footer">
            <button type="button" wire:click="closeModal" class="rounded-xl border border-borde/70 bg-fondo-card px-5 py-2.5 text-xs font-black uppercase tracking-wider text-parrafo">Cancelar</button>
            <button type="submit" form="formAlergias" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-panel px-6 py-2.5 text-xs font-black uppercase tracking-wider text-inverso transition hover:bg-fondo-panel">Actualizar Alergias</button>
        </x-slot>
    </x-ui.modal-livewire>
    ...
    <x-ui.modal-livewire wire:model="modalCondiciones" title="Agregar / Editar Condiciones Médicas" maxWidth="2xl" closeMethod="closeModal">
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                @foreach([
                    ...
                    <label class="group flex cursor-pointer items-center gap-3 rounded-xl border border-borde/45 bg-fondo-panel p-2.5 transition hover:border-borde-focus hover:bg-fondo-panel">
                        ...
                        <span class="text-xs font-black uppercase tracking-wider text-parrafo transition group-hover:text-boton-acento">{{ $label }}</span>
                    </label>
                @endforeach
            </div>
        </form>
        <x-slot name="footer">
            <button type="button" wire:click="closeModal" class="rounded-xl border border-borde/70 bg-fondo-card px-5 py-2.5 text-xs font-black uppercase tracking-wider text-parrafo">Cancelar</button>
            <button type="submit" form="formCondiciones" class="inline-flex items-center justify-center gap-2 rounded-xl bg-boton-acento px-6 py-2.5 text-xs font-black uppercase tracking-wider text-inverso transition hover:bg-fondo-panel">Guardar Condiciones</button>
        </x-slot>
    </x-ui.modal-livewire>
    ...
    <x-ui.modal-livewire wire:model="modalObservaciones" title="Restricciones, Dietas y Observaciones" maxWidth="2xl" closeMethod="closeModal">
        ...
        <form wire:submit.prevent="save" id="formObservaciones">
            <div class="grid gap-4">
                <div>
                    <label class="mb-1.5 block text-[10px] font-black uppercase tracking-widest text-apoyo">Restricciones Alimentarias / Dieta Especial</label>
                ...
                <div>
                    <label class="mb-1.5 block text-[10px] font-black uppercase tracking-widest text-apoyo">Observaciones Generales de la Ficha</label>
        ...
        <x-slot name="footer">
            <button type="button" wire:click="closeModal" class="rounded-xl border border-borde/70 bg-fondo-card px-5 py-2.5 text-xs font-black uppercase tracking-wider text-parrafo">Cancelar</button>
            <button type="submit" form="formObservaciones" class="inline-flex items-center justify-center gap-2 rounded-xl bg-estado-advertenciaBg px-6 py-2.5 text-xs font-black uppercase tracking-wider text-inverso transition hover:bg-fondo-panel">Guardar Datos</button>
        </x-slot>
    </x-ui.modal-livewire>
</div>
</div>
