...
{!! file_get_contents(resource_path('frontend/styles/modules/livewire-residentes-red-apoyo-panel.css')) !!}
 ...
 <p class="mx-auto mt-1 max-w-md text-sm font-bold text-apoyo">El árbol jerárquico cargará los contactos vinculados.</p>
 </div>
 </div>
 @else
 ...
 <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-estado-exitoBg text-parrafo text-xs font-bold">
 {{ $persona['iniciales'] }}
 </span>
 <div class="min-w-0">
 ...
 <td class="px-4 py-3 text-xs font-bold text-apoyo">Familiar</td>
