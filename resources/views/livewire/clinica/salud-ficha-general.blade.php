<div class="space-y-5 animate-in fade-in duration-300">
 ...
 <a href="{{ route('admin.salud-seguimiento.ficha', $paciente->cod_am) }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-panel px-4 py-2 text-[10px] font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-boton-acento hover:text-inverso active:scale-95">
