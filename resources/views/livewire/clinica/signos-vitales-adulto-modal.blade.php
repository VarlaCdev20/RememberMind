<div>
 ...
 <div>
 <h3 class="text-xl font-extrabold text-titulo">Signos Vitales</h3>
 ...
 <p class="text-[10px] font-bold uppercase mb-0.5">PA</p>
 ...
 <p class="text-[10px] font-bold uppercase mb-0.5">FC</p>
 ...
 <p class="text-[10px] font-bold uppercase mb-0.5">Temp</p>
 ...
 <p class="text-[10px] font-bold uppercase mb-0.5">SpO2</p>
 ...
 <h4 class="mb-3 text-sm font-bold uppercase text-titulo">1. Momento del Registro</h4>
 <div class="grid gap-4 md:grid-cols-2">
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Fecha *</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Hora *</label>
 ...
 <h4 class="mb-3 text-sm font-bold uppercase text-titulo">2. Hemodinámica</h4>
 <div class="space-y-4">
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Presión Arterial (mmHg)</label>
 ...
 <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
 <h4 class="mb-3 text-sm font-bold uppercase text-titulo">3. Ventilación y Temperatura</h4>
 <div class="space-y-4">
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Temperatura (°C)</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Saturación O2 (%)</label>
 ...
 <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
 <h4 class="mb-3 text-sm font-bold uppercase text-titulo">4. Mediciones y Antropometría</h4>
 <div class="space-y-4">
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Glucosa (mg/dL)</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Peso (kg)</label>
 <input type="number" step="0.1" wire:model.live="peso" placeholder="Ej. 65"
 class="w-full rounded-xl border border-borde-suave bg-fondo-panel px-3 py-2 text-sm text-titulo focus:border-borde-focus focus:ring-borde-focus">
 </div>
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Talla (m o cm)</label>
 <input type="number" step="0.01" wire:model.live="talla" placeholder="Ej. 1.65"
 class="w-full rounded-xl border border-borde-suave bg-fondo-panel px-3 py-2 text-sm text-titulo focus:border-borde-focus focus:ring-borde-focus">
 </div>
 </div>
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">IMC Calculado</label>
 ...
 <!-- Dolor y Notas -->
 <div class="rounded-xl border border-borde-suave bg-fondo-card/50 p-4 shadow-sm">
 <h4 class="mb-3 text-sm font-bold uppercase text-titulo">5. Dolor y Observaciones</h4>
 <div class="space-y-4">
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Escala de Dolor (0-10)</label>
 ...
 <div>
 <label class="mb-1 block text-[11px] font-bold uppercase tracking-widest text-apoyo">Observación</label>
