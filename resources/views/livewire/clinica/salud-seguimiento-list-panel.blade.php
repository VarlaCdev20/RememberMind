<div class="relative mx-auto max-w-7xl space-y-5 overflow-hidden rounded-[2rem] border border-borde/70 bg-fondo-panel p-3 text-parrafo shadow-[0_22px_70px_rgba(47,62,92,0.16)] backdrop-blur-xl sm:p-5 lg:p-6">
 ...
 @else
 <section class="space-y-5 animate-in fade-in duration-200">
  <div class="rounded-2xl bg-[#DED1C3] dark:bg-[#2C2723] border border-[#C7B9AA] dark:border-[#423B34] p-3.5 text-xs shadow-sm space-y-3">
     <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between border-b border-[#C7B9AA]/50 dark:border-[#423B34] pb-2.5">
         <div>
             <span class="text-[10px] font-black uppercase tracking-[0.15em] text-[#A35A44] dark:text-[#D58C79]">{{ $contexto['titulo'] }}</span>
             <h2 class="text-base font-extrabold text-[#304060] dark:text-[#F3EAE1]">Seleccionar expediente clínico</h2>
             <p class="text-xs text-[#677084] dark:text-[#9A9084]">{{ $contexto['descripcion'] }}</p>
         </div>
     </div>

     {{-- GRID ESTRUCTURAL DE FILTROS --}}
     <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-2.5 items-center">
         ...
         <div class="lg:col-span-1 flex justify-end">
             <button type="button"
                     ...
                     class="w-full h-8 flex items-center justify-center rounded-xl border border-[#C7B9AA] dark:border-[#4E463E] bg-[#F0E8DE] dark:bg-[#211E1B] text-[#304060] dark:text-[#E8DFD5] hover:text-[#A35A44] transition">
     ...
     @if($hasFiltrosActivos)
         <div class="pt-2 border-t border-[#C7B9AA]/60 dark:border-[#423B34] flex flex-wrap items-center justify-between gap-2">
             <div class="flex flex-wrap items-center gap-1.5">
                 ...
                 @if(!empty($search))
                     <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-lg bg-[#F0E8DE] dark:bg-[#211E1B] border border-[#C7B9AA] dark:border-[#4E463E] text-[11px] font-semibold text-[#304060] dark:text-[#F3EAE1]">
                         ...
                         <button type="button" wire:click="limpiarFiltro('search')" class="hover:text-[#A35A44]"><i class="ph-bold ph-x text-xs"></i></button>
                     </span>
                 @endif
                 @if(!empty($filtroEstado))
                     <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-lg bg-[#D2A45E]/15 border border-[#D2A45E]/30 text-[11px] font-bold text-[#8C6422] dark:text-[#E2BD7E]">
                         ...
                         <button type="button" wire:click="limpiarFiltro('filtroEstado')" class="hover:text-[#A35A44]"><i class="ph-bold ph-x text-xs"></i></button>
                     </span>
                 @endif
             </div>
