                ...
                @else
                    <table>
                        ...
                        <tr>
                            <td>{{ $alerta->tipo }}</td>
                            <td>
                                <span class="badges {{ in_array($alerta->prioridad, ['ALTO', 'CRITICO']) ? 'badge-red' : ($alerta->prioridad === 'MEDIO' ? 'badge-yellow' : 'badge-blue') }}">
                                    {{ $alerta->prioridad }}
                                </span>
                            </td>
                            <td>{{ \Carbon\Carbon::parse($alerta->fecha_hora)->format('d/m/Y H:i') }}</td>
                        </tr>
                        @endforeach
                    </table>
                @endif
