<x-sistema-layout>
    ...
    >
        ...
        <div class="space-y-8">
            ...
            {{-- ========================================================================= --}}
            {{-- 6. ÁREA SOCIAL, VOLUNTARIADO Y FAMILIAS --}}
            {{-- ========================================================================= --}}
                ...
                <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-borde/60 font-medium">
                        ...
                        <tr class="hover:bg-fondo-hover/40 transition">
                            ...
                            <td class="py-3 px-4 text-center">
                                <a wire:navigate href="{{ route('admin.nutricion.valoracion') }}" class="inline-flex items-center gap-1 text-[11px] font-bold text-amber-600 hover:underline">
                                    <span>Ver Área</span>
                                    <i class="ph-bold ph-arrow-right text-[10px]"></i>
                                </a>
                            </td>
                        ...
                        <tr class="hover:bg-fondo-hover/40 transition">
                            <td class="py-3 px-4 font-bold text-titulo flex items-center gap-2">
                                ...
                                <span>Social, Familias y Voluntariado</span>
                            </td>
                            <td class="py-3 px-4 text-rose-600 dark:text-rose-400 font-bold">VOLUNTARIO / FAMILIAR</td>
                            <td class="py-3 px-4 text-apoyo">Red Familiar y Contactos, Preadmisiones de Ingreso, Asistencia de Voluntarios</td>
