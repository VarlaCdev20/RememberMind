...
>
 ...
 <a href="{{ route('admin.adultos-mayores.evaluaciones.index', $idAdulto) }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-panel px-4 py-2.5 text-xs font-bold text-inverso shadow-sm transition hover:-translate-y-0.5 hover:bg-fondo-panel active:scale-[0.98]">
 ...
 <div class="rounded-[24px] border border-borde bg-fondo-card/95 p-6 shadow-sm flex flex-col justify-center text-center">
 <p class="text-[10px] font-bold uppercase tracking-[0.18em] text-apoyo">Evolución (Promedio)</p>
 ...
 <a href="{{ route('admin.adultos-mayores.reporte-individual', ['adulto_mayor' => $idAdulto, 'tipo' => 'cognitivo', 'format' => 'pdf']) }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde-fuerte px-3 py-1.5 text-xs font-bold text-parrafo hover:bg-fondo-panel transition">
 ...
 <a href="{{ route('admin.adultos-mayores.evaluaciones.index', $idAdulto) }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-fondo-card border border-borde px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-parrafo shadow-sm transition hover:bg-fondo-panel active:scale-[0.98]">
