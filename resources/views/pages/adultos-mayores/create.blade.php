<x-sistema-layout>
 ...
 <h3 class="text-sm font-bold text-titulo mb-2">Resumen rápido</h3>
 ...
 <script>
{!! view()->file(resource_path('frontend/scripts/modules/pages-adultos-mayores-create.js.blade.php'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render() !!}
</script>
</x-sistema-layout>