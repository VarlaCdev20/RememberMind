<x-sistema-layout>
    <div class="space-y-5">
        ...
        <form method="GET" class="rm-filter-bar"><div class="grid gap-2 sm:grid-cols-[1fr_auto]"><input class="rm-input" name="buscar" value="{{ request('buscar') }}" placeholder="Nombre o documento"><button class="rm-btn-secondary">Buscar</button></div></form>
