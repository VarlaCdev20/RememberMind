...
<body class="bg-fondo-app font-sans antialiased min-h-screen flex items-center justify-center p-4 relative overflow-hidden select-none">
    ...
    <div class="relative w-full max-w-lg bg-fondo-card/70 backdrop-blur-xl border border-white/50 rounded-[2.3rem] shadow-[0_20px_50px_rgba(47,62,92,0.11)] p-8 md:p-12 text-center transform transition duration-500 hover:scale-[1.01]">
        ...
        <p class="text-[11px] font-black uppercase tracking-[0.25em] text-boton-acento mb-2 font-outfit">Código 403</p>
        ...
        {{-- BOTÓN REGRESAR --}}
        <a href="/dashboard" class="inline-flex items-center gap-2.5 bg-boton-principal hover:bg-boton-acento text-inverso text-xs font-black uppercase tracking-wider px-8 py-4 rounded-full shadow-lg shadow-[#2F3E5C]/15 transition duration-300 active:scale-95">
            <i class="ph-bold ph-arrow-left text-base"></i>
            Volver al panel principal
        </a>

        {{-- PIE DE PÁGINA --}}
        <div class="mt-12 pt-6 border-t border-borde-suave text-[10px] font-black uppercase tracking-widest text-apoyo">
